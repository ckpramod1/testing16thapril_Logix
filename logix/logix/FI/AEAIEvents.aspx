<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="AEAIEvents.aspx.cs" Inherits="logix.FI.AEAIEvents" %>
            ...
            <asp:Button ID="btn_Cancel" runat="server"  Text="Cancel" ToolTip="Cancel/Back" OnClick="btn_Cancel_Click" />
                ...
                <div class="widget-content">
                    ...
                    <div class="FormGroupContent4 boxmodal">
                        <div class="EventsDrop fit-content">
                        ...
                        <div class="gridpnl MB0">
                            <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" Width="100%" HorizontalAlign="Left" PageSize="15"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="flightno">
                                        <ItemTemplate>
                                            <div style="overflow: hidden; text-overflow: ellipsis; width: 50px">
                                                <asp:Label ID="flightno" runat="server" Text='<%# Bind("flightno") %>' ToolTip='<%# Bind("flightno") %>'></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Airlinename">
                                        <ItemTemplate>
                                            <div style="overflow: hidden; text-overflow: ellipsis; width: 200px">
                                                <asp:Label ID="Airlinename" runat="server" Text='<%# Bind("Airlinename") %>' ToolTip='<%# Bind("Airlinename") %>'></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle Wrap="false" Width="200px" HorizontalAlign="Center" />
                                        <ItemStyle Wrap="false" HorizontalAlign="Left"></ItemStyle>

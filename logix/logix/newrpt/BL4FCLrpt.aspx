<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BL4FCLrpt.aspx.cs" Inherits="logix.newrpt.BL4FCLrpt" %>
...
<div style="float:left;  margin:10px 5px 5px 175px;">
     <asp:Image id="img_Logo" runat="server"  width="75"/>
...
<div style="clear:both;"></div>
 ...
 <%--<p style="font-size:14px; font-weight:normal; text-align: center; padding:5px 5px 0px 5px; margin:0px;"><b> Regd Office</b>: No. 72/57A ,Periyar Nagar,Thiruvottiyur,Chennai-600019,india,  </p>--%>
  <p style="font-size:14px; font-weight:normal; text-align: center; padding:5px 5px 0px 5px; margin:0px;"> <b>Corp. Off</b>:VIII/1511, First Floor, Royal Plaza, Aluva West, Aluva, </p>
 <p style="font-size:14px; font-weight:normal; text-align: center; padding:5px 5px 0px 5px; margin:0px;">  Ernakulam, Kerala, 683101 India. </p>
...
<p style="font-weight:normal; padding:5px; text-align:left;  line-height:18px;"> 
    ...
    <asp:label text="Gross Weight" id="Labelgrss" runat="server"></asp:label>
          ...
          <p style="font-weight:normal; padding:5px; text-align:left; line-height:18px;"> 
         <span style="font-weight:bold;"></span>
              <asp:label text="Net Weight" id="Labelnet" runat="server"></asp:label><br />           <asp:Label ID="lbl_netwt" runat="server"></asp:Label> </p>

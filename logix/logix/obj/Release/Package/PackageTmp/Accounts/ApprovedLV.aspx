<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="ApprovedLV.aspx.cs" Inherits="logix.Accounts.ApprovedLV" %>
                ...
                <div class="widget box" runat="server" id="div_iframe">
                    ...
                    <div class="widget-content">
                            ...
                            <asp:dropdownlist id="ddl_voutype" tooltip="Voucher Type" runat="server" autopostback="True" cssclass="chzn-select" width="100%" data-placeholder="Voucher Type" tabindex="3" onselectedindexchanged="ddl_voutype_SelectedIndexChanged">
                               <asp:ListItem Value="0" Text=""></asp:ListItem>
                                ...
                                <asp:ListItem Value="2" Text="Purchase Invoice"></asp:ListItem>
                                  <asp:ListItem Value="20" Text="Bill of Supply"></asp:ListItem>
                                <asp:ListItem Value="22" Text="Sales Invoice OC"></asp:ListItem>
                                <asp:ListItem Value="23" Text="Purchase Invoice OC"></asp:ListItem>                               
                                 <asp:ListItem Value="24" Text="Bill of Supply OC"></asp:ListItem>
                                <asp:ListItem Value="7" Text="Debit Note"></asp:ListItem>
                                <asp:ListItem Value="8" Text="Credit Note"></asp:ListItem>
                        ...
                        <div class="BLLeft">
                            ...
                            <div class="FormGroupContent4 custom-d-flex">
                                <div class="custom-col custom-mr-05 ">
                                    <asp:Label ID="Label12" runat="server" Text="Job Details"></asp:Label>
                                    <asp:TextBox ID="txtvessel" runat="server" CssClass="form-control" AutoPostBack="True" ReadOnly="True" placeholder="" ToolTip="Job Details"></asp:TextBox>
                                </div>
                                <div class="custom-col  ">
                                    <asp:Label ID="Label13" runat="server" Text="PoL / PoD"></asp:Label>
                                    <asp:TextBox ID="txtdes" runat="server" CssClass="form-control" AutoPostBack="True" ReadOnly="True" placeholder="" ToolTip="POL /POD"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="FormGroupContent4 custom-d-flex">
                                <div class="custom-col custom-mr-05">
                                    ...
                                    <asp:TextBox ID="txtshipper" runat="server" CssClass="form-control" AutoPostBack="True" ReadOnly="True" placeholder="" ToolTip="Shipper"></asp:TextBox>
                                </div>
                                <div class="custom-col  ">
                                    <asp:Label ID="Label15" runat="server" Text="Agent"></asp:Label>
                                    <asp:TextBox ID="txtagent" runat="server" CssClass="form-control" AutoPostBack="True" ReadOnly="True" placeholder="" ToolTip="Agent"></asp:TextBox>
                                </div>
                            ...
                            <div class="FormGroupContent4 custom-d-flex">
                                <div class=" custom-col custom-mr-05  ">
                                    ...
                                    <asp:TextBox ID="txtconsignee" runat="server" CssClass="form-control" AutoPostBack="True" ReadOnly="True" placeholder="" ToolTip="Consignee"></asp:TextBox>
                                </div>

                                <div class="custom-col  ">
                                    <asp:Label ID="Label17" runat="server" Text="MLO / Air Line"></asp:Label>
                                    <asp:TextBox ID="txtmlo" runat="server" CssClass="form-control" AutoPostBack="True" ReadOnly="True" placeholder="" ToolTip="Main Line Operator"></asp:TextBox>
                                </div>
                            ...
                            <div class="FormGroupContent4 custom-d-flex">
                                ...
                                <div class="custom-col custom-mr-05 ">
                                    ...
                                    <asp:TextBox ID="txtnotify" runat="server" CssClass="form-control" AutoPostBack="True" ReadOnly="True" placeholder="" ToolTip="Notify Party"></asp:TextBox>
                                </div>
                                <div class="custom-col ">
                                    <asp:Label ID="Label19" runat="server" Text="CHA"></asp:Label>
                                    <asp:TextBox ID="txtcnf" runat="server" CssClass="form-control" AutoPostBack="True" ReadOnly="True" placeholder="" ToolTip="Customs House Agent"></asp:TextBox>
                                </div>
                            </div>
                             <div class="FormGroupContent4">
     ...
     <asp:TextBox ID="txtremarks" runat="server" CssClass="form-control" AutoPostBack="True" TabIndex="5" Width="100%" onKeyUp="CheckTextLength(this,150)" placeholder="" ToolTip="Remarks"></asp:TextBox>
                        ...
                        <div class="BLRight">
                            ...
                            <div class="FormGroupContent4">
                                ...
                                <asp:DropDownList ID="cmbbill" runat="server" AutoPostBack="True" Enabled="false" Width="100%" CssClass="chzn-select" OnSelectedIndexChanged="cmbbill_SelectedIndexChanged" ToolTip="Bill Type" data-placeholder="Bill Type" ReadOnly="true">
                                    <asp:ListItem Value="0" Text=""></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            ...
                            <div class=" FormGroupContent4 custom-d-flex">
                                <div class="custom-col custom-mr-10">
                                    ...
                                    <asp:TextBox ID="txtblno" runat="server" CssClass="form-control" AutoPostBack="True" OnTextChanged="txtblno_TextChanged" placeholder="" ToolTip="Bill of Lading Number" ReadOnly="true"></asp:TextBox>
                                </div>
                            ...
                            <div class="FormGroupContent4 custom-d-flex">
                                <div class="custom-col custom-mr-1">
                                    ...
                                    <asp:TextBox ID="txt_trantype" runat="server" ReadOnly="True" placeholder="" CssClass="form-control" ToolTip="Product"></asp:TextBox>
                                </div>
                                <div class="custom-col " id="txtcreditapp1" runat="server">
                                    <asp:Label ID="Label7" runat="server" Text="CreditApproval #"></asp:Label>
                                    <asp:TextBox ID="txtcreditapp" runat="server" CssClass="form-control" AutoPostBack="True" placeholder="" ToolTip="CreditApproval #" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            <div class="FormGroupContent4 custom-d-flex">
                                <div class="custom-col custom-mr-1">
                                    <asp:Label ID="Label21" runat="server" Text="Vendor Ref #"></asp:Label>
                                    <asp:TextBox ID="txtVendorref" runat="server" CssClass="form-control" Visible="false" AutoPostBack="True" onkeypress="return isNumberKey(event,'Vendor Ref#');" placeholder="" ToolTip="Vender Ref Number"></asp:TextBox>
                                </div>

                                <div class="custom-col ">
                                    <asp:Label ID="Label22" runat="server" Text="Vendor Ref Date"></asp:Label>
                                    <asp:TextBox ID="txtVendorRefnodate" runat="server" CssClass="form-control" Visible="false" AutoPostBack="True" placeholder="" ToolTip="Vendor Ref Date"></asp:TextBox>
                                </div>
                            </div>
                            <div class="FormGroupContent4">
                            ...
                            <div class="FormGroupContent4" style="display: flex; justify-content: space-between;">
                                <div id="lbl_txt" runat="server" visible="false">
                                    <div class="FormGroupContent4" style="display: flex; justify-content: space-between;">
                                        ...
                                        <div class="ApprovedValue"  style="margin: 44px 0px 0px 1px;">

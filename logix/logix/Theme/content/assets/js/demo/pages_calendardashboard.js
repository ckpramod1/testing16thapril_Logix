    ...
    $('#calendar').fullCalendar({
        ...
        events: [
            ...
            },
            {
                ...
                description: '<ul><li onclick="ProEmp()"><div class="cal_group_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Group 3</div></li><li onclick="ProEmp()"><div class="cal_team_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Team 1</div></li><li onclick="ProEmp()"><div class="cal_team_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Team 2</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Jaffer</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Abdul</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Kalam</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Abubakar</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">karrem</div></li> <li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Sayed</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Nazeer</div></li></ul>'
            },
             {
                 title: 'Noon Shift',

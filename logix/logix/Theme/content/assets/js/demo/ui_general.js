...
$(document).ready(function(){
	...
	$("a.basic-alert").click(function(e) {
		e.preventDefault();
		bootbox.alertify.alert("Hello world!", function() {
	...
	$("a.multiple-dialogs").click(function(e) {
		...
		bootbox.alertify.alert("Prepare for multiboxes in 1 second...");
			...
			bootbox.dialog({
				...
				buttons: {
					danger: {
						...
						className: "btn-danger",
						callback: function() {
							bootbox.alertify.alert("Aww boo. Click the button below to get rid of all these popups.", function() {
								bootbox.hideAll();
							});
						}
					},
					success: {
						...
						className: "btn-success",
						callback: function() {
							bootbox.alertify.alert("Glad to hear it! Click the button below to get rid of all these popups.", function() {
								bootbox.hideAll();
							});
						}
					}
	...
	$("a.programmatic-close").click(function(e) {
		e.preventDefault();
		var box = bootbox.alertify.alert("This dialog will automatically close in two seconds...");
		setTimeout(function() {
			box.modal('hide');
		}, 2000);
	});

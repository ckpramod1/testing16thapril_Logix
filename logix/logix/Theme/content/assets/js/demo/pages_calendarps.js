    ...
    $('#calendar').fullCalendar({
        ...
        events: [
...

            {
                ...
                allDay: false,
                description: '<ul><li onclick="ProEmp()"><div class="cal_group_img label-success"></div><div class="cal_amshift_txt">Group 2 <span><img src="Themes/Greeno/ltr/assets/img/patroll_icon.png"></span></div></li><li onclick="ProEmp()"><div class="cal_team_img label-success"></div><div class="cal_amshift_txt">Team 1  <span><img src="Themes/Greeno/ltr/assets/img/patroll_icon.png"></span></div></li><li onclick="ProEmp()"><div class="cal_team_img label-success"></div><div class="cal_amshift_txt">Team 2  <span><img src="Themes/Greeno/ltr/assets/img/patroll_icon.png"></span></div></li><li onclick="ProEmp()"><div class="cal_newshift_img label-success"></div><div class="cal_amshift_txt">Jaffer</div></li> <li onclick="ProEmp()"><div class="cal_newshift_img label-success"></div><div class="cal_amshift_txt">Akthar</div></li><li onclick="ProEmp()"><div class="cal_newshift_img label-success"></div><div class="cal_amshift_txt">Asif</div></li><li onclick="ProEmp()"><div class="cal_newshift_img label-success"></div><div class="cal_amshift_txt">Ajmal</div></li><li onclick="ProEmp()"><div class="cal_newshift_img label-success"></div><div class="cal_amshift_txt">Raffiq</div></li> <li onclick="ProEmp()"><div class="cal_newshift_img label-success"></div><div class="cal_amshift_txt">Irfan</div></li><li onclick="ProEmp()"><div class="cal_newshift_img label-success"></div><div class="cal_amshift_txt">Jaffer</div></li><li onclick="ProEmp()"><div class="cal_newshift_img label-success"></div><div class="cal_amshift_txt">Kamran</div></li></ul>'
            },
            {
                title: 'Noon Shift',
                ...
                description: '<ul><li onclick="ProEmp()"><div class="cal_group_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Group 3 <span><img src="Themes/Greeno/ltr/assets/img/patroll_icon.png"></span></div></li><li onclick="ProEmp()"><div class="cal_team_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Team 1  <span><img src="Themes/Greeno/ltr/assets/img/patroll_icon.png"></span></div></li><li onclick="ProEmp()"><div class="cal_team_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Team 2  <span><img src="Themes/Greeno/ltr/assets/img/patroll_icon.png"></span></div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Jaffer</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Abdul</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Kalam</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Abubakar</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">karrem</div></li> <li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">sayed</div></li><li onclick="ProEmp()"><div class="cal_newshift_img darkyellow_bg"></div><div class="cal_shiftfive_txt">Nazeer</div></li></ul>'
            },
             {
                 title: 'Noon Shift',

...
ColVis = function( oDTSettings, oInit )
{
	...
	{
		alertify.alert( "Warning: ColVis must be initialised with the keyword 'new'" );
	}
...
{
	alertify.alert( "Warning: ColVis requires DataTables 1.7 or greater - www.datatables.net/download");
}

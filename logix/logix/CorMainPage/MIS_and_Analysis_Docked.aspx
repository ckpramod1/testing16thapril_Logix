<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MIS_and_Analysis_Docked.aspx.cs" EnableEventValidation="false"  Inherits="logix.CorMainPage.MIS_and_Analysis_Docked" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="javascript:void(0);"><i class="icon-share"></i> MIS and Analytics</a></li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-delicious"></i> Analytics<i class="fa fa-angle-down rotate-icon"></i></a>
                       ...
                       <%-- <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-bank"></i> MIS<i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
            ...
            <nav class="drawer-nav" role="navigation" style="display:none;">
                    ...
                    <ul id="nav" class="drawer-menu">
                        <li class="brderright"><a href="javascript:void(0);" class="Fontbld"><i class="icon-share"></i></a></li>
                                ...
                                <li id="Analysis" runat="server"  class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"> <i class="icon-check-sign"></i>  <span class="drawer-caret"></span></a>
                                    <ul class="drawer-dropdown-menu">
                                        
                                    </ul>
                                </li>

                                <li id="MIS" runat="server" class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-tasks"></i>  <span class="drawer-caret"></span></a>
                                    <ul class="drawer-dropdown-menu">
            ...
            <div id="content">
                <div class="container">
                    <div class="div_iframe">
                        <!-- Tabs-->
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/CORHomeMIS.aspx" scrolling="no"></iframe>
                    </div>
                </div>
            </div>
        </div>

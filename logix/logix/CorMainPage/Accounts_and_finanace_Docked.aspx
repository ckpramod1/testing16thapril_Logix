<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accounts_and_finanace_Docked.aspx.cs" EnableEventValidation="false" Inherits="logix.CorMainPage.Accounts_and_finanace_Docked" %>
...
<body class="drawer drawer--left">
    <form id="form1" runat="server">
      ...
      <button type="button" class="drawer-toggle drawer-hamburger" title="Toggle Navigation">
      ...
      <span class="drawer-hamburger-icon"></span>
            ...
            <nav class="drawer-nav" role="navigation">
                    ...
                    <ul  id="nav" class="drawer-menu">
                        <li class="brderright"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-share"></i> Accounts and Finance</a>  </li>
                            

                                <li id="voucher" runat="server" class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-gear"></i> Voucher  <span class="drawer-caret"></span></a>
                                    <ul class="drawer-dropdown-menu">
                                        <div id="divvoucher" runat="server"></div>
                                    </ul>
                                </li>

                                <li id="Approval" runat="server" class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-user-md"></i> Approval <span class="drawer-caret"></span></a>
                                    <ul class="drawer-dropdown-menu">
                                        <div id="divApproval" runat="server"></div>
                                    </ul>
                                </li>

                                <li id="Register" runat="server" class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-list-alt"></i> Register <span class="drawer-caret"></span></a>
                                    <ul class="drawer-dropdown-menu">
                                        <div id="divRegister" runat="server"></div>
                                    </ul>
                                </li>

                                 <li id="operationmis" runat="server" class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-cog"></i> Query <span class="drawer-caret"></span></a>
                                    <ul class="drawer-dropdown-menu">
            ...
            <div id="content">
                <div class="container">
                    <div class="div_iframe">
                        <!-- Tabs-->
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/CorpAccNFinance.aspx" scrolling="no"></iframe>
                    </div>
                </div>
            </div>
        </div>

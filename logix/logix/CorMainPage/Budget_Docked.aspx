<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Budget_Docked.aspx.cs" EnableEventValidation="false"  Inherits ="logix.CorMainPage.Budget_Docked" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="javascript:void(0);"><i class="icon-share"></i> Budget</a></li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-bank"></i> Budget<i class="fa fa-angle-down rotate-icon"></i></a>
            ...
            <nav class="drawer-nav" role="navigation" style="display:none;">
                    ...
                    <ul id="nav" class="drawer-menu">
                        <li class="brderright"><a href="javascript:void(0);" class="Fontbld"><i class="icon-share"></i></a> </li>
                                ...
                                <li id="trend" runat="server" class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-list-alt"></i>  <span class="drawer-caret"></span></a>
            ...
            <div id="content">
                <div class="container">
                    <div class="div_iframe">
                        <!-- Tabs-->
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/CorpBudgetHome.aspx" scrolling="no"></iframe>
                    </div>
                </div>
            </div>
        </div>

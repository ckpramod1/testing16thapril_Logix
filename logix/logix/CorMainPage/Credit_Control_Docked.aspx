<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Credit_Control_Docked.aspx.cs" EnableEventValidation="false" Inherits="logix.CorMainPage.Credit_Control_Docked" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="javascript:void(0);"><i class="icon-share"></i> Credit Control</a></li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-comment-o"></i> Credit <i class="fa fa-angle-down rotate-icon"></i></a>
            ...
            <div id="content">
                <div class="container">
                    <div class="div_iframe">
                        <!-- Tabs-->
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/CorpCreditControl.aspx" scrolling="no"></iframe>
                    </div>
                </div>
            </div>
        </div>

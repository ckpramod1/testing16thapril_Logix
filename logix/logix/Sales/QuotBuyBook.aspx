<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="QuotBuyBook.aspx.cs" Inherits="logix.Sales.QuotBuyBook" %>
...
.DivSecPanel img:hover {
  transform: rotate(180deg);
    ...
    margin: 0px 0px 0px 439px;
        ...
        /*  table#logix_CPH_GrdBuysellcharge th:nth-child(4){
              width: 45px !important;
        }
         table#logix_CPH_GrdBuysellcharge th:nth-child(1){
       width: 445px !important;
 }
                 table#logix_CPH_GrdBuysellcharge  th:nth-child(5) {
    width: 45px !important;
}
                                  table#logix_CPH_GrdBuysellcharge  th:nth-child(2) {
    width: 45px !important;
}
  
        table#logix_CPH_GrdBuysellcharge thead th:nth-child(4) {
    width: 45px !important;
}
        table#logix_CPH_GrdBuysellcharge thead th:nth-child(5) {
    width: 45px !important;
}
        table#logix_CPH_GrdBuysellcharge   th:nth-child(6) {
    width: 45px !important;
}
        table#logix_CPH_GrdBuysellcharge   th:nth-child(7) {
    width: 45px !important;

}
        table#logix_CPH_GrdBuysellcharge   th:nth-child(8) {
    width: 45px !important;
}
        table#logix_CPH_GrdBuysellcharge   th:nth-child(9) {
    width: 45px !important;
}
                ...
                table#logix_CPH_GrdBuysellcharge td:nth-child(4){
              width: 45px !important;
        }
         table#logix_CPH_GrdBuysellcharge td:nth-child(1){
       width: 445px !important;
 }
                 table#logix_CPH_GrdBuysellcharge  td:nth-child(5) {
    width: 45px !important;
}
                                  table#logix_CPH_GrdBuysellcharge  td:nth-child(2) {
    width: 45px !important;
}
  
        table#logix_CPH_GrdBuysellcharge thead td:nth-child(4) {
    width: 45px !important;
}
        table#logix_CPH_GrdBuysellcharge thead td:nth-child(5) {
    width: 45px !important;
}
        table#logix_CPH_GrdBuysellcharge   td:nth-child(6) {
    width: 45px !important;
}
        table#logix_CPH_GrdBuysellcharge   td:nth-child(7) {
    width: 45px !important;

}
        table#logix_CPH_GrdBuysellcharge   td:nth-child(8) {
    width: 45px !important;
}
        table#logix_CPH_GrdBuysellcharge   td:nth-child(9) {
    width: 45px !important;
}*/
            ...
            $(document).ready(function () {
                $("#<%=txtCustomer.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "QuotBuyBook.aspx/GetLikeCustomer",
           ...
           <%-- $(document).ready(function () {
                $("#<%=txtCustomer.ClientID %>").autocomplete({
                    source: function (request, response) {
                        $("#<%=hdf_customerid.ClientID %>").val(0);
                        $.ajax({
                            url: "QuotBuyBook.aspx/GetCustomer",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $("#<%=txtCargo.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "QuotBuyBook.aspx/GetLikeCargo",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $('#<%=txtPOR.ClientID%>').autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "QuotBuyBook.aspx/SelPortName4typepadimg",
                            data: "{'prefix' :'" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $("#<%=txtCharges.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "QuotBuyBook.aspx/GetChargename",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $("#<%=txtCurr.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "QuotBuyBook.aspx/GetCurrencyname",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $("#<%=txtInco.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "QuotBuyBook.aspx/GetLikeIncocode",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
    ...
    <div>
            ...
            <div class="widget box" runat="server" id="div_iframe">
                    ...
                    <div class="FixedButtons">
                        ...
                        <div class="right_btn">
                            ...
                            <div class="btn ico-save" id="btn_save" runat="server">
                                <asp:Button ID="btnSave" runat="server" ToolTip="Save"  Enabled="false" TabIndex="34" OnClick="btnSave_Click" />
                            </div>
                            ...
                            <div class="btn ico-delete" id="btn_app1" runat="server">
                                <asp:Button ID="btnApp" runat="server" ToolTip="Delete" Text="Delete" TabIndex="36" OnClick="btnApp_Click" />
                            </div>
                            <div class="btn ico-approve" runat="server">
                            ...
                            <div class="btn ico-cancel" id="btn_back1" runat="server">
                                <asp:Button ID="btnclose" runat="server" ToolTip="Cancel"  TabIndex="38" OnClick="btnclose_Click" />
                            </div>
                ...
                <div class="widget-content">
                    ...
                    <div class="FormGroupContent4">
                        ...
                        <div class="right_btn" style="width: 30%;">
                            <div class="Quotation" style="float: right">
                                <span>Quot #</span>
                    ...
                    <div class="bordertopNew" style="float: right; min-height: 1px; width: 30%; box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;"></div>
                    <div class="FormGroupContent4">

                        <div class="Formdisplay" style="float: left; margin-right: 0.5%">
                            <asp:Label Text="Prepared By " ID="preBy" runat="server"></asp:Label>

                            <asp:TextBox ID="txtPreparedBy" runat="server" CssClass="form-control" BorderWidth="1" Width="100%" Enabled="false" ToolTip="Prepared by" PlaceHolder=""></asp:TextBox>
                        </div>
                        <div class="Quotationlbl" style="display: none;">
                            <asp:Label ID="Label16" runat="server" Text="Salesperson"></asp:Label>
                        </div>

                        <div class="Formdisplay " style="width: 20%">
                        ...
                        <div class="FormInputbox1" style="width: 13.6%; margin-right: 0px">
                        ...
                        <div class="GrossTxt">
                            ...
                            <asp:CheckBox ID="Gross_country" AutoPostBack="true" runat="server" OnCheckedChanged="Gross_country_CheckedChanged"></asp:CheckBox>
                    ...
                    <div class="FormGroupContent4">
                        ...
                        <asp:LinkButton ID="lnk_credit" CssClass="anc ico-info-sm hide" runat="server" OnClick="lnk_credit_Click"></asp:LinkButton>
                        <div class=" shipper" style="width: 50.5%; float: left; margin: 0px 0% 0px 0px">
                    ...
                    <div class="FormGroupContent4">
                        <div style="width: 49%; float: left; margin: 0px 0.5% 0px 0px">
                            <span>Address</span>
                        ...
                        <div style="width: 50.5%; float: left; margin: 0px 0px 0px 0px">
                    ...
                    <div class=" FormGroupContent4">
                        ...
                        <div class="FormInputbox1" style="width: 24.7%">
                            <div class="FormGroupContent4">
                        ...
                        <div class="FormInputbox1" style="width: 25.4%; margin-right: 0px">
                            <div class="FormGroupContent4">
                    ...
                    <div class="FormGroupContent4">
                        <div class="commodity" style="width: 42.7%;">
                    ...
                    <div class="FormGroupContent4">
                        <div class="IncoInput">
                            ...
                            <asp:TextBox ID="txtInco" runat="server" CssClass="form-control" AutoPostBack="false" ToolTip="INCO" PlaceHolder=" " TabIndex="18"></asp:TextBox>
        ...
        oncheckedchanged="rdbBussiness_CheckedChanged" />
                    ...
                    <div class="QuoteRight">
                        ...
                        <div class="FormGroupContent4 boxmodal hide">
                            ...
                            <div class="SeaRight" id="SearightNew" runat="server">
                                <div class="FormGroupContent4">
                                    <asp:Panel ID="Panel7" runat="server" CssClass="panel_10">
                                        <asp:GridView ID="grd_Sizetype" runat="server" AutoGenerateColumns="False" CssClass="Grid FixedHeader" Width="100%"
                                            ShowHeaderWhenEmpty="True" EnableTheming="False" OnPreRender="grd_Sizetype_PreRender">
                                            <Columns>
                    ...
                    <div class="divleft">
                        <div class="bordertopNew" style="width: 100%"></div>
                        ...
                        <div class="FormGroupContent4 boxmodal">
                            ...
                            <div class="FormInput6 " style="text-align: right; width: 5.9%;">
                            ...
                            <div class="FormInput6 " style="text-align: right; width: 10%">
                            ...
                            <div class="FormInput6 " style="text-align: right; width: 8%">
                                            ...
                                            <asp:GridView ID="GrdBuysellcharge" runat="server" ShowHeaderWhenEmpty="True" CssClass="Grid FixedHeader" AutoGenerateColumns="False" Width="100%" OnSelectedIndexChanged="GrdBuysellcharge_SelectedIndexChanged" OnPreRender="GrdBuysellcharge_PreRender" OnRowDataBound="GrdBuysellcharge_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="rate" HeaderText="Rate" DataFormatString="{0:#,##0.00}" ItemStyle-CssClass="TxtAlign1" HeaderStyle-CssClass="align-right"><%-- HeaderStyle-CssClass="TxtAlign1"--%>
                                                        <HeaderStyle HorizontalAlign="Center" Width="150px" CssClass="hide" />
                                                        <ItemStyle HorizontalAlign="Right" Width="150px" CssClass="hide" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="exrate" HeaderText="Exrate" DataFormatString="{0:#,##0.00}">
                                                        <HeaderStyle HorizontalAlign="Center" Width="150px" CssClass="align-right" />
                                                        <ItemStyle HorizontalAlign="Right" Width="150px" CssClass="align-right" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="rate" HeaderText="Buy" DataFormatString="{0:#,##0.00}" ItemStyle-CssClass="TxtAlign2">
                                                        <HeaderStyle HorizontalAlign="Center" Width="150px" CssClass="align-right" />
                                                        <ItemStyle HorizontalAlign="right" Width="150px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="sell" HeaderText="sell" DataFormatString="{0:#,##0.00}" ItemStyle-CssClass="TxtAlign3">
                                                      ...
                                                      <asp:BoundField DataField="buyinr" HeaderText="Buy1" DataFormatString="{0:#,##0.00}" ItemStyle-CssClass="TxtAlign2">
      <HeaderStyle HorizontalAlign="Center" Width="150px" CssClass="align-right" />
      <ItemStyle HorizontalAlign="right" Width="150px" />
  </asp:BoundField>
  <asp:BoundField DataField="sellinr" HeaderText="sell1" DataFormatString="{0:#,##0.00}" ItemStyle-CssClass="TxtAlign3">
      <HeaderStyle HorizontalAlign="Center" Width="150px" CssClass="align-right" />
      <ItemStyle HorizontalAlign="right" Width="150px" />
  </asp:BoundField>
                                ...
                                <div class=" FormGroupContent4 boxmodal" style="width: 100.5%">
                                                ...
                                                <asp:TemplateField HeaderText="Date">
                                                    <ItemTemplate>
                                                        <div style="overflow: hidden; text-overflow: ellipsis; width: 80px">
                                                            <asp:Label ID="quotdate" runat="server" Text='<%# Bind("quotdate") %>'></asp:Label>
                                                        </div>
                                                    </ItemTemplate>

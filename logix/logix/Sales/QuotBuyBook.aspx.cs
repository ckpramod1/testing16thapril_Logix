...
{
    public partial class QuotBuyBook : System.Web.UI.Page
    {
        string check = "";
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    if (Request.QueryString.ToString().Contains("quotno"))
                    {
                        ...
                        {
                            dt_MenuRights = userperobj.Getformuserrights(Convert.ToInt16(Session["LoginEmpId"].ToString()), "", Convert.ToInt16(Session["LoginBranchid"].ToString()), 2, "Quote");//Session["trantype_process"] as DataTable;
                    ...
                    if (Request.QueryString.ToString().Contains("Quotno"))
                    {
                        ...
                        txtQuotation.Text = Request.QueryString["Quotno"].ToString();
                ...
                txtQuotation.Focus();
                grd_Sizetype.Enabled = false;// add 20/1/23
            }
        ...
        protected void LoadBuying()
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, typeof(System.Web.UI.WebControls.Button), "alert", "alertify.alert('select the Quotation');", true);
                }
            }
        ...
        private void GetBuyingGrid()
        {
            ...
            try
            {
                if (txtBuying.Text != "")
                {
                    dtBooking = quotation.ChargeBuyingDetailsnew(Convert.ToInt32(txtBuying.Text.ToString()), Convert.ToInt32(Session["LoginBranchid"].ToString()));
        ...
        protected void txt_Sizecount_TextChanged(object sender, EventArgs e)
        {
            int index = 0;
            GridViewRow row = ((GridViewRow)((TextBox)sender).NamingContainer);
            index = row.RowIndex;
            TextBox Txt = (TextBox)row.FindControl("txt_Sizecount");
            //txt_noofcont.Text = "";
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "logix", "alertify.alert('Kindly Save the Quotation');", true);
                    return;
                }
                    ...
                    if (txtQuotation.Text != "")
                    {
                        ...
                        if (blnexists == false)
                        {
                            ...
                            if (txtQuotation.Text != "")
                            {
                                ...
                                if (dtQuot.Rows.Count > 0)
                                {
                                    ScriptManager.RegisterStartupScript(btnSave, typeof(Button), "alert", "alertify.alert('Booking Already done For this Quotation');", true);
                            ...
                            if (dtss.Rows.Count > 0)
                            {
                                ...
                                {
                                    totals = Convert.ToDouble(dtss.Rows[i]["buyinr"]);
                                    amounts = amounts + totals;
                                    totb1 = Convert.ToDouble(dtss.Rows[i]["sellinr"]);
                                    totb = totb + totb1;
                                }
                                ...
                                GrdBuysellcharge.Columns[8].HeaderText = "Buy ( " + dtss.Rows[0]["basecurr"] + " )";
                                GrdBuysellcharge.Columns[9].HeaderText = "Sell ( " + dtss.Rows[0]["basecurr"] + " )";
                                GrdBuysellcharge.Columns[10].HeaderText = "Profit ( " + dtss.Rows[0]["basecurr"] + " )";
                            ...
                            {
                                case "FE":
                                    Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 181, 1, Convert.ToInt32(Session["LoginBranchid"]), txtQuotation.Text + " / " + chargeid + "FE_QuotChargeS");
                                    break;
                                case "FI":
                                    Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 180, 1, Convert.ToInt32(Session["LoginBranchid"]), txtQuotation.Text + " / " + chargeid + "FI_QuotChargeS");
                                    break;
                                case "AE":
                        ...
                        else
                        {
                            ...
                            {
                                case "FE":
                                    Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 181, 2, Convert.ToInt32(Session["LoginBranchid"]), txtQuotation.Text + " / " + chargeid + "FE_QuotChargeU");
                                    break;
                                case "FI":
                                    Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 180, 2, Convert.ToInt32(Session["LoginBranchid"]), txtQuotation.Text + " / " + chargeid + "FI_QuotChargeU");
                                    break;
                                case "AE":
        ...
        {
            DataTable dtnew = new DataTable();
            dtnew = quotation.CheckMax(Convert.ToInt32(hid_quotno.Value), Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(Session["Logindivisionid"].ToString()));
            if (dtnew.Rows.Count > 0)
            {
                string type = "";
                string type1 = "";
                    ...
                    for (int i = 0; i <= grd_Sizetype.Rows.Count - 1; i++)
                    {
                        ...
                        if (type1 == type)
                        {
                            ...
                            if (grd_Sizetype.Rows[i].Cells[1].Text == "CBM" || grd_Sizetype.Rows[i].Cells[1].Text == "KGS")
                            {
                                ...
                                if (dtnew.Rows[n]["expqty"].ToString() != "")
                                {
                                    txt.Text = Convert.ToDecimal(dtnew.Rows[n]["expqty"]).ToString();
                                }
                            }
                            else
                            {
                                if (dtnew.Rows[n]["expqty"].ToString() != "")
                                {
                                    txt.Text = Convert.ToInt32(dtnew.Rows[n]["expqty"]).ToString();
                                }
        ...
        protected void LoadQuoatation()
        {
            ...
            try
            {
                ...
                if (lblHeader.Text == "Quotation Approval")
                {
                    dtQuot = quotation.ApprovalPendingDetails(Session["StrTranType"].ToString(), Convert.ToInt32(Session["LoginBranchid"].ToString()));
                }
                else
                {
                    if (txtCustomer.Text != "" && hdf_customerid.Value != "")
                    {
                        dtQuot = quotation.QuotationDetailsCustqnew(Session["StrTranType"].ToString(), Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(hdf_customerid.Value.ToString()));
                    }
                    else
                    {
                        dtQuot = quotation.QuotationDetailsnew(Session["StrTranType"].ToString(), Convert.ToInt32(Session["LoginBranchid"].ToString()));
                    }
                }
                if (dtQuot.Rows.Count > 0)
                {
        ...
        protected void grdQuotaionDetails_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (grdQuotaionDetails.Rows.Count > 0)
                {
                    ...
                    txtQuotation.Text = ((Label)grdQuotaionDetails.Rows[Convert.ToInt32(index)].Cells[0].FindControl("Quotation")).Text;
                    quotid = Convert.ToInt32(txtQuotation.Text);
                    ...
                    if (dtQuot.Rows.Count > 0)
                    {
                        ddl_product.Text = dtQuot.Rows[0]["product"].ToString();
        ...
        protected void grdQuotation_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (grdQuotation.Rows.Count > 0)
                {
                    ...
                    dtQuot = quotation.GetQuotationDetails(Convert.ToInt32(txtQuotation.Text), Session["StrTranType"].ToString(), Convert.ToInt32(Session["LoginBranchid"].ToString()));
                    ...
                    if (btnSave.ToolTip == "Update")
                    {
                        ...
                        if (ddlversion == dtQuottt.Rows[0]["version"].ToString())
                        {
                            ...
                            if (app == 0)
                            {
                                ...
                                if (strtrantype == "FE" || strtrantype == "FI")
                                {
                                    quotation.UpdateCombinedQuotationDetail(quotid, Convert.ToDateTime(Utility.fn_ConvertDate(txtValidTill.Text) + " " + DateTime.Now.ToLongTimeString()), Convert.ToInt32(hdf_customerid.Value), Convert.ToInt32(hdf_POR.Value),
                            ...
                            txt_transittime.Text, Convert.ToInt32(ddl_moveTypes.SelectedValue), txt_pieces.Text, txt_noofcont.Text, Convert.ToDecimal(txt_grwt.Text), (txt_units.Text), Convert.ToDouble(txt_volume.Text), txt_dim.Text, txt_value.Text, 0, Convert.ToInt32(txt_totdays.Text), ddl_feasi.SelectedValue
                           , Convert.ToDateTime(Utility.fn_ConvertDate(txt_enquiry.Text)));
                                ...
                                else
                                {
                                    quotation.UpdateCombinedQuotationDetail(quotid, Convert.ToDateTime(Utility.fn_ConvertDate(txtValidTill.Text) + " " + DateTime.Now.ToLongTimeString()), Convert.ToInt32(hdf_customerid.Value), Convert.ToInt32(hdf_POR.Value),
                                                                        ...
                                                                        Convert.ToInt32(hdf_salesperson.Value), Convert.ToInt32(Session["LoginEmpId"].ToString()), Convert.ToInt32(hdf_Hazard.Value), Session["StrTranType"].ToString(), txtRemarks.Text, "0", Convert.ToInt32(Session["LoginBranchid"].ToString()),
                                                                        Convert.ToInt32(txtBuying.Text.Trim()), hdf_Bussiness.Value, check, txtterms.Text, Convert.ToInt32(hdn_Incoid.Value), Convert.ToInt32(hdn_shipperid.Value), Convert.ToInt32(hdn_Consigneeid.Value), txt_custpono.Text, txt_routing.Text,
                                                            txt_transittime.Text, Convert.ToInt32(ddl_moveTypes.SelectedValue), txt_pieces.Text, "0", Convert.ToDecimal(txt_grwt.Text), (txt_units.Text), Convert.ToDouble(txt_volume.Text), txt_dim.Text, txt_value.Text, Convert.ToDecimal(txt_noofcont.Text), Convert.ToInt32(txt_totdays.Text), ddl_feasi.SelectedValue
                                                           , Convert.ToDateTime(Utility.fn_ConvertDate(txt_enquiry.Text)));
                                }
                                ...
                                ScriptManager.RegisterStartupScript(btnSave, typeof(Button), "alert", "alertify.alert('Quotation # " + quotid + " Updated ');", true);
                                btnAdd.Enabled = true;
                                btnAdd.ForeColor = System.Drawing.Color.White;
                                intapprovedbyid = Convert.ToString(1);
                                DateTime appdate;
        ...
        public void save()
        {
            ...
            if (txtCustomer.Text != "" && txtPOR.Text != "" && txtPOL.Text != "" && txtPOD.Text != "" && txtFD.Text != "")
            {
                ...
                if (strtrantype == "FE" || strtrantype == "FI")
                {
                    quotid = quotation.InsertcombinedQuotationDetails(Convert.ToDateTime(Utility.fn_ConvertDate(txtDate.Text) + " " + DateTime.Now.ToLongTimeString()), Convert.ToDateTime(Utility.fn_ConvertDate(txtValidTill.Text) + " " +
                        ...
                        txt_transittime.Text, Convert.ToInt32(ddl_moveTypes.SelectedValue), txt_pieces.Text, txt_noofcont.Text, Convert.ToDecimal(txt_grwt.Text), (txt_units.Text), Convert.ToDouble(txt_volume.Text), txt_dim.Text, txt_value.Text, 0, Convert.ToInt32(txt_totdays.Text), ddl_feasi.SelectedValue, Convert.ToDateTime(Utility.fn_ConvertDate(txt_enquiry.Text)));//Convert.ToDateTime(Utility.fn_ConvertDate(txt_enquiry.Text))
                }
                else
                {
                    quotid = quotation.InsertcombinedQuotationDetails(Convert.ToDateTime(Utility.fn_ConvertDate(txtDate.Text) + " " + DateTime.Now.ToLongTimeString()), Convert.ToDateTime(Utility.fn_ConvertDate(txtValidTill.Text) + " " +
                                           ...
                                           "0", Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(txtBuying.Text.Trim()), Convert.ToInt32(Session["LoginDivisionId"].ToString()), hdf_Bussiness.Value,
                                           check, txtterms.Text, Convert.ToInt32(hdn_Incoid.Value), Convert.ToInt32(hdn_shipperid.Value), Convert.ToInt32(hdn_Consigneeid.Value), txt_custpono.Text, txt_routing.Text,
                                           txt_transittime.Text, Convert.ToInt32(ddl_moveTypes.SelectedValue), txt_pieces.Text, "0", Convert.ToDecimal(txt_grwt.Text), (txt_units.Text), Convert.ToDouble(txt_volume.Text), txt_dim.Text, txt_value.Text, Convert.ToDecimal(txt_noofcont.Text), Convert.ToInt32(txt_totdays.Text), ddl_feasi.SelectedValue, Convert.ToDateTime(Utility.fn_ConvertDate(txt_enquiry.Text)));
                }
                txtQuotation.Text = Convert.ToString(quotid);
                hid_quotno.Value = txtQuotation.Text;
        ...
        public void getvalue()
        {
            try
            {
                ...
                if (txtQuotation.Text != "")
                {
                    ...
                    {
                        ScriptManager.RegisterClientScriptBlock(this, typeof(System.Web.UI.WebControls.Button), "logix", "alertify.alert('Invalid Quotation Number');", true);
                        txtQuotation.Focus();
                        return;
                    }
            ...
            try
            {
                ...
                else if (btnApp.ToolTip == "Delete")
                {
                        ...
                        if (ddlversion == dtQuottt.Rows[0]["version"].ToString())
                        {
                            ...
                            if (txtCharges.Text != "" && txt_sellrate.Text != "" && txtCurr.Text != "" && ddlBase.SelectedIndex != 0)
                            {
                                if (txtQuotation.Text != "")
                                {
                                    ...
                                    if (dtQuot.Rows.Count > 0)
                                    {
                                        ScriptManager.RegisterStartupScript(btnSave, typeof(Button), "alert", "alertify.alert('Booking Already done, you cannot Delete this Quotation);", true);
                                        return;
                                    }
                                }
                    ...
                    else
                    {
                        ...
                        if (dtQuot.Rows.Count == 0)
                        {
                            ScriptManager.RegisterStartupScript(btnApp, typeof(Button), "alert", "alertify.alert('No Quotation available to Delete');", true);
                        }
                        if (dtQuot.Rows.Count > 0)
                        {
                            grdQuotaionDetails.DataSource = dtQuot;
            ...
            try
            {
                ...
                if (NewQuoteRpt.Value == "Y")
                {
                    ...
                    if (txtQuotation.Text.Trim() != "")
                    {
                        ...
                        {
                            str_Script = "window.open('../Reportasp/Combinedquotrpt.aspx?Quoteno=" + txtQuotation.Text + "&Bid=" + Session["LoginBranchid"] + "&Cid=" + Session["LoginDivisionid"] + "&TranType=" + Session["StrTranType"] + "&version=" + version +"&Ccode="+ Ccode + "','','');";
        ...
        protected void grdQuotaionDetails_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            grdQuotaionDetails.DataSource = (DataTable)ViewState["quotation"];
            grdQuotaionDetails.DataBind();
            this.popupQuot.Show();
            pnlJobAE.Visible = true;
            grdQuotaionDetails.Visible = true;
        ...
        protected void Btn_reuse_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "logix", "alertify.alert('Please Enter the Quotation # ');", true);
                    return;
                }
        ...
        protected void LoadQuoatationreuse()
        {
            ...
            try
            {
                ...
                else
                {
                    if (txtCustomer.Text != "" && hdf_customerid.Value != "")
                    {
                        dtQuot = quotation.QuotationDetailsCust(Session["StrTranType"].ToString(), Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(hdf_customerid.Value.ToString()));
                    }
                    else
                    {
                        dtQuot = quotation.QuotationDetails(Session["StrTranType"].ToString(), Convert.ToInt32(Session["LoginBranchid"].ToString()));
                    }
                }
        ...
        protected void txt_buyrate_TextChanged(object sender, EventArgs e)
        {
            ...
            //    txt_retention.Text = ret.ToString();
            //}
            if (txt_buyrate.Text != "0" && txt_margin.Text != "" && txt_sellrate.Text == "0")
            {
                double sellrate = ((Convert.ToDouble(txt_margin.Text)) / 100) * (Convert.ToDouble(txt_buyrate.Text)) + Convert.ToDouble(txt_buyrate.Text);
                txt_sellrate.Text = sellrate.ToString();
            }
            else if (txt_buyrate.Text != "" && txt_sellrate.Text != "0" && txt_buyrate.Text != "0")
            {
                double ret = Convert.ToDouble(txt_sellrate.Text) - Convert.ToDouble(txt_buyrate.Text);
                txt_retention.Text = ret.ToString();
                //double margin = (((Convert.ToDouble(txt_sellrate.Text)) / (Convert.ToDouble(txt_buyrate.Text))) - 1) * 100;
                //txt_margin.Text = Convert.ToDouble(margin).ToString("#,0.00");
                double margin = ((Convert.ToDouble(txt_sellrate.Text) - Convert.ToDouble(txt_buyrate.Text)) / (Convert.ToDouble(txt_sellrate.Text))) * 100; // yuvaraj * 100      
               // double margin1 = (margin / Convert.ToDouble(txt_buyrate.Text)) * 100;                
                txt_margin.Text = Convert.ToDouble(margin).ToString("#,0");

            }
            else if (txt_buyrate.Text != "" && txt_margin.Text == "" && txt_sellrate.Text != "0" && txt_buyrate.Text != "0")
            {
                double margin = ((Convert.ToDouble(txt_sellrate.Text) - Convert.ToDouble(txt_buyrate.Text)) / (Convert.ToDouble(txt_sellrate.Text))) * 100; // yuvaraj * 100      
               // double margin1 = (margin / Convert.ToDouble(txt_buyrate.Text)) * 100;
                txt_margin.Text = Convert.ToDouble(margin).ToString("#,0");
        ...
        protected void txt_sellrate_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txt_buyrate.Text != "" && txt_sellrate.Text != "0" && txt_buyrate.Text != "0")
            {
                double ret = Convert.ToDouble(txt_sellrate.Text) - Convert.ToDouble(txt_buyrate.Text);
                txt_retention.Text = ret.ToString();
                double margin = ((Convert.ToDouble(txt_sellrate.Text) - Convert.ToDouble(txt_buyrate.Text)) / (Convert.ToDouble(txt_sellrate.Text))) * 100; // yuvaraj * 100      
            ...
            try
            {
                ...
                if (btn_approve.ToolTip == "Approve")
                {
                    ...
                    if (txtQuotation.Text != "" && txtCustomer.Text != "" && txtPOR.Text != "" && txtPOL.Text != "" && txtPOD.Text != "" && txtFD.Text != "")
                    {
                        ...
                        appdate = Logobj.GetDate();
                        strapproved = Session["LoginUserName"].ToString();
                        dtQuot = quotation.GetcombbinedQuotationDetails(quotid, strtrantype, Convert.ToInt32(Session["LoginBranchid"].ToString()));
                        if (dtQuot.Rows.Count > 0)
                        {
                            ...
                            {//Convert.ToDateTime((txtDate.Text) + " " + DateTime.Now.ToLongTimeString())
                                quotation.InsertcombinedQuotationDetailsversion(Convert.ToDateTime(Utility.fn_ConvertDate(txtDate.Text) + " " + DateTime.Now.ToLongTimeString()), Convert.ToDateTime(Utility.fn_ConvertDate(txtValidTill.Text) + " " +
                                      DateTime.Now.ToLongTimeString()), Session["StrTranType"].ToString(), Convert.ToInt32(hdf_customerid.Value), Convert.ToInt32(hdf_POR.Value), Convert.ToInt32(hdf_POL.Value),
                                      Convert.ToInt32(hdf_POD.Value), Convert.ToInt32(hdf_FD.Value), ddlShipment.SelectedItem.Text, ddlFreight.SelectedItem.Text, Convert.ToInt32(hdf_cargoid.Value),
                                      txtDescription.Text, Convert.ToInt32(hdf_salesperson.Value), Convert.ToInt32(Session["LoginEmpId"].ToString()), Convert.ToInt32(hdf_Hazard.Value), txtRemarks.Text.Trim(),
                                      "0", Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(txtBuying.Text.Trim()), Convert.ToInt32(Session["LoginDivisionId"].ToString()), hdf_Bussiness.Value,
        ...
        protected void GrdBuysellcharge_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (GrdBuysellcharge.Rows.Count > 0)
                {
                    ...
                    double x = Convert.ToDouble(txtqty.Text);
                    ...
                    //txt_buyrate.Text = GrdBuysellcharge.SelectedRow.Cells[8].Text;
                    txt_sellrate.Text = GrdBuysellcharge.SelectedRow.Cells[7].Text;
                    double sel = Convert.ToDouble(txt_sellrate.Text);
                    int z = Convert.ToInt32(sel);
                    double y = z / x;
                    //txt_sellrate.Text = y.ToString();
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        string buyrate = dt.Rows[0]["rate"].ToString();


                       //double g= Convert.ToDouble(buyrate);
                       
                       // double quan = g / x;
                       // txt_buyrate.Text = quan.ToString();

                        txt_buyrate.Text = Convert.ToDouble(buyrate).ToString("0.00");
                    ...
                    else
                    {
                        ...
                        //dtrate=quotation.Getrateamount(Convert.ToInt32( hid_quotno),chargeid,ddlBase.SelectedValue);

                        double margin = (Convert.ToDouble(txt_sellrate.Text) - Convert.ToDouble(txt_buyrate.Text)); // yuvaraj * 100      
                        double margin1 = (margin / Convert.ToDouble(txt_buyrate.Text)) * 100;

                        //double margin = (Convert.ToDouble(dtrate.Rows[0]["rate"]) - Convert.ToDouble(dt.Rows[0]["amount"])); // yuvaraj * 100      
                        // double margin1 = (margin / Convert.ToDouble(dtrate.Rows[0]["rate"]) * 100); 

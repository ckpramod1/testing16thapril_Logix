<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Customersupport4AllTaskDashBord.aspx.cs" Inherits="logix.CRM.Customersupport4AllTaskDashBord" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
    ...
    <div>
            ...
            <div class="widget box" runat="server" id="div_iframe">
                ...
                <div class="widget-content">
                    ...
                    <div class="FormGroupContent4" style="-webkit-box-shadow: 0 0 0 30px #d3d3d336 inset !important;  margin-bottom: 12px !important;border-radius: 12px;">
                        <div class="Product">
                            <asp:Label ID="Label5" runat="server" Text="Product" Visible="false"></asp:Label>
                            <asp:DropDownList ID="ddl_product" runat="server" data-placeholder="Product" ToolTip="Product" AutoPostBack="true" Enabled="false" CssClass="chzn-select" OnSelectedIndexChanged="ddl_product_SelectedIndexChanged" Visible="false">
                        ...
                        <div class="event">
                            <asp:Label ID="Label6" runat="server" Text="Task" Visible="false"></asp:Label>
                            <asp:DropDownList ID="ddlevent" runat="server" data-placeholder="Event" ToolTip="Event" AutoPostBack="true" CssClass="chzn-select" OnSelectedIndexChanged="ddlevent_SelectedIndexChanged" Visible="false">
                                <asp:ListItem Value="0" Text=""></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="Job">
                            <asp:Label ID="Label32" runat="server" Text="Job #" Visible="false"></asp:Label>
                            <asp:TextBox ID="txt_job" runat="server" CssClass="form-control" ToolTip="Job #" OnTextChanged="txt_job_TextChanged" AutoPostBack="true" Visible="false"></asp:TextBox>
                        </div>
                        <div class="Booking">
        ...
        <asp:Button ID="btn_Excel" runat="server" Text="Excel" ToolTip="Export To Excel"  OnClick="btn_Excel_Click" />
    </div>
    ...
    <ItemStyle HorizontalAlign="Center" Width="25px" />
                                    ...
                                    <asp:TemplateField HeaderText="Last Event">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="ddl_LastEvent" runat="server" AutoPostBack="true" Text='<%#Eval("lastevent")%>' ToolTip='<%#Eval("lastevent")%>' Enabled="false"></asp:TextBox>
                                    ...
                                    <asp:BoundField DataField="lasteventupdatedon" HeaderText="Date" DataFormatString="{0:dd/MM/yyyy}">
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                    </asp:BoundField>

                                                                        <asp:BoundField DataField="TaskToBeDone" HeaderText="Task To Be Done">
    <ItemStyle HorizontalAlign="Center" Width="25px" />
</asp:BoundField>


                                    <asp:TemplateField HeaderText="Arrived To">
                                        <HeaderStyle Wrap="false" />
                                    ...
                                    <asp:TemplateField HeaderText="">
                                        ...
                                        <ItemTemplate>
                                            <div class="btn ico-update" id="btn_send1" runat="server">
                                                <asp:Button ID="btn_send" runat="server" Text="Send" ToolTip="Update" TabIndex="41" OnClick="btnSave_Click" Visible="false" />
                                            </div>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="">
                                        ...
                                        <ItemTemplate>
                                            <div class="btn ico-send-mail" id="btn_sendMail" runat="server">
                                                <asp:Button ID="btn_mail" runat="server" Text="Send" ToolTip="mail" TabIndex="41" OnClick="btn_mail_Click" Visible="false" />
                                            </div>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>

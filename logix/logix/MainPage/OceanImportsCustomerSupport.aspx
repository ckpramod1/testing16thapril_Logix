<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OceanImportsCustomerSupport.aspx.cs" Inherits="logix.MainPage.OceanImportsCustomerSupport" %>
...
<body  class="drawer drawer--left">
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        ...
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Customer Support - OI<i class="fa fa-angle-down rotate-icon"></i></a>
                    ...
                    <ul id="nav" class="drawer-menu">
                        <li class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-share"></i> <span class="drawer-caret"></span></a>
                            <ul class="drawer-dropdown-menu">
                                ...
                                <%--<li id="links" runat="server"><a href="javascript:void(0);" class="Fontbld"><i class="icon-user-md"></i>Customer Service</a>
                                    <ul class="sub-menu">--%>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/js/bootstrap.min.js"></script>
            ...
            <script src="../Theme/MenuToggle/drawer.min.js"></script>
            <script>
                $(document).ready(function () {
                    $('.drawer').drawer();
                });
            ...
            <div id="content">
                <div class="container">
                    ...
                    <div class="div_iframe">
                        ...
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/OICSHome.aspx" scrolling="no"></iframe>

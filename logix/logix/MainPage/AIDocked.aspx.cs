...
{
    public partial class AIDocked : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (dt_MenuRights.Rows.Count > 0)
                {
                    for (int i = 0; i < dt_MenuRights.Rows.Count; i++)
                    {
                        ...
                        {
                            if (dt_MenuRights.Rows[i]["uicaption"].ToString().Trim() == "Quotation (Selling)" ||
                                ...
                                dt_MenuRights.Rows[i]["uicaption"].ToString().Trim() == "Sales Co-Ordinater" ||
                        ...
                        {
                            if (dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Delivery Order" ||
                        ...
                        if (dt_MenuRights.Rows[i]["menuname"].ToString().Trim() == "Shipment Details")
                        {
                                ...
                                dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Download Document")
                            {
                                ...
                                divShipp.InnerHtml = str_MenuDesign2.ToString();
                            }
                        }
                        ...
                        {
                            if (dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "AmendBL #" ||

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AEDocked.aspx.cs" EnableEventValidation="false" Inherits="logix.MainPage.AEDocked" %>
        ...
        <div id="container" class="fixed-header">
            ...
            <div id="sidebar" class="sidebar-fixed">
                <div id="sidebar-content">
                    ...
                    <!--=== Navigation Starts ===-->
                    <ul id="nav">
                        <li class="current"><a href="javascript:void(0);"><i class="icon-share"></i>Air Exports</a>
                            <ul class="sub-menu">
                                ...
                                <li id="links" runat="server" visible="false">
                                    <a href="#" class="Fontbld"><i class="icon-user-md"></i>Customer Service</a>
                                ...
                                <li id="files" runat="server" visible="false">
                                    <a href="#" class="Fontbld"><i class="icon-list-alt"></i>Shipment Details</a>
                                    <ul class="sub-menu">
                                ...
                                <li id="Accounts" runat="server" visible="false">
                                    <a href="#" class="Fontbld"><i class="icon-group"></i>Accounts</a>
                                    <ul class="sub-menu">
                                ...
                                <li id="Approval" runat="server" visible="false">
                                    <a href="#" class="Fontbld"><i class="icon-check-sign"></i>Approval</a>
                                    <ul class="sub-menu">
                                ...
                                <li id="MIS" runat="server" visible="false">
                                    <a href="#" class="Fontbld"><i class="icon-tasks"></i>MIS</a>
                                ...
                                <li id="Utility" runat="server" visible="false">
                                    <a href="#" class="Fontbld"><i class="icon-cog"></i>Utility</a>
                                    <ul class="sub-menu">
            ...
            <div id="content">
                <div class="container">
                    <div class="div_iframe" runat="server" id="div_iframe">
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" frameborder="0" src="../Home/AEHome.aspx" scrolling="Yes"></iframe>

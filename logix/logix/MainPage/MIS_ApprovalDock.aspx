<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MIS_ApprovalDock.aspx.cs" Inherits="logix.MainPage.MIS_ApprovalDock" %>
        ...
        <div id="container" class="fixed-header">
                ...
                <ul class="custom-scrollbar">
                    ...
                    <li>
                        <ul class="collapsible collapsible-accordion">
                            <li><a href="javascript:void(0);"><i class="icon-share"></i>MIS</a></li>
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-shield"></i>MIS<i class="fa fa-angle-down rotate-icon"></i></a>
                            ...
                            <li><a class="collapsible-header waves-effect arrow-r hide"><i class="fa fa-dedent"></i>Operation MIS <i class="fa fa-angle-down rotate-icon"></i></a>
                                <div class="collapsible-body">
                                    <ul class="list-unstyled">
            ...
            <nav class="drawer-nav" role="navigation" style="display: none;">
                ...
                <ul id="nav" class="drawer-menu">
                    <li class="brderright" id="MIS" runat="server" visible="false"><a href="javascript:void(0);" class="Fontbld"><i class="icon-share"></i></a></li>
                    <li class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-share"></i><span class="drawer-caret"></span></a>
                        <ul class="drawer-dropdown-menu">
                        </ul>
                    </li>


                    <li id="operationmis" runat="server" class="drawer-dropdown">
            ...
            <div id="content">
                <div class="container">
                    ...
                    <div class="div_iframe">
                        ...
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/MISAndApproval.aspx" scrolling="no"></iframe>

   <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OceanImports_ops.aspx.cs" Inherits="logix.MainPage.OceanImports_ops" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="javascript:void(0);"><i class="icon-share"></i> Ocean Imports </a></li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Documentation <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                                     <div id="divops" runat="server"></div>
                                </ul>
                            </div>
                        </li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Customer Support <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                        ...
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Accounts <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                        ...
                        <li style="display:none"><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Utility<i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
...
<nav class="drawer-nav" role="navigation" style="display:none;">
                    ...
                    <ul id="nav" class="drawer-menu">
                        <li class="brderright" id="id_ops" runat="server" visible="false"><a href="javascript:void(0);" class="Fontbld"><i class="icon-share"></i></a> </li>
                             <li class="drawer-dropdown">
                                    <a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-gear"></i> OPS & DOCS - OI <span class="drawer-caret"></span></a>
                        ...
                        <ul class="drawer-dropdown-menu">
                            ...
                            <li id="Accounts" runat="server" visible="false" class="drawer-dropdown">
                                <a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-user-md"></i>  <span class="drawer-caret"></span></a>   <%-- <i class="icon-group"></i>--%>
                                <ul class="drawer-dropdown-menu">

                                </ul>
                            </li>
                            
                            <%-- <li class="current"  id="Approval" runat ="server" visible="false"><a href="#" class="Fontbld"><i class="icon-check-sign"></i>Approval</a>
                  <ul class="sub-menu">
            ...
            <div id="content">
                <div class="container">
                    ...
                    <div class="div_iframe">
                        ...
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/OEOpsAndDocs.aspx" scrolling="no"></iframe>

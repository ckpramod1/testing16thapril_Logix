...
{
    public partial class CHADocked : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                    ...
                    for (int i = 0; i < dt_MenuRights.Rows.Count; i++)
                    {
                        if (dt_MenuRights.Rows[i]["menuname"].ToString().Trim() == "Shipment Details")
                        {
                            if (dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Event Details" ||
                                dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Document #" ||
                                dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Consignee" ||
                                dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Job #" ||
                                dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Principal" ||
                                dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Credit Request" ||

                                  dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Job Info" ||
                                ...
                                )
                            {
                                ...
                                divShipp.InnerHtml = str_MenuDesign.ToString();
                            }
                        }
                        ...
                        {
                            if (dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "MIS")
                            {
                                MIS.Visible = true;
                        ...
                        {
                            if (dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Transfer To Commercial Invoice" ||
                                 dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Job Closing" ||
                                  dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "ExRate Change" ||
                                  dt_MenuRights.Rows[i]["submenuname"].ToString().Trim() == "Profoma Invoice" ||
            ...
            if (Strtrantype == "CH")
            {
                ...
                lnk_PendingBooking.Enabled = false;
                lnk_PendingBooking.ForeColor = System.Drawing.Color.Gray;

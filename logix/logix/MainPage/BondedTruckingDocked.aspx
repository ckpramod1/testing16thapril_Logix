<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BondedTruckingDocked.aspx.cs" EnableEventValidation="false" Inherits="logix.MainPage.BondedTruckingDocked" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="javascript:void(0);"><i class="icon-share"></i> Bonded Trucking</a></li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Job Details<i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                                     <div id="DivJob" runat="server"></div>
                                </ul>
                            </div>
                        </li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-wpforms"></i> Accounts <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                          ...
                          <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-modx"></i> Approval <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                          ...
                          <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-codiepie"></i> MIS <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                         ...
                         <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-gitlab"></i> Utility <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
        ...
        <!--/. Sidebar navigation -->
            ...
            <nav class="drawer-nav" role="navigation" style="display:none;">
                    ...
                    <ul id="nav" class="drawer-menu">
                        <li class="brderright">
                            <a href="javascript:void(0);"><i class="icon-share"></i></a></li>
                            
                                <li id="files" runat="server" visible="false" class="drawer-dropdown">
                                ...
                                <li id="Accounts" runat="server" visible="false" class="drawer-dropdown">
                                ...
                                <li id="Approval" runat="server" visible="false" class="drawer-dropdown">
                                    <a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-check-sign"></i>  <span class="drawer-caret"></span></a> 

                                    <ul class="drawer-dropdown-menu">
                                        
                                    </ul>
                                </li>
                                <li id="MIS" runat="server" visible="false" class="drawer-dropdown">
                                ...
                                <li id="Utility" runat="server" visible="false" class="drawer-dropdown">
            ...
            <div id="content">
                <div class="container">
                    <div class="div_iframe" runat="server">
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" frameborder="0" src="../Home/BTHome.aspx" scrolling="Yes"></iframe>
                    ...
                    <asp:LinkButton ID="lnk_PendingBooking" runat="server" ForeColor="Navy" style="text-decoration:none" OnClick="lnk_PendingBooking_Click">Pending Booking</asp:LinkButton>
                </div>                        
                <asp:Panel ID="Panelbooking" runat="server"  ScrollBars="Vertical" CssClass="Gridpnl1">
                    <asp:GridView ID="grdpendingbook1" CssClass="Grid FixedHeader"  runat="server" AutoGenerateColumns="true" Width="100%" ForeColor="Black" EmptyDataText="No Record Found" BackColor="White" ShowHeaderWhenEmpty="true" OnRowDataBound="grdpendingbook1_RowDataBound" OnSelectedIndexChanged="grdpendingbook1_SelectedIndexChanged" >                   
                ...
                <div class="div_Break"></div>--%>
                            ...
                            <li><i class="icon-angle-right PR10"></i>
                                <asp:LinkButton ID="lnk_PendingApproval" runat="server" ForeColor="Navy" Style="text-decoration: none" OnClick="lnk_PendingApproval_Click">Pending Approval</asp:LinkButton></li>
                            <div class="Gridpnl1">
                            ...
                            <li><i class="icon-angle-right PR10"></i>
                                <asp:LinkButton ID="lnk_Tools" runat="server" ForeColor="Navy" Style="text-decoration: none" OnClick="lnk_Tools_Click">Tools</asp:LinkButton></li>
                            <div class="pnl_tool">
                                <asp:Panel ID="panel_tool" runat="server" Style="border: 1px solid grey;"  Height="125px" Visible="false">
                                    <div class="lbl_con">
                                        <asp:Label ID="lbl_conversion" runat="server" ForeColor="Brown" Text="CONVERSION TOOLS" CssClass="LabelValue"></asp:Label>
                                    </div>
                                    <div class="lnk_common">
                                        <asp:LinkButton ID="lnk_curr" CssClass="LabelValue" runat="server" ForeColor="Navy" Style="text-decoration: none" Text="Country and Currency" OnClick="lnk_curr_Click"></asp:LinkButton></div>
                                    <div class="div_Break"></div>
                                    <div class="lnk_common">
                                        <asp:LinkButton ID="lnl_inco" CssClass="LabelValue" runat="server" ForeColor="Navy" Style="text-decoration: none" Text="Inco Terms" OnClick="lnl_inco_Click"></asp:LinkButton></div>
                                    <div class="div_Break"></div>
                                    <div class="lnk_common">
                                        <asp:LinkButton ID="lnk_length" CssClass="LabelValue" runat="server" ForeColor="Navy" Style="text-decoration: none" Text="Length Conversation" OnClick="lnk_length_Click"></asp:LinkButton></div>
                                    <div class="div_Break"></div>
                                    <div class="lnk_common">
                                        <asp:LinkButton ID="lnk_weight" CssClass="LabelValue" runat="server" ForeColor="Navy" Style="text-decoration: none" Text="Weigth Conversation" OnClick="lnk_weight_Click"></asp:LinkButton></div>
                                    <div class="div_Break"></div>
                                    <div class="lnk_common">
                                        <asp:LinkButton ID="lnk_volume" CssClass="LabelValue" runat="server" ForeColor="Navy" Style="text-decoration: none" Text="Volume Conversation" OnClick="lnk_volume_Click"></asp:LinkButton></div>
                                </asp:Panel>
                            </div>
                            <div class="Clear"></div>

                            <li><i class="icon-angle-right PR10"></i><i class="icon-angle-right PR10"></i>
                                <asp:LinkButton ID="lnk_PendingCountry" runat="server" ForeColor="Navy" Style="text-decoration: none" OnClick="lnk_PendingCountry_Click">Port Country</asp:LinkButton></li>
                            ...
                            <div class="Clear"></div>
                            <li><i class="icon-angle-right PR10"></i>
                                <asp:LinkButton ID="lnk_userlogged" runat="server" ForeColor="Navy" Style="text-decoration: none" OnClick="lnk_userlogged_Click">User Logged in</asp:LinkButton></li>
                            <div class="Gridpnl1">
                            ...
                            <li><i class="icon-angle-right PR10"></i>
                                <asp:LinkButton ID="lnk_unclosedjobs" runat="server" ForeColor="Navy" Style="text-decoration: none" OnClick="lnk_unclosedjobs_Click">Unclosed Jobs</asp:LinkButton></li>
                            <div class="Gridpnl1">
                            ...
                            <div class="Clear"></div>
                            <li>
                                <i class="icon-angle-right PR10"></i>

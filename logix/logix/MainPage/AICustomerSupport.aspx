<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AICustomerSupport.aspx.cs" Inherits="logix.MainPage.AICustomerSupport" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="javascript:void(0);"><i class="icon-share"></i> Air Import</a></li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Customer Support - AI<i class="fa fa-angle-down rotate-icon"></i></a>
        ...
        <!--/. Sidebar navigation -->
           ...
           <nav class="drawer-nav" role="navigation" style="display:none;">
                    ...
                    <ul id="nav" class="drawer-menu">
                        <li class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="true"><i class="icon-share"></i> <span class="drawer-caret"></span></a>
            ...
            <div id="content">
                <div class="container">
                    ...
                    <div class="div_iframe">
                        ...
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/AICSHome.aspx" scrolling="no"></iframe>

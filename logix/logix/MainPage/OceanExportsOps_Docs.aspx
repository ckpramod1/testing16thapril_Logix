<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OceanExportsOps_Docs.aspx.cs" Inherits="logix.MainPage.OceanExportsOps_Docs" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="javascript:void(0);"><i class="icon-share"></i> Ocean Exports </a></li>
        ...
        <!--/. Sidebar navigation -->
            ...
            <nav class="drawer-nav" role="navigation" style="display:none;">
             <ul id="nav" class="drawer-menu">
                        <li class="drawer-dropdown" id="id_ops" runat="server"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-share"></i>  <span class="drawer-caret"></span></a>

                        <ul class="drawer-dropdown-menu">

                            </ul>
                             </li>
                            <li id="Accounts" runat="server" visible="false"  class="drawer-dropdown"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-user-md"></i>  <span class="drawer-caret"></span></a> <%-- <i class="icon-group"></i>--%>
                                <ul class="drawer-dropdown-menu">

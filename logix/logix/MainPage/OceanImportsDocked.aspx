<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OceanImportsDocked.aspx.cs" EnableEventValidation="false" Inherits="logix.MainPage.OceanImportsDocked" %>
        ...
        <div id="container" class="fixed-header">
            ...
            <div id="sidebar" class="sidebar-fixed">
                <div id="sidebar-content">
                    ...
                    <ul id="nav">
                        <li class="current">
                            <a href="javascript:void(0);"><i class="icon-share"></i>Ocean Imports</a>
                            <ul class="sub-menu">
                                ...
                                <li id="files" runat="server" visible="false">
                                    ...
                                    <ul class="sub-menu">
                                        <div id="DivShip" runat="server"></div>
                                    </ul>
                                </li>
                                ...
                                <li id="operationmis" runat="server" visible="false">
                                    <a href="javascript:void(0);" class="Fontbld"><i class="icon-gear"></i>Operation MIS</a>
            ...
            <div id="content">
                <div class="container">
                    <div runat="server" class="div_iframe">
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" frameborder="0" src="../Home/OIHome.aspx" scrolling="no"></iframe>
                    </div>
                    <!-- <div class="Widget-boxright"  runat ="server" id="div1">
        <asp:Panel ID="Panel2" runat="server"  scrolling="no" frameborder="0" src="" >
           ...
           <li><i class="icon-angle-right PR10"></i><asp:LinkButton ID="lnk_PendingBooking" runat="server" ForeColor="Navy" style="text-decoration:none" OnClick="lnk_PendingBooking_Click">Pending Booking</asp:LinkButton></li>                
               ...
               <asp:Panel ID="Panelbooking" runat="server"  Height="125px" Visible="false">
                 ...
                 <div class="Clear"></div>  
              <li><i class="icon-angle-right PR10"></i><asp:LinkButton ID="lnk_Pendingcan" runat="server" ForeColor="Navy" style="text-decoration:none" OnClick="lnk_Pendingcan_Click">Pending CAN</asp:LinkButton></li>   
            <div class="Gridpnl1">                      
                <asp:Panel ID="Panelcan" runat="server"  Height="125px" Visible="false">
                 ...
                 <div class="Clear"></div>  
          <li><i class="icon-angle-right PR10"></i><asp:LinkButton ID="lnk_Pendingline" runat="server" ForeColor="Navy" style="text-decoration:none" OnClick="lnk_Pendingline_Click" >Pending Line#</asp:LinkButton></li>                        
         <div class="Gridpnl1">  
             <asp:Panel ID="Panelline" runat="server"  Height="125px" Visible="false">
                 ...
                 <div class="Clear"></div>  
         <li><i class="icon-angle-right PR10"></i><asp:LinkButton ID="lnk_Pendingstuff" runat="server" ForeColor="Navy" style="text-decoration:none" OnClick="lnk_Pendingstuff_Click" >Pending De-Stuffing</asp:LinkButton></li>                        
         <div class="Gridpnl1">       
            <asp:Panel ID="Panelstuff" runat="server"  Height="125px" Visible="false">
         ...
         <div class="Gridpnl1"> 
               <asp:Panel ID="PanelPendingEvent" runat="server"  Height="125px" Visible="false">     
                    <asp:GridView ID="GrdOceanExp1" CssClass="Grid FixedHeader"  runat="server" AutoGenerateColumns="true" Width="100%" ForeColor="Black" EmptyDataText="No Record Found" BackColor="White" ShowHeaderWhenEmpty="true" OnRowDataBound="GrdOceanExp1_RowDataBound" OnSelectedIndexChanged="GrdOceanExp1_SelectedIndexChanged" Visible="false" >
                        <EmptyDataRowStyle CssClass="EmptyRowStyle" />
                        <HeaderStyle CssClass="GridHeader" />
                        <AlternatingRowStyle CssClass="GrdAltRow" />
                    </asp:GridView> 

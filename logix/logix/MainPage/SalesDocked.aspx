<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesDocked.aspx.cs" Inherits="logix.MainPage.SalesDocked" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                       <ul class="collapsible collapsible-accordion">
                            <li><a href="javascript:void(0);"><i class="icon-share"></i> Sales</a></li>
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Sales<i class="fa fa-angle-down rotate-icon"></i></a>
                            ...
                            <%-- <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-chevron-right"></i> Reports<i class="fa fa-angle-down rotate-icon"></i></a>
                                <div class="collapsible-body">
                                    <ul class="list-unstyled">
                                        <div id="Div1_Reports" runat="server"></div>
                                    </ul>
                                </div>
                            </li>  hide by yuvaraj--%>
        ...
        <!--/. Sidebar navigation -->
            ...
            <nav class="drawer-nav" role="navigation" style="display:none;">
                    ...
                    <ul id="nav" class="drawer-menu">
                        <li class="drawer-dropdown" id="Sales" runat="server"><a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><i class="icon-share"></i>  <span class="drawer-caret"></span></a>
                            <ul class="drawer-dropdown-menu MT20">
            ...
            <div id="content">
                <div class="container">
                    ...
                    <div class="div_iframe">
                        ...
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" height="850px" frameborder="0" src="../Home/SalesHome.aspx" scrolling="no"></iframe>

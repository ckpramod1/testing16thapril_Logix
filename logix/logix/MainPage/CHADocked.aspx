<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CHADocked.aspx.cs" EnableEventValidation="false" Inherits="logix.MainPage.CHADocked" %>
            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="javascript:void(0);"><i class="icon-share"></i> CHA</a></li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-shield"></i> Shipment Details<i class="fa fa-angle-down rotate-icon"></i></a>
                        ...
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-dedent"></i> Accounts <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                          ...
                          <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-user-plus"></i> Approval <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                          ...
                          <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-sticky-note"></i> MIS <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                         ...
                         <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-balance-scale"></i> Utility <i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
            ...
            <div id="content">
                <div class="container">
                    <div class="div_iframe" runat="server" id="div_iframe">
                        <iframe id="ifrmaster" runat="server" name="MainFrame" class="iframe" frameborder="0" src="../Home/CHAHome.aspx" scrolling="no"></iframe>

                    </div>
                    <!--   <div class="Widget-boxright" runat ="server" id="div1">
               <asp:Panel ID="Panel2" runat="server" CssClass="" scrolling="no" frameborder="0" src="">

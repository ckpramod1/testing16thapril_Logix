...
{
    public partial class PerformaOsVouchers : System.Web.UI.Page
    {
        DateTime GST_date;
        DateTime get_date;
        int jobno = 0;
        ...
        /*public void FGetNoofContAEAI(string jobno, string blno)
        {
            ...
            if (cmbbl.SelectedItem.ToString() == mblno)
            {
                ...
                dt_new = AEBLObj.ShowAIEInfoQuerynew(Convert.ToInt32(txtJobno.Text), "SAMPLE", "JOB", 0, Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(Session["LoginDivisionId"].ToString()), Session["StrTranType"].ToString());
        ...
        */
        ...
        protected void txtJobno_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (INVOICEobj.CheckClosedJobs(strTranType, Convert.ToInt32(txtJobno.Text), Convert.ToInt32(Session["LoginBranchid"])) == 1 && Session["StrTranType"].ToString()!="AC")
                {
                ...
                else if (INVOICEobj.CheckClosedJobs(strTranType, Convert.ToInt32(txtJobno.Text), Convert.ToInt32(Session["LoginBranchid"])) == 0 && Session["StrTranType"].ToString() == "AC")
                {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (DtCHeckNew.Rows.Count == 0 && Session["StrTranType"].ToString() == "AC")
                {
                    ScriptManager.RegisterStartupScript(btnAdd, typeof(System.Web.UI.WebControls.Button), "logix", "alertify.alert('Job is still Open. You Can not Add charges Here.');", true);
                    return;
                }
                ...
                if (btnAdd.Text == "Add")
                {
                    ...
                    {
                        case "FE":
                            logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1015, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value) + "/" + txtcurr.Text + "/" + txtrate.Text + "/" + txtamount.Text);
                            break;
                        case "FI":
                            logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1022, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value) + "/" + txtcurr.Text + "/" + txtrate.Text + "/" + txtamount.Text);
                            break;
                        case "AE":
                            logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1029, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value) + "/" + txtcurr.Text + "/" + txtrate.Text + "/" + txtamount.Text);
                            break;
                        case "AI":
                            logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1036, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value) + "/" + txtcurr.Text + "/" + txtrate.Text + "/" + txtamount.Text);
                            break;
                        case "CH":
                            logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1969, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value) + "/" + txtcurr.Text + "/" + txtrate.Text + "/" + txtamount.Text);
                            break;
                    }
            ...
            try
            {
                ...
                if (grdcredit.Rows.Count > 0)
                {
                    ...
                    if (hid_confirm.Value.ToString() == "")
                    {
                        ...
                        DtBLNO = DAdvise.FillBLNo(Convert.ToInt32(txtJobno.Text), Session["StrTranType"].ToString(), Convert.ToInt32(Session["LoginDivisionId"]));
                        if (DtBLNO.Rows.Count > 0)
                        {
                            mblno = DtBLNO.Rows[0][0].ToString();
                        }
                            ...
                            if (dtNewCount.Rows.Count > 0)
                            {
                                for (int i = 0; i <= dtNewCount.Rows.Count - 1; i++)
                                {
                                    ...
                                    if (damt > 0)
                                    {
                                        if (int_djobno > 0)
                                        {
                                            if (Voucher == "Debit")
                                            {
                                                ...
                                                if (refno != 0)
                                                {
                                                    ScriptManager.RegisterStartupScript(btnview, typeof(Button), "DataFound", "alertify.alert('Pro Debit Note Updated " + "DNNo" + "=" + refno + "');", true);
                                                }
                                                if (refnonew != 0)
                                                {
                                                    ScriptManager.RegisterStartupScript(btnview, typeof(Button), "DataFound", "alertify.alert('Pro Debit Note Updated " + "DNNo" + "=" + refnonew + "');", true);
                                                }
                                        ...
                                        else
                                        {
                                            if (Voucher == "Debit")
                                            {
                                                ...
                                                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Guid.NewGuid().ToString(), "alertify.alert(' Pro Debit Note Saved " + "Ref No" + "=" + refno + "')", true);
                                                lbl.Text = "Debit Note";
                                                hid_debitDnno.Value = refno.ToString();
                                                GrdLoadNew(hid_debitDnno.Value);
                                                //voutype = "OSSI";
                                                ...
                                                {
                                                    case "FE":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1015, 1, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + lbl.Text);
                                                        break;
                                                    case "FI":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1022, 1, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + lbl.Text);
                                                        break;
                                                    case "AE":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1029, 1, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + lbl.Text);
                                                        break;
                                                    case "AI":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1036, 1, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + lbl.Text);
                                                        break;
                                                    case "CH":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1969, 1, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + lbl.Text);
                                                        break;
                                                }
                                    ...
                                    if (camt > 0)
                                    {
                                        ...
                                        if (int_cjobno > 0)
                                        {
                                            if (Voucher == "Credit")
                                            {
                                                ...
                                                if (grdcredit.Rows.Count > 0)
                                                {
                                                    for (int j = 0; j <= grdcredit.Rows.Count - 1; j++)
                                                    {
                                                        if (string.IsNullOrEmpty(grdcredit.Rows[j].Cells[12].Text) != true)
                                                        {
                                                            ...
                                                            {
                                                                da_obj_OSDNCN.UpdateOSDCNProGstOSV(Convert.ToInt32(hf_jobno.Value), Convert.ToDouble(amount), Convert.ToDateTime(dtdate), Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranTypeO"].ToString(), 6,
                                                ...
                                                if (crefnonew != 0)
                                                {
                                                    ScriptManager.RegisterStartupScript(btnview, typeof(Button), "DataFound", "alertify.alert('Pro Credit Note Updated " + "Ref No" + "=" + crefnonew + "');", true);
                                                }
                                                if (cnrefno != 0)
                                                {
                                                    ScriptManager.RegisterStartupScript(btnview, typeof(Button), "DataFound", "alertify.alert('Pro Credit Note Updated " + "Ref No" + "=" + cnrefno + "');", true);
                                                }
                                                ...
                                                switch (Session["StrTranType"].ToString())
                                                {
                                                    case "FE":
                                                        ...
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1015, 2, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + ddlDebiteOrCredite.SelectedValue);
                                                        break;
                                                    case "FI":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1022, 2, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + ddlDebiteOrCredite.SelectedValue);
                                                        break;
                                                    case "AE":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1029, 2, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + ddlDebiteOrCredite.SelectedValue);
                                                        break;
                                                    case "AI":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1036, 2, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + ddlDebiteOrCredite.SelectedValue);
                                                        break;
                                                    case "CH":
                                                        da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1969, 2, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value) + "/" + ddlDebiteOrCredite.SelectedValue);
                                                        break;
                                                }
                                        ...
                                        else
                                        {
                                            if (Voucher == "Credit")
                                            {
                                                ...
                                                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Guid.NewGuid().ToString(), "alertify.alert('Pro Credit Note Saved " + "Ref No" + "=" + cnrefno + "')", true);
                                    ...
                                    if (deb == 0)
                                    {
                                        ...
                                        ScriptManager.RegisterStartupScript(btnview, typeof(Button), "DataFound", "alertify.alert('Pro Debit Note Deleted');", true);
                                        ...
                                        switch (Session["StrTranType"].ToString())
                                        {
                                            case "FE":
                                                ...
                                                da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1015, 4, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value));
                                                break;
                                            case "FI":
                                                da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1022, 4, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value));
                                                break;
                                            case "AE":
                                                da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1029, 4, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value));
                                                break;
                                            case "AI":
                                                da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1036, 4, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value));
                                                break;
                                            case "CH":
                                                da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1969, 4, Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString() + Convert.ToString(hf_jobno.Value));
                                                break;
                                        }
                                    }
                                    else if (cre == 0)
                                    {
                                        ...
                                        ScriptManager.RegisterStartupScript(btnview, typeof(Button), "DataFound", "alertify.alert('Pro Credit Note Deleted');", true);
                                        // da_obj_logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"].ToString()), 1022, 4, Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToString(hf_jobno.Value));
        ...
        protected void txtdcn_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (INVOICEobj.CheckClosedJobs(strTranType, Convert.ToInt32(txtJobno.Text), Convert.ToInt32(Session["LoginBranchid"])) == 0 && Session["StrTranType"].ToString() == "AC")
                    {
            ...
            if (grddebit.Rows.Count > 0)
            {
                ...
                if (Session["StrTranType"].ToString() == "AE")
                {
                    ...
                    else
                    {
                        ...
                        str_sf = "{DebitAdvise.jobno}=" + txtJobno.Text.ToString() + " and {DebitAdvise.trantype}=\"" + Session["StrTranType"].ToString() + "\" and {DebitAdvise.branchid}=" + Session["LoginBranchid"].ToString();
                ...
                else if (Session["StrTranType"].ToString() == "FI")
                {
                    ...
                    else
                    {
                        ...
                        str_sf = "{DebitAdvise.jobno}=" + txtJobno.Text + " and {DebitAdvise.trantype}=\"" + Session["StrTranType"].ToString() + "\" and {DebitAdvise.branchid}=" + Session["LoginBranchid"].ToString();
                ...
                {
                    case "FE":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1015, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " DAView");
                        break;

                    case "FI":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1022, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " DAView");
                        break;
                    case "AE":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1029, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " DAView");
                        break;
                    case "AI":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1036, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " DAView");
                        break;
                    case "CH":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1969, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " DAView");
                        break;
                }
            ...
            if (grdcredit.Rows.Count > 0)
            {
                ...
                if (Session["StrTranType"].ToString() == "AE")
                {
                    ...
                    else
                    {
                        ...
                        str_sf = "{CreditAdvise.jobno}=" + txtJobno.Text + " and {CreditAdvise.trantype}=\"" + Session["StrTranType"].ToString() + "\"and {CreditAdvise.branchid}=" + Session["LoginBranchid"].ToString();
                ...
                else if (Session["StrTranType"].ToString() == "FI")
                {
                    ...
                    else
                    {
                        ...
                        str_sf = "{CreditAdvise.jobno}=" + txtJobno.Text.ToString() + " and {CreditAdvise.trantype}=\"" + Session["StrTranType"].ToString() + "\" and {CreditAdvise.branchid}=" + Session["LoginBranchid"].ToString();
                ...
                {
                    case "FE":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1015, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " CAView");
                        break;
                    case "FI":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1022, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " CAView");
                        break;
                    case "AE":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1029, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " CAView");
                        break;
                    case "AI":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1036, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " CAView");
                        break;
                    case "CH":
                        obj_da_log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1969, 3, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + " CAView");
                        break;
                }
        ...
        protected void Grd_Details_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (Grd_Details.Rows.Count > 0)
            {
                ...
                // Response.Redirect("../Accounts/OSDCN.aspx?typejobno=" + jobno);
                Response.Redirect("../Accounts/ApprovedOSVouchers.aspx?PROJ=" + jobno1 + "&PROTY=" + typenew + "&PRONO=" + jobno);
            }
        ...
        protected void btn_uploadpopup_Click(object sender, EventArgs e)
        {
            ...
            Session["hf_txtrefno"] = txtdcn.Text;
            Session["vouno"] = null;
        }
        ...
        protected void btn_MoreCust_Yes_Click(object sender, EventArgs e)
        {
            ...
            if (btnAdd.Text == "Add")
            {
                ...
                {
                    case "FE":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1015, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                    case "FI":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1022, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                    case "AE":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1029, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                    case "AI":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1036, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                    case "CH":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1969, 1, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                }
            ...
            else if (btnAdd.Text == "Update")
            {
                ...
                {
                    case "FE":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1015, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                    case "FI":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1022, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                    case "AE":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1029, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                    case "AI":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1036, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                    case "CH":
                        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1969, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                        break;
                }
                ...
                //{
                //    case "FE":
                //        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 36, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                //        break;
                //    case "FI":
                //        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 37, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                //        break;
                //    case "AE":
                //        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 38, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                //        break;
                //    case "AI":
                //        logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 39, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + cmbbl.Text + "/" + Convert.ToInt32(hdnChargid.Value));
                //        break;
                //}
                //chargetxtclear();
                GrdLoad(ddlDebiteOrCredite.SelectedValue);
        ...
        protected void loadgridlog()
        {
            ...
            {
                case "FE":
                    obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1015, "", cmbbl.Text, cmbbl.Text, Session["StrTranType"].ToString());
                    break;
                case "FI":
                    obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1022, "", cmbbl.Text, cmbbl.Text, Session["StrTranType"].ToString());
                    break;
                case "AE":
                    obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1029, "", cmbbl.Text, cmbbl.Text, Session["StrTranType"].ToString());
                    break;
                case "AI":
                    obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1036, "", cmbbl.Text, cmbbl.Text, Session["StrTranType"].ToString());
                    break;
            }
            if (cmbbl.Text != "")
            {

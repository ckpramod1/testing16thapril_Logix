...
*/
        ...
        .BLRight {
            ...
            box-shadow: rgb(244 244 244 / 80%);
        }

            /*     .BLRight .FormGroupContent4 span {
                -webkit-box-shadow: 0 0 0 30px #d3d3d336 inset !important;
            }*/
    ...
    height: 154px !important;
        ...
        span#logix_CPH_Label26 {
    -webkit-box-shadow: 0 0 0 30px #f4f4f4cc inset !important;
}
        span#logix_CPH_Label27 {
    -webkit-box-shadow: 0 0 0 30px #f4f4f4cc inset !important;
}
    </style>
            ...
            <ItemStyle CssClass="hide" />
                        ...
                        <div class="BLRight">
                            ...
                            <div class="FormGroupContent4">
                                <div id="lbl_txt" runat="server" visible="false">
                                    <div class="">
                                        ...
                                        <div class="ApprovedValue" style="margin: 3px 0px 0px 7px !important;">
                                            <span style="color: #06529c!important">PREPARED BY</span>
                                            <asp:Label ID="lbl_prepare" runat="server" Text=""></asp:Label>
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="ApprovedValue" runat="server" visible="false" id="lbl_appr" style="margin: 3px 0px 0px 7px !important;">
                            ...
                            <div class="FormGroupContent4" style="display: flex">
                                <div class="custom-col custom-mr-1 spancolor">
                                ...
                                <div class="custom-col custom-mr-05  spancolor">
                            ...
                            <div class=" FormGroupContent4 custom-d-flex">
                                <div class="custom-col custom-mr-10 spancolor">
                                    <asp:Label ID="Label25" runat="server" Text="Vessel"></asp:Label>
                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control inputcolor" AutoPostBack="True" OnTextChanged="txtblno_TextChanged" placeholder="" ToolTip="Vessel Voy" ReadOnly="true"></asp:TextBox>
                                </div>
                                <div class="custom-col custom-mr-10 spancolor">
                            ...
                            <div class="FormGroupContent4 custom-d-flex hide">
                                ...
                                <div class="custom-col spancolor " id="txtcreditapp1" runat="server">
                            ...
                            <div class="FormGroupContent4">
                                <div style="width:50%;float:left"  class="pol" >
                                ...
                                <asp:Panel ID="pnlContlist" runat="server" CssClass="lst_cont TextArea">
                                         ...
                                         <asp:Label ID="Label26" runat="server"  CssClass="cbm" Text="CBM"></asp:Label>
                            ...
                            <div class="FormGroupContent4" style="background: #f4f4f4cc;" >
                                <asp:Panel ID="pnlVolList" runat="server" CssClass="lst_vol TextArea">
                                         <asp:Label ID="Label27" runat="server"    Text="Container Details"></asp:Label>

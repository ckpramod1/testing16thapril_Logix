...
{
    public partial class ApprovedAdminDCNvouchers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Request.QueryString.ToString().Contains("VNo"))
                {
                    ddl_voutype.SelectedItem.Text = lbl_Header.Text;
                    if (ddl_voutype.SelectedItem.Text == "Admin Purchase Invoice")
                    {
                        ddl_voutype.SelectedValue = "3";
                    }
                    else if (ddl_voutype.SelectedItem.Text == "Admin Sales Invoice")
                    {
                        ddl_voutype.SelectedValue = "4";
                    }
        ...
        protected void txt_Refno_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                obj_dt = obj_da_AdminDnCN.ShowAdminDCNHeadFromDCNNoCOM(int.Parse(txt_Refno.Text), int.Parse(ddl_voutype.SelectedValue), int.Parse(txt_year.Text), BranchID);
                ...
                if (obj_dt.Rows.Count > 0)
                {
                    ...
                    if (INVOICEobj.GetVoucherAgainstRcptPayCOM(Convert.ToInt32(txt_Refno.Text), BranchID, int.Parse(txt_year.Text), type) != "0")
                    {
                        Against = INVOICEobj.GetVoucherAgainstRcptPayNEWCOM(Convert.ToInt32(txt_Refno.Text), BranchID, int.Parse(txt_year.Text), type);
                    }
        ...
        private void Fn_Getdetail()
        {
            try
            {
                DataTable obj_dt = new DataTable();
                //DataAccess.Accounts.AdminDCNNo obj_da_AdminDNCN = new DataAccess.Accounts.AdminDCNNo();
                obj_dt = obj_da_AdminDNCN.GetAdminDCNDetailsCOM(int.Parse(txt_Refno.Text), Convert.ToInt32(ddl_voutype.SelectedValue), int.Parse(txt_year.Text), BranchID);
                double Total = 0;
                ...
                obj_dt = obj_da_AdminDNCN.GetAdminDCNDetailswithCustCOM(int.Parse(txt_Refno.Text), Convert.ToInt32(ddl_voutype.SelectedValue), int.Parse(txt_year.Text), BranchID);
        ...
        protected void btn_uploadpopup_Click(object sender, EventArgs e)
        {
            if (txt_Refno.Text == "")
            {
                ScriptManager.RegisterStartupScript(btn_uploadpopup, typeof(Button), "Checklist", "alertify.alert('Kindly Enter the Pro Ref # ');", true);
                txt_Refno.Focus();
                return;
            }
            ...
            if (txt_Refno.Text != "")
            {
                ...
                DataTable dt = new DataTable();
                 HdnJobNo.Value = "0";
                dt = appobj.view_invoicecnops(Convert.ToInt32(txt_Refno.Text), Convert.ToInt32(HdnJobNo.Value), Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(txt_year.Text), ddl_voutype.SelectedItem.Text);
                ViewState["dt"] = dt;
        ...
        protected void btn_view_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_Refno.Text.Trim().Length > 0)
                {
                  ...
                  if(  ddl_voutype.SelectedValue=="4")
                  {
                      hid_type.Value = "DN";
                  }
                    else
                  {
                    ...
                    if (hid_type.Value == "DN")
                    {
                        ...
                        if (gst_date <= getdate)
                        {
                            Str_Script = "window.open('../Reportasp/AdminvouchersRPT.aspx?DCN=" + txt_Refno.Text + "&vouyear=" + txt_year.Text + "&total=" + txt_total.Text + "&form=" + "Admin-DN" + "&customertype=" + agent + "&branchid=" + Convert.ToInt32(BranchID) + "&" + this.Page.ClientQueryString + "','','');";
                        }
                        else
                        {
                            Str_Script = "window.open('../Tools/ReportViewFA.aspx?SFormula=" + Str_sf + "&Parameter=" + Str_sp + "&RFName=" + Str_RptName + "&" + this.Page.ClientQueryString + "','','');";
                        }
                        //Str_Script = "window.open('../Reportasp/AdminvouchersRPT.aspx?DCN=" + txt_Refno.Text + "&vouyear=" + txt_year.Text + "&total=" + txt_total.Text + "&form=" + "Admin-DN" + "&" + this.Page.ClientQueryString + "','','');";
                        ScriptManager.RegisterStartupScript(btn_view, typeof(Button), "Debit", Str_Script, true);
                        Session["str_sp"] = Str_sp;
                    }
                    else
                    {
                        ...
                        if (gst_date <= getdate)
                        {
                            Str_Script = "window.open('../Reportasp/AdminvouchersRPT.aspx?DCN=" + txt_Refno.Text + "&vouyear=" + txt_year.Text + "&total=" + txt_total.Text + "&form=" + "Admin-CN" + "&customertype=" + agent + "&branchid=" + Convert.ToInt32(BranchID) + "&" + this.Page.ClientQueryString + "','','');";
                        }
                        else
                        {
                            Str_Script = "window.open('../Tools/ReportViewFA.aspx?SFormula=" + Str_sf + "&Parameter=" + Str_sp + "&RFName=" + Str_RptName + "&" + this.Page.ClientQueryString + "','','');";
                        }
                        //Str_Script = "window.open('../Reportasp/AdminvouchersRPT.aspx?DCN=" + txt_Refno.Text + "&vouyear=" + txt_year.Text + "&total=" + txt_total.Text + "&form=" + "Admin-CN" + "&" + this.Page.ClientQueryString + "','','');";
                        ScriptManager.RegisterStartupScript(btn_view, typeof(Button), "Debit", Str_Script, true);
                        Session["str_sp"] = Str_sp;
                    }
                }

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="profomaAdminVouchers.aspx.cs" Inherits="logix.FAForm.profomaAdminVouchers" %>
                ...
                $("#<%=txt_to.ClientID %>").autocomplete({
                    ...
                    source: function (request, response) {
                        ...
                        if ($("#<%=radio_customer.ClientID %>").is(':checked')) {
                            ...
                            alert('Select Party type as Customer or Agent');
                ...
                $("#<%=txt_chrgdes.ClientID %>").autocomplete({
                    ...
                    source: function (request, response) {
                        ...
                        if ($("#<%=radio_customer.ClientID %>").is(':checked')) {
                            ...
                            alert('Please Check Customer or Agent');
                            $("#<%=radio_customer.ClientID %>").focus();
                            return false;
                        }
          ...
          <%--  $(document).ready(function () {
            ...
            $(document).ready(function () {
                $("#<%=txtsupplyto.ClientID %>").autocomplete({
                    ...
                    select: function (event, i) {
                        $("#<%=txtsupplyto.ClientID %>").val($.trim(i.item.label));
                        $("#<%=txtsupplyto.ClientID %>").change();
                        $("#<%=hid_SupplyTo.ClientID %>").val(i.item.val);
                    },
                    focus: function (event, i) {
                    ...
                    close: function (event, i) {
                        var result = $("#<%=txtsupplyto.ClientID %>").val().toString();
                        $("#<%=txtsupplyto.ClientID %>").val($.trim(result));
                    },
                    minLength: 1
                });
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
     ...
     <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li><a href="#" title="" id="lbl_head" runat="server">Proforma Admin Sales Invoice</a></li>
            <li>
                    ...
                    <div style="display:flex;justify-content:flex-end">
                         <div class="BLDropInputNewForNew">
                                ...
                                <asp:DropDownList ID="ddlTypes" runat="server" ToolTip="Type" AutoPostBack="True" OnSelectedIndexChanged="ddlTypes_SelectedIndexChanged" Width="100%" data-placeholder="Type" TabIndex="2" CssClass="chzn-select">
                                    ...
                                    <asp:ListItem Value="3" Text="">Proforma Admin Purchase Invoice</asp:ListItem>
                                    <asp:ListItem Value="4" Text="">Proforma Admin Sales Invoice</asp:ListItem>
                                </asp:DropDownList>

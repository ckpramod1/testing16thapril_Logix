...
{
    public partial class PaymentFA_Receipt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((ScriptManager)Master.FindControl("ScriptManager1")).RegisterPostBackControl(Grid_detail);
            ((ScriptManager)Master.FindControl("ScriptManager1")).RegisterPostBackControl(txt_cust);
            ...
            else if (lbl_head.Text == "Receipts")
            {
                Session["Rtype"] = "R";
                Session["rptype"] = Session["Rtype"];
            }
            ...
            if (!IsPostBack)
            {
                ...
                dtrights = Log_Obj.getrights4payrec(Convert.ToInt32(Session["LoginEmpId"].ToString()));
                if (dtrights.Rows.Count > 0)
                {
                    onaccount.Visible = true;
                    btn_onaccount.Visible = true;
                }
                else
                {
                    onaccount.Visible = false;
                    btn_onaccount.Visible = false;
                }
                ...
                /*if (Request.QueryString.ToString().Contains("type"))
                {
                    ...
                    if (product == "Payments")
                    {
                        ...
                        {
                            ddl_branch.SelectedValue = Session["SelectedBranch"].ToString();
                        }
                        else
                        {
                            ddl_branch.SelectedValue = Session["branch"].ToString();

                        }

                     
                        ddl_mode.SelectedItem.Text = "Cash";
                        lnk_amount_Click(sender, e);
                ...
                if (lbl_head.Text == "Payments")
                {
                    ...
                    txt_recieve.ToolTip = "Payment To";
                    Label8.Text = "Payment #";
                    Label21.Text = "Payment To";
                    //txt_recp.Attributes.Add("placeholder", "Payment #");
                    txt_recp.ToolTip = "Payment #";
                    txt_recieve.ToolTip = "Payment To";
                    Label4.Visible = true;
                    ddl_branch.Visible = true;
                    Label16.Text = "Tax/ledger";
                    //txt_deduction.Attributes.Add("placeholder", "Charges");
                    txt_deduction.ToolTip = "Tax/ledger";
                    //txt_dedu_amt.Attributes.Add("placeholder", "Amount");
                    Label17.Text = "Amount";
                    txt_dedu_amt.ToolTip = "Amount";
        ...
        public static List<string> GetCustomerPano(string prefix)
        {
            ...
            dt = customerobj.GetLikeCustomerpan(prefix);
            ...
            try
            {
                ...
                if (btn_save.ToolTip == "Save")
                {
                    ...
                    for (int i = 0; i <= Grid_detail.Rows.Count - 1; i++)
                    {
                        ...
                        if (Session["rptype"].ToString() == "R")
                        {
                            if (IE == "I" || IE == "D" || IE == "V" || IE == "X" || IE == "O" || IE == "B" || IE == "OI" || IE == "OD" || IE == "OV" || IE == "OX" || IE == "OB" || IE == "F" || IE == "H" || IE == "OF" || IE == "OH")
                            {
                        ...
                        {
                            if (IE == "I" || IE == "D" || IE == "V" || IE == "X" || IE == "B" || IE == "B" || IE == "OI" || IE == "OD" || IE == "OV" || IE == "OX" || IE == "OB" || IE == "F" || IE == "H" || IE == "OF" || IE == "OH")
                            {
                                IncTotAmnt = Convert.ToDouble(IncTotAmnt + Convert.ToDouble(Rec_Amount.Text.TrimStart().TrimEnd().Trim()));
                            }
                    ...
                    if (rid != 0)
                    {
                        ...
                        if (dtInvoive.Rows.Count > 0)
                        {
                            ...
                            for (int i = 0; i <= dtInvoive.Rows.Count - 1; i++)
                            {
                                ...
                                {
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "I") dtrow["invoiceno"] = "SI - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "D") dtrow["invoiceno"] = "OSSI - " + dtInvoive.Rows[i][2].ToString();
                                    ...
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "P") dtrow["invoiceno"] = "PI - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "C") dtrow["invoiceno"] = "OSPI - " + dtInvoive.Rows[i][2].ToString();
                                    ...
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OI") dtrow["invoiceno"] = "OB SI - " + dtInvoive.Rows[i][2].ToString();         //NewOne
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OD") dtrow["invoiceno"] = "OB OSSI - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OV") dtrow["invoiceno"] = "OB DN - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OX") dtrow["invoiceno"] = "OB ADN - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OP") dtrow["invoiceno"] = "OB PI - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OC") dtrow["invoiceno"] = "OB OSPI - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OE") dtrow["invoiceno"] = "OB CN - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OS") dtrow["invoiceno"] = "OB ACN - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OB") dtrow["invoiceno"] = "OB BOS - " + dtInvoive.Rows[i][2].ToString();

                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "F") dtrow["invoiceno"] = "SI OC  - " + dtInvoive.Rows[i][2].ToString();  // Vino [05-03-2024]
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OF") dtrow["invoiceno"] = "OB SI OC - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "G") dtrow["invoiceno"] = "PI OC  - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OG") dtrow["invoiceno"] = "OB PI OC - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "H") dtrow["invoiceno"] = "BS OC  - " + dtInvoive.Rows[i][2].ToString();
                                    if (dtInvoive.Rows[i][5].ToString().Trim() == "OH") dtrow["invoiceno"] = "OB BS OC - " + dtInvoive.Rows[i][2].ToString();
                ...
                if (hid_custid.Value != "")
                {
                    ...
                    if (dtInvoice1.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dtInvoice1.Rows.Count; i++)
                        {
                            ...
                            //if (dtInvoice1.Rows[i]["voutype"].ToString() == "I")
                            //{
                            //    dtrow["invoiceno"] = "SI - " + dtInvoice1.Rows[i][2].ToString();
                            //}
                            //else if (dtInvoice1.Rows[i]["voutype"].ToString() == "P")
                            //{
                            //    dtrow["invoiceno"] = "CN-OPS - " + dtInvoice1.Rows[i][2].ToString();
                            //}
                            //else if (dtInvoice1.Rows[i]["voutype"].ToString() == "V")
                            //{
                            //    dtrow["invoiceno"] = "CN - " + dtInvoice1.Rows[i][2].ToString();
                            //}
                            //else if (dtInvoice1.Rows[i]["voutype"].ToString() == "E")
                            //{
                            //    dtrow["invoiceno"] = "DN - " + dtInvoice1.Rows[i][2].ToString();
                            //}
                            //else if (dtInvoice1.Rows[i]["voutype"].ToString() == "B")
                            //{
                ...
                if (hid_custid.Value != "")
                {
                    ...
                    if (dtOverseas.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dtOverseas.Rows.Count; i++)
                        {
                            ...
                            dtrow["invoiceno"] = "OSSI - " + dtOverseas.Rows[i][2].ToString();
            ...
            if (hid_custid.Value != "")
            {
                ...
                if (dtPA.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtPA.Rows.Count; i++)
                    {
                        ...
                        dtrow["invoiceno"] = "PI - " + dtPA.Rows[i][2].ToString();
            ...
            if (hid_custid.Value != "")
            {
                ...
                if (dtOverseasCredit.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtOverseasCredit.Rows.Count; i++)
                    {
                        ...
                        dtrow["invoiceno"] = "OSSI - " + dtOverseasCredit.Rows[i][2].ToString();
        ...
        private void Journal()
        {
            ...
            {
                Custid = Convert.ToInt32(hid_custid.Value);
                dtJournal = Bank_Obj.GetjnrlRecptDtls(Custid, did, "FA" + dispyear, "");    //NewOne //24/05/2022
                ...
                if (dtJournal.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtJournal.Rows.Count; i++)
                    {
                        ...
                        dtrow["vendorrefdate"] = "";
                        //dtrow["jlid"] = ""; //NewOne
                        dtrow["jlid"] = dtJournal.Rows[i][8].ToString();        //NewOne //24/05/2022
                ...
                for (int i = 0; i <= cVal; i++)
                {
                    if (Grid_detail.Rows[i].Cells[2].Text != "On Account")
                    {
                        ...
                        if (ramt > 0 && vtype != "O")
                        {
                            ...
                            hid_Lid.Value = Grid_detail.Rows[i].Cells[15].Text;
                            if (vouamt > ramt)
                            {
                                Setteled = 'N';
                            }
                            ...
                            if (Grid_detail.Rows[i].Cells[12].Text != "")
                            {
                                ...
                                {
                                    vendordatetime = "";
                                    // vendordatetime =  (Grid_detail.Rows[i].Cells[12].Text) ;
                                }
                                else
                                {
                                    if (Grid_detail.Rows[i].Cells[12].Text == "&nbsp;")
                            ...
                            vouchtype1 = "";
                            if (vtype == "OI" || vtype == "OD" || vtype == "OV" || vtype == "OS" || vtype == "OP" || vtype == "OE" || vtype == "OE" || vtype == "OX" || vtype == "OF" || vtype == "OG" || vtype == "OH")
                            {
                            ...
                            if (vtype == "J")
                            {
                                ...
                                Bank_Obj.InsRecptAginstInvjid(rid, rtype, 0, vouchtype, gbid, vouamt, ramt, Setteled, RAvouyear, jrefno, jltype, Convert.ToInt16(hid_Lid.Value));  //NewOne //24/05/2022     
                            }
                            else
                            {
                                if (vendordatetime != "")
                                {
                                    Bank_Obj.InsRecptAginstInvwithvendor(rid, rtype, invno, Convert.ToChar(vouchtype1), gbid, vouamt, ramt, Setteled, RAvouyear, vendorrefno, Convert.ToDateTime(Utility.fn_ConvertDate(vendordatetime)));
        ...
        protected void txt_receiptamount_TextChanged(object sender, EventArgs e)
        {
            ...
            if (Session["rptype"].ToString() == "P")
            {
                ...
                for (int i = 0; i <= Grid_detail.Rows.Count - 1; i++)
                {
                    ...
                    if (IE == "I" || IE == "D" || IE == "V" || IE == "X" || IE == "B" || IE == "OI" || IE == "OD" || IE == "OV" || IE == "OX" || IE == "OB" || IE == "F" || IE == "H" || IE == "OF" || IE == "OH")// && (GridCustID == Convert.ToInt32(Grid_detail.Rows[i].Cells[10].Text)))
                    {
                    ...
                    else if (IE == "P" || IE == "C" || IE == "E" || IE == "S" || IE == "O" || IE == "OP" || IE == "OC" || IE == "OE" || IE == "OS" || IE == "G" || IE == "OG") //&& (GridCustID == Convert.ToInt32(Grid_detail.Rows[i].Cells[10].Text)))
                    {
                        TextBox txt = (TextBox)Grid_detail.Rows[i].FindControl("txt_receiptamount");
            ...
            else if (Session["rptype"].ToString() == "R")
            {
                ...
                for (int i = 0; i <= Grid_detail.Rows.Count - 1; i++)
                {
                    ...
                    if (IE == "I" || IE == "D" || IE == "V" || IE == "X" || IE == "O" || IE == "B" || IE == "OI" || IE == "OD" || IE == "OV" || IE == "OX" || IE == "OB" || IE == "F" || IE == "H" || IE == "OF" || IE == "OH") //&& (GridCustID == Convert.ToInt32(Grid_detail.Rows[i].Cells[10].Text)))
                    {
                        TextBox txt = (TextBox)Grid_detail.Rows[i].FindControl("txt_receiptamount");
                        if (txt.Text == "")
                        {
                    ...
                    else if (IE == "P" || IE == "C" || IE == "E" || IE == "S" || IE == "OP" || IE == "OC" || IE == "OE" || IE == "OS" || IE == "G" || IE == "OG") //&& (GridCustID == Convert.ToInt32(Grid_detail.Rows[i].Cells[10].Text)))
                    {
                        TextBox txt = (TextBox)Grid_detail.Rows[i].FindControl("txt_receiptamount");
                        if (txt.Text == "")
                        {
            ...
            /* if (Grid_detail.Rows.Count > 0)
             {
                 ...
                 {
                     TextBox grdtxt = (TextBox)Grid_detail.Rows[index + 1].Cells[3].FindControl("txt_receiptamount");
                     grdtxt.Focus();
                 }
        ...
        protected void txt_recp_TextChanged(object sender, EventArgs e)
        {
            if (ddl_mode.Text == "Cash")
            {
                Btn_rev.Visible = true;
                revid.Visible = true;
            }
            else
            {
                Btn_rev.Visible = false;
                revid.Visible = false;
            }
        ...
        public void calculation(int rowindex)
        {
            ...
            if (Session["rptype"].ToString() == "P")
            {
                ...
                for (int i = 0; i <= Grid_detail.Rows.Count - 1; i++)
                {
                    ...
                    if (IE == "I" || IE == "D" || IE == "V" || IE == "X" || IE == "OI" || IE == "OD" || IE == "OV" || IE == "OX" || IE == "B" || IE == "OB" || IE == "F" || IE == "OF" || IE == "H" || IE == "OH") //&& (GridCustID == Convert.ToInt32(Grid_detail.Rows[i].Cells[10].Text)))
                    {
                        TextBox txt = (TextBox)Grid_detail.Rows[i].FindControl("txt_receiptamount");
            ...
            else if (Session["rptype"].ToString() == "R")
            {
                ...
                for (int i = 0; i <= Grid_detail.Rows.Count - 1; i++)
                {
                    ...
                    if (IE == "I" || IE == "D" || IE == "V" || IE == "X" || IE == "O" || IE == "OI" || IE == "OD" || IE == "B" || IE == "OB" || IE == "OV" || IE == "OX" || IE == "F" || IE == "OF" || IE == "H" || IE == "OH")// && (GridCustID == Convert.ToInt32(Grid_detail.Rows[i].Cells[10].Text)))
                    {
                        TextBox txt = (TextBox)Grid_detail.Rows[i].FindControl("txt_receiptamount");
                        if (txt.Text == "")
                        {
            ...
            if (hid_custid.Value != "")
            {
                ...
                if (dtINV.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtINV.Rows.Count; i++)
                    {
                        ...
                        if (dtINV.Rows[i][5].ToString() == "OF") // Vino [05-03-2024]
                        {
                            dtrow["invoiceno"] = "OB SI OC - " + dtINV.Rows[i][2].ToString();
                        }
                        else if (dtINV.Rows[i][5].ToString() == "OG")
                        {
                            dtrow["invoiceno"] = "OB PI OC - " + dtINV.Rows[i][2].ToString();
                        }
                        else if (dtINV.Rows[i][5].ToString() == "OH")
                        {
            ...
            if (hid_custid.Value != "")
            {
                ...
                if (dtINV.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtINV.Rows.Count; i++)
                    {
                        ...
                        else if (dtINV.Rows[i][5].ToString() == "OF") // Vino [05-03-2024]
                        {
                            dtrow["invoiceno"] = "OB SI OC - " + dtINV.Rows[i][2].ToString();
                        }
                        else if (dtINV.Rows[i][5].ToString() == "OG")
        ...
        protected void btn_upload_Click(object sender, EventArgs e)
        {
            ...
            {
                path = Server.MapPath("~/PaymentFA_BackDated/" + filename);
                ...
                fileupload1.PostedFile.SaveAs(Server.MapPath("~/PaymentFA_BackDated/" + filename.ToString()));
                path = Server.MapPath("~/PaymentFA_BackDated/" + filename);
        ...
        public void ImportAttendence1(string PrmPathExcelFile)
        {
            try
            {
                ...
                MyCommand = new System.Data.OleDb.OleDbDataAdapter("select * from [Collection Report$]", MyConnection);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int i = 0; i <= dt.Rows.Count - 1; i++)
                {
                    for (int j = 0; j <= Grid_detail.Rows.Count - 1; j++)
                    {
                        ...
                        {
                            if (dt.Rows[i]["Inv #"] is DBNull)
                            { continue; }
                            else
                            {
                                CheckBox Chk = (CheckBox)Grid_detail.Rows[j].FindControl("Chkrecpfc");

                                hid_invoiceno.Value = Grid_detail.Rows[j].Cells[6].Text;
                                // if (Convert.ToInt32(dt.Rows[i]["Inv #"]) == Convert.ToInt32(hid_invoiceno.Value))
                                if (Convert.ToInt32(dt.Rows[i]["Inv #"]) == Convert.ToInt32(hid_invoiceno.Value))
                                {
                                    amt = Convert.ToDouble(dt.Rows[i]["Invoice Amount"]);
                                    double amt1 = Convert.ToDouble(Grid_detail.Rows[j].Cells[3].Text);
                                    if (amt1 > amt)
                                    {

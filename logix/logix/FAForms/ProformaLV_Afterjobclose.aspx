<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ProformaLV_Afterjobclose.aspx.cs" Inherits="logix.FAForm.ProformaLV_Afterjobclose" %>
        ...
        function pageLoad(sender, args) {
            $(document).ready(function () {
                ...
                $("#<%=txtblno.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "../FAForms/ProformaLV_Afterjobclose.aspx/GetBLno",
            ...
            $(document).ready(function () {
                ...
                $("#<%=txtto.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "../FAForms/ProformaLV_Afterjobclose.aspx/GetToCust",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $("#<%=txtcharge.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "../FAForms/ProformaLV_Afterjobclose.aspx/GetCharges",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $("#<%=txtcurr.ClientID %>").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: "../FAForms/ProformaLV_Afterjobclose.aspx/GetLikeCurrency",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
                    ...
                    <div class="FormGroupContent4 FixedButtons">
                         <div class="right_btn">
                            <div class="btn ico-save" id="btnsave1" runat="server">
                                <asp:button id="btnsave" runat="server" tooltip="Save"   tabindex="11" onclick="btnsave_Click" />
                            </div>
                  ...
                  <%--  <div class="FormGroupContent4">
                    ...
                    <div class="FormGroupContent4">
                        ...
                        <div class="VendorRef" id="txtVendorRefnodate1" runat="server">
                            <asp:label id="Label9" runat="server" text="Customer Ref Date"></asp:label>
                          ...
                          <div class="VendorRefN blueheighlight" id="txtcredit" runat="server">
    ...
    <div class="FormGroupContent4" style="margin-top: 7px !important;" >
                ...
                <asp:textbox id="txtAllDetails" runat="server" style="resize: none;" rows="2" tooltip="" placeholder="" cssclass="form-control" enabled="false" tabindex="9" textmode="MultiLine" width="100%"></asp:textbox>
                    ...
                    <div class="FormGroupContent4 boxmodal">
                        ...
                        <div class="BLDropN2 blueheighlight">
                            <asp:label id="Label28" runat="server" text="Base / Units"></asp:label>
        ...
        <br />
        <div style="font-size: 10pt"><b>Do You Want GST Applicable For This Charge </b></div>
        <br />
        <div class="div_confirm">

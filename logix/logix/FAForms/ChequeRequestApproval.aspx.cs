...
{
    public partial class ChequeRequestApproval : System.Web.UI.Page
    {
        ...
        private void Fn_Getdetail()
        {
            try
            {
                ...
                if (ddl_branch.SelectedItem.Text == "ALL")
                {
                    ...
                    {
                        obj_dt = obj_da_Cheque.GetChequeApproval("PA", transtype, int_divisionid, 0);
                    }
                    else if (rbt_CN.Checked == true)
                    {
                        obj_dt = obj_da_Cheque.GetChequeApproval("CN", transtype, int_divisionid, 0);
                    }
                    else if (rbt_CNAdmin.Checked == true)
                    {
                        obj_dt = obj_da_Cheque.GetChequeApproval("AP", transtype, int_divisionid, 0);
                    }
                }
                else
                {
                    if (rbt_CNOP.Checked == true)
                    {
                        obj_dt = obj_da_Cheque.GetChequeApproval("PA", transtype, int_divisionid, intBranchID);
                    }
                    else if (rbt_CN.Checked == true)
                    {
                        obj_dt = obj_da_Cheque.GetChequeApproval("CN", transtype, int_divisionid, intBranchID);
                    }
                    else if (rbt_CNAdmin.Checked == true)
                    {
                        obj_dt = obj_da_Cheque.GetChequeApproval("AP", transtype, int_divisionid, intBranchID);
                    }
                }
                    ...
                    if (Chk.Checked == true)
                    {
                        ...
                        if (Session["StrTranTypeCA"].ToString() != "CA")
                        {
                            ...
                            if (rbt_CNOP.Checked == true)
                            {
                                ...
                                {
                                    obj_da_Cheque.UpdChequeApproval4BrHead(int_Vouno, int_Vyear, str_trantype, int_Branchid, int_Empid, "PA");
                            ...
                            else if (rbt_CN.Checked == true)
                            {
                                if (Grd_Cheque.Rows[row.RowIndex].Cells[11].Text.ToString() == "Cash")
                                {
                                    obj_da_Cheque.UpdChequeApproval4BrHead(int_Vouno, int_Vyear, str_trantype, int_Branchid, int_Empid, "CN");
                            ...
                            else if (rbt_CNAdmin.Checked == true)
                            {
                                if (Grd_Cheque.Rows[row.RowIndex].Cells[11].Text.ToString() == "Cash")
                                {
                                    obj_da_Cheque.UpdChequeApproval4BrHead(int_Vouno, int_Vyear, str_trantype, int_Branchid, int_Empid, "AP");
                        ...
                        else if (Session["StrTranTypeCA"].ToString() == "CA")
                        {
                            ...
                            if (rbt_CNOP.Checked == true)
                            {
                                obj_da_Cheque.UpdChequeApproval4Co(int_Vouno, int_Vyear, str_trantype, int_Branchid, int_Empid, "PA");
                                obj_da_Log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1065, 2, Convert.ToInt32(Session["LoginBranchid"]), "Vouno : " + int_Vouno + "/CN-Admin/Trantype : " + str_trantype);
                            }
                            else if (rbt_CN.Checked == true)
                            {
                                obj_da_Cheque.UpdChequeApproval4Co(int_Vouno, int_Vyear, str_trantype, int_Branchid, int_Empid, "CN");
                                obj_da_Log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1065, 2, Convert.ToInt32(Session["LoginBranchid"]), "Vouno : " + int_Vouno + "/CN-Admin/Trantype : " + str_trantype);
                            }
                            else if (rbt_CNAdmin.Checked == true)
                            {
                                obj_da_Cheque.UpdChequeApproval4Co(int_Vouno, int_Vyear, str_trantype, int_Branchid, int_Empid, "AP");
                                obj_da_Log.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1065, 2, Convert.ToInt32(Session["LoginBranchid"]), "Vouno : " + int_Vouno + "/CN-Admin/Trantype : " + str_trantype);
                            }
                        }
                    }

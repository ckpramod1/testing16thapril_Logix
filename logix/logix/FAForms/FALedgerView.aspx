<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="FALedgerView.aspx.cs" Inherits="logix.FAForm.FALedgerView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../Styles/LedgerView.css" rel="Stylesheet" type="text/css" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
    ...
    <asp:Button ID="btn_outstd" runat="server" Text="Outstanding" ToolTip="Outstanding" OnClick="btn_outstd_Click" />
</div>
                            <div class="btn ico-branch">
    <asp:Button ID="btnagref" runat="server" Text="Agref" AccessKey="R" ToolTip="Agref" OnClick="btnagref_Click" />
</div>
                           <div class="btn ico-print hide">
                               <asp:Button ID="btnprint" runat="server" Text="Print" ToolTip="Print" AccessKey="P" OnClick="btnprint_Click" />
                           </div>
                           <div class="btn ico-excel">
                               <asp:Button ID="btnexcel" runat="server" Text="Excel" ToolTip="Excel" AccessKey="E" OnClick="btnexcel_Click" />
                           </div>
                           <div class="btn ico-pending" id="pending_id" runat="server" Visible="false"  >
                               <asp:Button ID="btnpendbills" runat="server" Text="Pending Bills" ToolTip="Pending Bills" Visible="false" AccessKey="n" OnClick="btnpendbills_Click" CssClass="btn" />
                           </div>
                           <div class="btn ico-log" id="bills_id" runat="server" Visible="false"  >
                               <asp:Button ID="btnallbills" runat="server"  Text="All Bills" ToolTip="All Bills" Visible="false" AccessKey="A" OnClick="btnallbills_Click" />
                           </div>
                           <div class="btn ico-cancel">
                               <asp:Button ID="btncancel" runat="server" Text="Cancel" AccessKey="C" ToolTip="Cancel" OnClick="btncancel_Click" />
                           </div>
                ...
                <div class="widget-content">
                    ...
                    <div class="FormGroupContent4 boxmodal">
                        ...
                        <div class="LedgerInput">
                            ...
                            <asp:Label ID="lbl_Esc" runat="server" Text="Ledger Name"></asp:Label>

                            <asp:TextBox ID="txtLedgerName" runat="server" CssClass="form-control" AutoPostBack="true" ToolTip="Ledger Name" placeholder="" OnTextChanged="txtLedgerName_TextChanged"></asp:TextBox>
                        </div>
                        <div class="LedgerInput1">

                            <asp:Label ID="Label1" runat="server" Text="SubGroup"></asp:Label>
                            <asp:TextBox ID="Txt_subname" ReadOnly="true" runat="server" CssClass="form-control" ToolTip="SubGroup" placeholder=""></asp:TextBox>
                        </div>
                        <div class="LedgerInput2">
                            <asp:Label ID="Label2" runat="server" Text="Group Name"> </asp:Label>
                            <asp:TextBox ID="Txt_Groupname" ReadOnly="true" runat="server" CssClass="form-control" ToolTip="Group Name" placeholder=""></asp:TextBox>
                        </div>
                        ...
                        <div class="right_btn custom-mt-2">
                            <div class="btn ico-get">
                                <asp:Button ID="btnview" runat="server" Text="Get" ToolTip="Get" OnClick="btnview_Click" />
                            </div>
                        </div>
                            ...
                            <div runat="server" id="divgrd">
                                ...
                                <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" CssClass="Grid FixedHeader" ForeColor="Black" OnSelectedIndexChanged="grd_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Narration"><%--17--%>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Container #"><%-- 18--%>
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 200px">
                                        ...
                                        <asp:TemplateField HeaderText="Ref #"><%--19--%>
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 200px">
                                        ...
                                        <asp:BoundField DataField="fcur" HeaderText="Cur"><%--20--%>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="2%" Wrap="false" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="famt" HeaderText="Dr.Amt" DataFormatString="{0:#,##0.00}" ItemStyle-CssClass="TxtAlign1" HeaderStyle-CssClass="TxtAlign1"><%-- 21--%>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Right" Width="4%" Wrap="false" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="famtcr" HeaderText="Cr.Amt" DataFormatString="{0:#,##0.00}" ItemStyle-CssClass="TxtAlign1" HeaderStyle-CssClass="TxtAlign1"><%-- 22--%>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Right" Width="4%" Wrap="false" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="fexrate" HeaderText="Ex-Rate" DataFormatString="{0:#,##0.00}" ItemStyle-CssClass="TxtAlign1" HeaderStyle-CssClass="TxtAlign1"><%-- 23--%>
                                            <HeaderStyle HorizontalAlign="Left" Wrap="false" />
                                            <ItemStyle Width="4%" HorizontalAlign="Right" Wrap="false" />
                                        </asp:BoundField>

                                        <asp:BoundField DataField="GSTIN" HeaderText="GSTIN"><%-- 24--%>
                                            <HeaderStyle HorizontalAlign="Left" Wrap="false" />
                                            <ItemStyle Width="4%" HorizontalAlign="Right" Wrap="false" />
                                        </asp:BoundField>

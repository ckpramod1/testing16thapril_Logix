...
{
    public partial class ChequeRequestNew : System.Web.UI.Page
    {
        ...
        private void Fn_Getdetail()
        {
            try
            {
                ...
                {
                    dt_ok = obj_da_Cheque.GetChequeRequestNewVou("PA", Session["StrTranType"].ToString(), int_bid, int_divisionid);
                }
                else if (rbt_CN.Checked == true)
                {
                    dt_ok = obj_da_Cheque.GetChequeRequestNewVou("CN", Session["StrTranType"].ToString(), int_bid, int_divisionid);
                }

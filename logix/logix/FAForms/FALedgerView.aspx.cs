...
{
    public partial class FALedgerView : System.Web.UI.Page
    {
        ...
        private void ExportToExcel()
        {
            ...
            if (grdconsol.Rows.Count > 0 && grdconsol.Visible == true)
            {
                ...
                SB.Append("<table BORDER=1 BORDERCOLOR=Black><tr><td align=left colspan=" + Count + "><font face=arial size=3;><B>" + txtLedgerName.Text + " From " + dtfrom.Text + " To " + dtto.Text + "</B></font></td></tr>");
                SB.Append("</table><br />");
        ...
        protected void grd_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string voutrantype = grd.Rows[index].Cells[10].Text;
                //Session["StrTranType"] = voutrantype;
                                ...
                                if (PBid == Convert.ToInt32(Session["Loginbranchid"].ToString()))
                                {
                                    ...
                                    else
                                    {
                                       ...
                                       // iframecost.Attributes["src"] = "../FAForms/Voucher.aspx?QueryVoucherName=" + gvlname + "&Flag=" + true + "&PBranch_ID=" + PBid + "&QueryVoucherNo=" + vouno + "&OsvType=" + osvtype + "&LedgerID=" + hidId.Value + "&FromDate=" + dtfrom.Text + "&ToDate=" + dtto.Text + "&LedgerName=" + txtLedgerName.Text + "&FrmName=" + FrmName;
                                        if (vtype == 5 || vtype == 6)
                                        {
                                            iframecost.Attributes["src"] = "../Accounts/OSVouchers.aspx?FAvouTYPE=" + vtype + "&vouno=" + vouno;
                                        }
                                        else
                                        {
                                            iframecost.Attributes["src"] = "../Accounts/ApprovedLV.aspx?FAvouTYPE=" + vtype + "&vouno=" + vouno;
                                        }
        ...
        protected void grdconsol_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string voutrantype = grdconsol.Rows[index].Cells[10].Text;
                Session["StrTranType"] = voutrantype;

...
{
    public partial class ProformaLV_Afterjobclose : System.Web.UI.Page
    {
            ...
            if (!this.IsPostBack)
            {
                try
                {
                    ...
                    if (Request.QueryString.ToString().Contains("1voutype"))
                    {
                        ...
                        ddl_product.SelectedValue = Request.QueryString["1tran"].ToString();
                    ...
                    if (Request.QueryString.ToString().Contains("rptvoutype"))
                    {
                        ...
                        //txtblno.Text = Request.QueryString["mblno"].ToString();
                        ddl_product.SelectedValue = Request.QueryString["rpttran"].ToString();
                        ddl_product_SelectedIndexChanged(sender, e);
                        txtref_TextChanged(sender, e);
                    ...
                    {
                        ddl_voutype.SelectedItem.Text = Request.QueryString["app1"].ToString();
                    ...
                    {
                        ddl_voutype.SelectedItem.Text = Request.QueryString["app2"].ToString();
                        Dropdownlist1_SelectedIndexChanged(sender, e);
                        txtblno.Text = Request.QueryString["mblno"].ToString();
                        chkmbl.Checked = true;
                        chkmbl_CheckedChanged(sender, e);
                    ...
                    {
                        ddl_voutype.SelectedItem.Text = Request.QueryString["appfibl"].ToString();
                        Dropdownlist1_SelectedIndexChanged(sender, e);
        ...
        protected void txtblno_TextChanged(object sender, EventArgs e)
        {
            try
            {
                    ...
                    if (txtblno.Text.ToUpper() != "")
                    {
                        ...
                        if (ddl_voutype.SelectedItem.Text == "Proforma Sales Invoice" || ddl_voutype.SelectedItem.Text == "Proforma Sales Invoice OC")
                        {
                            ...
                            if (Session["StrTranType"] != null)
                            {
                                ...
                                DataTable dtref = obj_inv.Getcusrefnofromquot4rpt(Convert.ToInt32(Session["LoginBranchId"].ToString()), Session["StrTranType"].ToString(), txtblno.Text, "Profoma");
                ...
                {
                    ScriptManager.RegisterStartupScript(this, typeof(System.Web.UI.WebControls.Button), "logix", "alertify.alert('Select Voucher type..');", true);
                    return;
                }
                UserRights();
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                  ...
                  if (dtacc.Rows.Count > 0)
                  {
                      ...
                      //{
                      //    ScriptManager.RegisterStartupScript(btnsave, typeof(System.Web.UI.WebControls.Button), "logix", "alertify.alert('Job # " + dtacc.Rows[0]["jobno"].ToString() + " has closed. Corporate accountant only can approve the Pro Invoice/PA');", true);
                      //    txtref.Text = "";
                      //    txtref.Focus();
                      //    return;
                      //}
                      ...
                      if (ddl_voutype.SelectedValue == "0")
                      {
                          ...
                          else
                          {
                              ...
                              if (ddl_voutype.SelectedItem.Text == "Proforma Sales Invoice")
                              {
                                  ...
                                  if (sezcus == "Y")
                                  {
                                      ScriptManager.RegisterStartupScript(txtsupplyto, typeof(Button), "DataFound", "alertify.alert('Kindly Update the charge details once again ,Since it is a SEZ customer..');", true);
                                      if (ddl_voutype.SelectedItem.Text == "Proforma Sales Invoice")
                                      {
                                          switch (Session["StrTranType"].ToString())
                                          {
        ...
        protected void txtref_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //   DataAccess.Masters.MasterCustomer customerobj = new DataAccess.Masters.MasterCustomer();
                    ...
                    ///  dtacc = INVOICEobj.SelEmpDtls4Accnew(int_Empid, 0, branchid, strTranType, str_BLno);
                    ...
                    /* if (dtacc.Rows[0]["closedjob"].ToString() == "1")
                     {
                         ScriptManager.RegisterStartupScript(btnsave, typeof(System.Web.UI.WebControls.Button), "logix", "alertify.alert('Job # " + dtacc.Rows[0]["jobno"].ToString() + " has been closed. Corporate accountant only can approve the Pro Invoice/PA');", true);
                         txtref.Text = "";
                         txtref.Focus();
                         return;
                     }
                                        ...
                                        if (ddl_voutype.SelectedItem.Text == "Proforma Purchase Invoice")
                                        {
                                            if (cmbbill.Text != "Internal")
                                            {
                                                ...
                                                if (stper == 0)
                                                {
                                                    ...
                                                    ProINVobj.InsertProLVDetails(Convert.ToInt32(txtref.Text), Convert.ToInt32(hdnChargid.Value), txtcurr.Text.ToUpper(), 
                                                        ...
                                                        branchid, Convert.ToInt32(txtvouyear.Text), cmbbill.SelectedItem.Text, strTranType, Convert.ToInt32(ddl_voutype.SelectedValue), "N", Convert.ToDouble(hdnUnit.Value));
                                                }
                                                else
                                                {
                                            ...
                                            else
                                            {
                                                ...
                                                ProINVobj.InsertProLVDetails(Convert.ToInt32(txtref.Text), Convert.ToInt32(hdnChargid.Value), txtcurr.Text.ToUpper(), 
                                                    ...
                                                    Convert.ToInt32(txtvouyear.Text), cmbbill.Text, strTranType, Convert.ToInt32(ddl_voutype.SelectedValue), "Y", Convert.ToDouble(hdnUnit.Value));
        ...
        protected void btn_yes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnadd.ToolTip == "Add")
                {
                    ProINVobj.InsertProLVDetails(Convert.ToInt32(txtref.Text), Convert.ToInt32(hdnChargid.Value), txtcurr.Text.ToUpper(), Convert.ToDouble(txtrate.Text), Convert.ToDouble(txtex.Text), cmbbase.SelectedValue.ToString(), Convert.ToDouble(txtamount.Text), Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(txtvouyear.Text), cmbbill.SelectedValue.ToString(), Session["StrTranType"].ToString(), Convert.ToInt32(ddl_voutype.SelectedValue), "Y", Convert.ToDouble(hdnUnit.Value));
                } 
                else
                {
                    ProINVobj.UpdateProLVDetails(Convert.ToInt32(txtref.Text), Convert.ToInt32(hdnChargid.Value), txtcurr.Text.ToUpper(), Convert.ToDouble(txtrate.Text), Convert.ToDouble(txtex.Text), cmbbase.Text, Convert.ToDouble(txtamount.Text), hid_cmbase.Value, Convert.ToInt32(txtvouyear.Text), Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString(), Convert.ToInt32(ddl_voutype.SelectedValue), Convert.ToDouble(hdnUnit.Value));
                }
                grdfill();
        ...
        protected void btn_no_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnadd.ToolTip == "Add")
                {
                    ProINVobj.InsertProLVDetails(Convert.ToInt32(txtref.Text), Convert.ToInt32(hdnChargid.Value), txtcurr.Text.ToUpper(), Convert.ToDouble(txtrate.Text), Convert.ToDouble(txtex.Text), cmbbase.SelectedValue.ToString(), Convert.ToDouble(txtamount.Text), Convert.ToInt32(Session["LoginBranchid"].ToString()), Convert.ToInt32(txtvouyear.Text), cmbbill.SelectedValue.ToString(), Session["StrTranType"].ToString(), Convert.ToInt32(ddl_voutype.SelectedValue), "N", Convert.ToDouble(hdnUnit.Value));

                }
                else
                {
                    ProINVobj.UpdateProLVDetailsertax(Convert.ToInt32(txtref.Text), Convert.ToInt32(hdnChargid.Value), txtcurr.Text.ToUpper(), Convert.ToDouble(txtrate.Text), Convert.ToDouble(txtex.Text), cmbbase.Text, Convert.ToDouble(txtamount.Text), hid_cmbase.Value, Convert.ToInt32(txtvouyear.Text), Convert.ToInt32(Session["LoginBranchid"].ToString()), Session["StrTranType"].ToString(), Convert.ToInt32(ddl_voutype.SelectedValue), Convert.ToDouble(hdnUnit.Value), "N");
                    ...
                    if (ddl_voutype.SelectedItem.Text == "Proforma Sales Invoice")
                    {
                        ...
                        if (sezcus == "Y")
                        {
                            ...
                            if (ddl_voutype.SelectedItem.Text == "Proforma Sales Invoice")
                            {
                                ...
                                {
                                    case "FE":
                                        Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1013, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + "Supplyto :" + txtsupplyto.Text + "SEZ:" + sezcus + "/changed");
                                        break;
                                    case "FI":
                                        Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1020, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + "Supplyto :" + txtsupplyto.Text + "SEZ:" + sezcus + "/changed");
                                        break;
                                    case "AE":
                                        Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1027, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + "Supplyto :" + txtsupplyto.Text + "SEZ:" + sezcus + "/changed");
                                        break;
                                    case "AI":
                                        Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1034, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + "Supplyto :" + txtsupplyto.Text + "SEZ:" + sezcus + "/changed");
                                        break;
                                    case "CH":
                                        Logobj.InsLogDetail(Convert.ToInt32(Session["LoginEmpId"]), 1041, 2, Convert.ToInt32(Session["LoginBranchid"]), Session["StrTranType"].ToString() + "Supplyto :" + txtsupplyto.Text + "SEZ:" + sezcus + "/changed");
                                        break;
                                }
                            }
                        }
        ...
        protected void loadgridlog()
        {
            ...
            if (ddl_voutype.SelectedItem.Text == "Proforma Sales Invoice")
            {
                if (Session["StrTranType"] != null)
                {
                    if (Session["StrTranType"].ToString() == "FE")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1013, "ProInv", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                    else if (Session["StrTranType"].ToString() == "FI")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1020, "ProInv", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                    else if (Session["StrTranType"].ToString() == "AE")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1027, "ProInv", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                    else if (Session["StrTranType"].ToString() == "AI")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1034, "ProInv", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                    else if (Session["StrTranType"].ToString() == "CH")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1041, "ProInv", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                }
                else
                {
            ...
            else if (ddl_voutype.SelectedItem.Text == "Proforma Purchase Invoice")
            {
                if (Session["StrTranType"] != null)
                {
                    if (Session["StrTranType"].ToString() == "FE")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1014, "Propa", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                    else if (Session["StrTranType"].ToString() == "FI")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1021, "Propa", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                    else if (Session["StrTranType"].ToString() == "AE")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1028, "Propa", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                    else if (Session["StrTranType"].ToString() == "AI")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1035, "Propa", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                    else if (Session["StrTranType"].ToString() == "CH")
                    {
                        obj_dtlogdetails = Logobj.InsTempGrpLogdtlsGet(Convert.ToInt32(Session["LoginEmpId"]), Convert.ToInt32(Session["LoginBranchid"]), 1042, "Propa", txtref.Text, txtref.Text, Session["StrTranType"].ToString());
                    }
                }
                else
                {

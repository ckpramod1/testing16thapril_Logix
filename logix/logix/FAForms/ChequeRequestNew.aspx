<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="ChequeRequestNew.aspx.cs"
    Inherits="logix.FAForm.ChequeRequestNew" EnableEventValidation="false" %>
            ...
            $(document).ready(function () {
                ...
                $("#<%=txt_Filterby.ClientID %>").autocomplete({
                    ...
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "../FAForms/ChequeRequestNew.aspx/ApprovedBy_Name",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                ...
                $("#<%=txt_vouno.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "../FAForms/ChequeRequestNew.aspx/Vouno",
                            data: "{ 'prefix': '" + request.term + "'}",
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
    ...
    <script type="text/javascript" language="javascript">
       ...
       function () { new xTableHeaderFixed('gvTheGrid', 'table-container', 0); }, false);
        ...
        function GetDetail() {
            $.ajax({
                type: "POST",
                url: "ChequeRequestNew.aspx/GetVouno",
            ...
            <li>
                ...
                <div class="" runat="server" id="div_iframe">
                    <div class="widget-content">
                        <div class="FormGroupContent4" style="margin-top:28px!important;">
                        ...
                        <div class="FormGroupContent4 boxmodal">
                            <div class="FloatRight2">
                                ...
                                <div class="right_btn">
                                    <div class="btn ico-update" id="btn_update_id" runat="server" >

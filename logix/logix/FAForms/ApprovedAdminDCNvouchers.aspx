<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="ApprovedAdminDCNvouchers.aspx.cs"
    Inherits="logix.FAForm.ApprovedAdminDCNvouchers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    width: 14.6%;
    float: right;
    margin: 0px 0.5% 0px 0% !important;
}
    </style>
                ...
                <div class="widget-content">
                    ...
                    <div class="FormGroupContent4 boxmodal" style="display: flex; justify-content: flex-end">
                      ...
                      <%--     <div class="FormGroupContent4">
                                <asp:Label ID="Label13" runat="server" Text="Bill Type"></asp:Label>
                                <asp:DropDownList ID="ddl_voutype" runat="server"  ToolTip="Bill Type" CssClass="chzn-select" data-placeholder="Bill Type" TabIndex="8">
                                       <asp:ListItem Text="" Value="0"></asp:ListItem>
              <asp:ListItem Value="4" Text="Debit"></asp:ListItem>

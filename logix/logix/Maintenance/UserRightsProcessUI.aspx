<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="UserRightsProcessUI.aspx.cs" EnableEventValidation="false" Inherits="logix.Maintenance.UserRightsProcessUI" %>
            ...
            $(document).ready(function () {
                $("#<%=txt_user.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "../Maintenance/UserRightsProcessUI.aspx/GetEmployeename",
                ...
                <div class="widget-content">
                    ...
                    <div class="FormGroupContent4 boxmodal">
                        <div class="UserPerInput">
                            <asp:Label ID="Label2" runat="server" CssClass="hide" Text="Emp Name"> </asp:Label>
                            <asp:TextBox ID="txt_user" runat="server" CssClass="form-control" MaxLength="100" placeholder="Emp Name" ToolTip="Emp Name" AutoPostBack="true" OnTextChanged="txt_user_TextChanged"></asp:TextBox>
                        </div>
                        <div class="UserMenu">
                            <asp:Label ID="Label3" runat="server" CssClass="hide" Text="Emp Details"> </asp:Label>
                            <asp:TextBox ID="txt_details" runat="server" CssClass="form-control" MaxLength="100" placeholder="Emp Details" ToolTip="Emp Details"></asp:TextBox>
                        </div>
                        ...
                        <asp:DropDownList ID="ddl_process" runat="server" placeholder="Process" AppendDataBoundItems="True" CssClass="chzn-select" OnSelectedIndexChanged="ddl_process_SelectedIndexChanged" AutoPostBack="true"
                                            ToolTip="Process" data-placeholder="Branch">
                                            <asp:ListItem Value="0" Text=""></asp:ListItem>
                                        </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="UserBox1">
                        ...
                        <div class="btn ico-all-rights MT15">

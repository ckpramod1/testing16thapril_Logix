<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="MasterCustomer.aspx.cs" EnableEventValidation="false" Inherits="logix.Maintenance.MasterCustomer" %>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#<%=txtlocation.ClientID %>").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: "MasterCustomer.aspx/GetLocation",
        ...
        $(document).ready(function () {
            ...
            $("#<%= txtcustomer.ClientID %>").autocomplete({
                    ...
                    $.ajax({
                        url: "MasterCustomer.aspx/GetCustomer",
                        data: "{ 'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
        ...
        $(document).ready(function () {
            $("#<%=txtcity  .ClientID %>").autocomplete({
                     source: function (request, response) {
                         ...
                         $.ajax({
                             url: "MasterCustomer.aspx/GetPortName",
                             data: "{ 'prefix': '" + request.term + "'}",
                             dataType: "json",
                             type: "POST",
                             contentType: "application/json; charset=utf-8",
        ...
        $(document).ready(function () {
            $("#<%=txtpincode .ClientID %>").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        url: "MasterCustomer.aspx/GetPincode",
                        data: "{ 'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $("#<%=txt_Salesperson.ClientID %>").autocomplete({
                      source: function (request, response) {
                         ...
                         $.ajax({
                             url: "MasterCustomer.aspx/GetEmployeename",
                             data: "{ 'prefix': '" + request.term + "'}",
                             dataType: "json",
                             type: "POST",
                             contentType: "application/json; charset=utf-8",
        ...
        source: function (request, response) {
            $.ajax({
                url: "MasterCustomer.aspx/GetSubgroupname",
                data: "{ 'prefix': '" + request.term + "'}",
                dataType: "json",
                type: "POST",
                contentType: "application/json; charset=utf-8",
...
.KycCustomerHead {
    ...
    top: 5px;
        ...
        #logix_CPH_ddlAddProof_chzn {
             width:100%!important;
        }
        #logix_CPH_ddlkycproof_chzn{
             width:100%!important;
        }
        .Request1 {
    width: 12%;
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
                    ...
                    <div class="widget-header">
                        <div style="float: left; margin: 0px 0.5% 0px 0px;">
                            <h4 class="hide"><i class="icon-umbrella"></i>
                                <asp:Label ID="lbl_Header" runat="server" Text="Customer"></asp:Label></h4>
                               <!-- Breadcrumbs line -->
        <div class="crumbs">
                ...
                <li class="current"><a href="#" title="">Customer</a> </li>
                    ...
                    <div class="widget-content">
                        ...
                        <div class="FormGroupContent4 Mandatory boxmodal">
                            ...
                            <asp:DropDownList ID="ddlCType" runat="server" CssClass="chzn-select" AutoPostBack="true"  data-placeholder="CUSTOMER TYPE" TabIndex="2" OnSelectedIndexChanged="ddlCType_SelectedIndexChanged">
                        ...
                        <div class="FormGroupContent4 Mandatory">
                            ...
                            <div class="UnitsInput1">
                                <asp:TextBox ID="txtdoor" runat="server" ToolTip="Door#" placeholder="Door#" CssClass="form-control" TabIndex="4" onkeyup="CheckTextLength(this,10);"></asp:TextBox>
                            </div>
                             <div class="BuildingName">
                                <asp:TextBox ID="txtbuildingname" ToolTip="BuildingName" CssClass="form-control" placeholder="BuildingName" runat="server" TabIndex="5" onkeyup="CheckTextLength(this,50);" ></asp:TextBox>
                            </div>
                        ...
                        <div class="FormGroupContent4">
                            ...
                            <div class="State2">
                                <asp:TextBox ID="txtGSTCode" runat="server" placeholder="State GSTCode" CssClass="form-control" ToolTip="State GSTCode" Enabled="False"></asp:TextBox>
                            </div>
                            <div class="Country2">
                        ...
                        <div class="FormGroupContent4">
                             <div class="Drop1"><asp:DropDownList ID="cmbpanreq" runat="server" CssClass="chzn-select" TabIndex="2" Width="100%"  data-placeholder="PAN Required"  Tooltip="PAN Required">    
            <asp:ListItem Text="" Value="0"></asp:ListItem>          
              </asp:DropDownList> </div>
                            <div class="Shipper1">
                                <asp:TextBox ID="txtPanNo" placeholder="PAN #" ToolTip="PAN #" runat="server" TabIndex="16" CssClass="form-control" OnTextChanged="txtPanNo_TextChanged" onkeyup="CheckTextLength(this,25);"></asp:TextBox>
                            </div>
                            <div class="ServiceTax">
                                <asp:TextBox ID="txtServiceTaxNo" placeholder="Service Tax#" ToolTip="Service Tax#" runat="server" TabIndex="17" CssClass="form-control" onkeyup="CheckTextLength(this,25);"></asp:TextBox>

                            </div>
                            <div class="TDS1">
                                <asp:TextBox ID="txttds" runat="server" placeholder="TDS" ToolTip="TDS" CssClass="form-control" Enabled="false" TabIndex="18" onkeypress="return isNumberKey (event)"></asp:TextBox>
                            </div>
                            <div class="TDS2">
                            ...
                            <div class="MRDropdown">
                                <asp:DropDownList ID="ddl_Option" runat="server" TabIndex="19" Width="100%" CssClass="chzn-select" ToolTip="Gst Type" data-placeholder="Gst Type">
                       ...
                       <div class="DesDrop"> <asp:DropDownList ID="ddl_description" Height="23px" CssClass="chzn-select"  data-placeholder="Description" ToolTip="Descripttion"  runat="server" AppendDataBoundItems="true">
                       </asp:DropDownList>
                       </div>
                        <div class="DISNone"> 
                         <asp:Label ID="lbl_type" runat="server" Text="Type"></asp:Label></div>
                        <div class="CusTypeDrop3"> 
                         <asp:DropDownList ID="ddl_type" runat="server" Height="23px" CssClass="chzn-select"  data-placeholder="Type" AutoPostBack="True" ToolTip="Type"  OnSelectedIndexChanged="ddl_type_SelectedIndexChanged" AppendDataBoundItems="true">
                         </asp:DropDownList>
                         </div>
                         <div class="DISNone"><asp:Label ID="lbl_slab" runat="server" Text="Slab"></asp:Label></div>
                         <div class="CusDrop1"> <asp:DropDownList ID="ddl_slab" Height="23px" runat="server" CssClass="chzn-select"  data-placeholder="Slab" ToolTip="Slab"  AutoPostBack="True" AppendDataBoundItems="true"  OnSelectedIndexChanged="ddl_slab_SelectedIndexChanged">
                         </asp:DropDownList></div>
                         <div class="DISNone"> <asp:Label ID="lbl_percentage" runat="server" Text="Percentage"></asp:Label></div>
                         <div class="CusPerDrop"><asp:DropDownList ID="ddl_percentage" Height="23px"  CssClass="chzn-select"  data-placeholder="Percentage" ToolTip="Percentage" runat="server" AppendDataBoundItems="true" >
                        </asp:DropDownList></div>


                                             <div class="LimtTxtBox">
                                <asp:TextBox ID="txt_limit" runat="server" placeholder="LIMIT" ToolTip="LIMIT Amount" CssClass="form-control" AutoPostBack="true" ></asp:TextBox>
                            </div>
                                       <div class="ExemptionTxtBox">
                 ...
                 <asp:CalendarExtender ID="CalendarExtender2" runat="server" DaysModeTitleFormat="dd/MM/yyyy" Format="dd/MM/yyyy" TargetControlID="txt_empto" TodaysDateFormat="dd/MM/yyyy">
                             ...
                             <div class="Certificaten1">
                                <asp:TextBox ID="txt_tds_exp" runat="server" placeholder="TDS Exemption" ToolTip="TDS Exemption Amount" CssClass="form-control" AutoPostBack="true"  ></asp:TextBox>
                            </div>

                        </div>
                       <div class="FormGroupContent4 boxmodal">
                           <div class="LiveDrop">
                             <asp:DropDownList ID="DropLiveHold" runat="server" CssClass="chzn-select"   data-placeholder="Live" ToolTip="Live/Hold">
                        ...
                        <div class="PDFLeft boxmodal">
                            ...
                            <div class="FormGroupContent4">
                                 <div class="MRDropN1">
                                <asp:DropDownList ID="ddl_MR" runat="server" TabIndex="19" Width="100%" CssClass="chzn-select">
                            ...
                            <div class="MGMT1">
                                <asp:TextBox ID="txtmanagptc" runat="server" placeholder="MANAGEMENT HEAD NAME" ToolTip="MANAGEMENT HEAD NAME" CssClass="form-control" TabIndex="20"></asp:TextBox>
                            </div>
                            </div>
                             <div class="FormGroupContent4">
                             <div class="MGMT2">
                                <asp:TextBox ID="txtmailmanag" runat="server" placeholder="MANAGEMENT HEAD MAIL ID" ToolTip="MANAGEMENT HEAD MAIL ID" CssClass="form-control " TabIndex="21" AutoPostBack="true" OnTextChanged="txtmailmanag_TextChanged"></asp:TextBox>
                            </div>
                                 </div>
                                 <div class="FormGroupContent4">
                                     <div class="MRDropN1">
                                <asp:DropDownList ID="DropDownList1" runat="server" TabIndex="22" Width="100%" CssClass="chzn-select">
                                    <asp:ListItem>Mr</asp:ListItem>
                                    <asp:ListItem>Ms</asp:ListItem>
                                    <asp:ListItem>Mrs</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="MGMT1">
                                <asp:TextBox ID="txtcomptc" runat="server" placeholder="COMMERCIAL HEAD NAME" ToolTip="COMMERCIAL HEAD NAME" CssClass="form-control " TabIndex="23" AutoPostBack="true"></asp:TextBox>
                            </div>
                            ...
                            <div class="MGMT2">
                                <asp:TextBox ID="txtmailcom" runat="server" placeholder="COMMERCIAL HEAD MAIL ID" ToolTip="COMMERCIAL HEAD MAIL ID" CssClass="form-control " TabIndex="24" AutoPostBack="true" OnTextChanged="txtmailcom_TextChanged"></asp:TextBox>
                            </div>
                        </div>
                            <div class="FormGroupContent4">
                                 <div class="MRDropN1">
                                <asp:DropDownList ID="DropDownList2" runat="server" TabIndex="25" Width="100%" CssClass="chzn-select">
                                    <asp:ListItem>Mr</asp:ListItem>
                                    <asp:ListItem>Ms</asp:ListItem>
                                    <asp:ListItem>Mrs</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="MGMT1">
                                <asp:TextBox ID="txtexpptc" runat="server" placeholder="EXPORT HEAD NAME" ToolTip="EXPORT HEAD NAME" CssClass="form-control" AutoPostBack="true" TabIndex="26"></asp:TextBox>
                            </div>
                            </div>
                                 <div class="FormGroupContent4">
                            <div class="MGMT2">
                                <asp:TextBox ID="txtmailexport" runat="server" placeholder="EXPORT HEAD MAIL ID" ToolTip="EXPORT HEAD MAIL ID" CssClass="form-control" TabIndex="27" AutoPostBack="true" OnTextChanged="txtmailexport_TextChanged"></asp:TextBox>
                            </div>
                            ...
                            <div class="MRDropN1">
                                <asp:DropDownList ID="DropDownList3" runat="server" TabIndex="28" Width="100%" CssClass="chzn-select">
                                    <asp:ListItem>Mr</asp:ListItem>
                                    <asp:ListItem>Ms</asp:ListItem>
                                    <asp:ListItem>Mrs</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="MGMT1">
                                <asp:TextBox ID="txtimpptc" runat="server" placeholder="IMPORT HEAD NAME" ToolTip="IMPORT HEAD NAME" CssClass="form-control" AutoPostBack="true" TabIndex="29"></asp:TextBox>
                            </div>
                           </div>  
                             <div class="FormGroupContent4">
                             <div class="MGMT2">
                                <asp:TextBox ID="txtmailimp" runat="server" placeholder="IMPORT HEAD MAIL ID" ToolTip="IMPORT HEAD MAIL ID" CssClass="form-control" AutoPostBack="true" TabIndex="30" OnTextChanged="txtmailimp_TextChanged"></asp:TextBox>
                            </div>
                             ...
                             <div class="FormGroupContent4">
                            <div class="MRDropN1">
                                <asp:DropDownList ID="DropDownList4" runat="server" TabIndex="31" Width="100%" CssClass="chzn-select">
                                    <asp:ListItem>Mr</asp:ListItem>
                                    <asp:ListItem>Ms</asp:ListItem>
                                    <asp:ListItem>Mrs</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="MGMT1">
                                <asp:TextBox ID="txtfinptc" runat="server" Width="100%" placeholder="FINANCIAL HEAD NAME" ToolTip="FINANCIAL HEAD NAME" CssClass="form-control" TabIndex="32" AutoPostBack="true"></asp:TextBox>
                            </div>
                                </div>
                             <div class="FormGroupContent4">
                             <div class="MGMT2">
                                <asp:TextBox ID="txtmailfin" runat="server" placeholder="FINANCIAL HEAD MAIL ID" Width="100%" ToolTip="FINANCIAL HEAD MAIL ID" CssClass="form-control" TabIndex="33" AutoPostBack="true" OnTextChanged="txtmailfin_TextChanged"></asp:TextBox>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="FormGroupContent4">
                            <div class="Request1" style="margin-top:4px;">
                            ...
                            <div class="ChkLedger">
                                <asp:CheckBox ID="chkleger" runat="server" Text="Billing Customer" Visible="false" OnCheckedChanged="chkleger_CheckedChanged" AutoPostBack="true" />
                            </div>
                            
                            <div class="SubGroupn1">
             <asp:TextBox ID="txtsubgroupname" runat="server" ToolTip="Sub Group Name" AutoPostBack="true" placeholder="Sub Group Name"  CssClass="form-control"  OnTextChanged="txtsubgroupname_TextChanged" Visible="false"></asp:TextBox>
             </div>
                                  <div class="SubGroupn2">
             <asp:TextBox ID="txtgroupname" runat="server" ToolTip="Group Name" AutoPostBack="true" placeholder="Group Name"  CssClass="form-control"   Enabled="false"></asp:TextBox>
             </div>
                            </div>
                              </div>
                          <div class="FormGroupContent4">
                              <div class="left_btn">
                            <div class="btn btn-pending">
                                <asp:Button ID="btn_Block_customer" runat="server" ToolTip="Block Customer" OnClick="btn_Block_customer_Click" /></div> 
                             <div class="btn btn-groupwise1" id="butgoup" runat="server">
                                    <asp:Button ID="btn_custgroup" runat="server" ToolTip="Cust Group" OnClick="btn_custgroup_Click" TabIndex="38"  /> <%--onclientclick="disableBtn(this.id, 'Loading...')" usesubmitbehavior="False"--%>
                                </div>
                              </div>
                            ...
                            <div class="right_btn">
                                <div class="btn ico-save" id="btnSave1" runat="server">
                                    <asp:Button ID="btnSave" runat="server" ToolTip="Save" OnClick="btnSave_Click" TabIndex="33"  onclientclick="disableBtn(this.id, 'Loading...')" usesubmitbehavior="False"/> <%--onclientclick="disableBtn(this.id, 'Loading...')" usesubmitbehavior="False"--%>
                                </div>
                        ...
                        <div class="FormGroupContent4 boxmodal">
                          ...
                          <div class="FormGroupContent4">
                            <div class="BillDrop2">
                                <asp:DropDownList ID="ddlIDProof" runat="server" AppendDataBoundItems="True" TabIndex="2" CssClass="chzn-select"
                            ...
                            <div class="FileUpload2">
                             ...
                             <div class="right_btn MT0">                                 
                                 <div class="btn ico-upload" id="Div2" runat="server" style="display:none">
                            ...
                            <div class="BillDrop2" style="display:none;">
                                <asp:DropDownList ID="ddlAddProof" runat="server" AppendDataBoundItems="True" TabIndex="4" CssClass="chzn-select"
                            ...
                            <div class="BillDrop2" style="display:none;">
                                <asp:DropDownList ID="ddlkycproof" runat="server" AppendDataBoundItems="True" TabIndex="4" CssClass="chzn-select"
                            ...
                            <%--DataKeyNames="districtid,stateid,countryid,portid,locationid,customerid"--%>
                                  <div class="panel_05">
                            <asp:GridView ID="GrdProof" runat="server" AutoGenerateColumns="False" CssClass="Grid FixedHeader"  ShowHeaderWhenEmpty="True" 
    ...
    <div class="FormGroupContent4">
        ...
        <asp:HiddenField ID="hid_int_custid" runat="server" />

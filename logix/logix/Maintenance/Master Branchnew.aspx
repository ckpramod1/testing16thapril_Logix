<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="Master Branchnew.aspx.cs" EnableEventValidation="false"  Inherits="logix.Maintenance.Master_Branchnew" %>
...
span#logix_CPH_Label1, span#logix_CPH_Label2 {
...
<script type="text/javascript">
   ...
   <script type="text/javascript">
       ...
       <script type="text/javascript">
           function ShowpImagePreviewnew(input) {
               if (input.files && input.files[0]) {
                   var reader = new FileReader();
                   reader.onload = function (e) {
                       //  $('#img_flag').attr('src', e.target.result);
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
    ...
    <!-- Breadcrumbs line End -->
     ...
     <div class="widget-header">
         <div>
                  <h4 class="hide"><i class="icon-umbrella"></i><asp:Label ID="lbl_Header" runat="server" Text="Branch"></asp:Label></h4>
           <!-- Breadcrumbs line -->
          <div class="crumbs">
            ...
            <asp:ListItem Text="" Value="0"></asp:ListItem>
                ...
                ontextchanged="txt_location_TextChanged" TabIndex="2"></asp:TextBox>
                                     ...
                                     <div class="ShortRight">
                                       <asp:TextBox ID="txt_shortname" runat="server"  ToolTip="ShortName" placeHolder="ShortName"
                              CssClass="form-control" TabIndex="4"></asp:TextBox>

                                   </div>
                                     <div class="PersonLeft">
                                       <asp:TextBox ID="txt_personto" runat="server"  ToolTip="Person To Contact" placeHolder="Person To Contact"
               CssClass="form-control" AutoPostBack="True" 
               ontextchanged="txt_personto_TextChanged" TabIndex="3"></asp:TextBox>
               ...
               CssClass="form-control" TextMode="MultiLine"  TabIndex="5"></asp:TextBox>
                          ...
                          <div class="ThumbRight boxmodal"><div class="FormGroupContent4">
                         <div class="logoimg"><asp:Image ID="ImgLogo" runat="server"  ToolTip="IMAGE"  Height="100%" Width="100%" placeholder="IMAGE" ImageUrl="~/images/UT.jpg"/>
     </div> 
   ...
   <%-- <span style =" margin-top :0.5%;margin-left:0%; display :block; background-color:lightblue; width:110px;height:18px; color:black;border:2px solid #999997;">Upload</span>
      <asp:FileUpload ID="FileUpd_logo" runat="server" TabIndex="35" class="upload" onchange="ShowpImagePreview(this);" /></div>--%>
                           ...
                           <asp:FileUpload ID="FileUpd_logo" runat="server" TabIndex="35" class="upload" onchange="ShowpImagePreview(this);" />
                                        ...
                                        <div class="ThumbRight boxmodal" style=" margin-right: 0px !important;"><div class="FormGroupContent4">
                         <div class="logoimg"><asp:Image ID="Image1" runat="server"  ToolTip="IMAGE"  Height="100%" Width="100%" placeholder="IMAGE"/>      </div> 
<%--                          <div class="fileUpload">
   <%-- <span style =" margin-top :0.5%;margin-left:0%; display :block; background-color:lightblue; width:110px;height:18px; color:black;border:2px solid #999997;">Upload</span>
      <asp:FileUpload ID="FileUpd_logo" runat="server" TabIndex="35" class="upload" onchange="ShowpImagePreview(this);" /></div>--%>
                              <div class="FileUpload4 fileUpload">
                                    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always"  runat="server" >
                                        <ContentTemplate>
                            <span style=" margin-top :0%; display :block; color:#fff; background-color:#5ba701; color:black; width:121px; font-size:12px; padding:0px 0px 0px 0px; height:25px;">UPLOAD</span>
                           <asp:FileUpload ID="FileUpload1" runat="server" TabIndex="35" class="upload" onchange="ShowpImagePreviewnew(this);" />
                                            <div class="div_btn">
              ...
              <div class="FormGroupContent4">
                  <div class="PhoneTxt1"> 
                      <asp:TextBox ID="txt_PanNo" runat="server" CssClass="form-control"  ToolTip="PAN #" placeHolder="PermenantAccount #"
               Width="100%" TabIndex="11" AutoPostBack="True"></asp:TextBox>

                  </div>
                  <div class="Faxtxt1 hide"><asp:TextBox ID="txt_service" runat="server" CssClass="form-control"  ToolTip="Service Tax #" placeHolder="Service Tax #"
               Width="100%" TabIndex="12" AutoPostBack="True"></asp:TextBox> </div>

                    <div class="Gaxtxt1">
                       <asp:TextBox ID="txt_gstin" runat="server" CssClass="form-control"  ToolTip="GSTIN" placeHolder="GSTIN" Width="100%" ></asp:TextBox>
                   </div>
                   <div class="Saxtxt">
                      
                       <asp:DropDownList ID="ddllocation" runat="server" ToolTip="StateName" Data-Placeholder="StateName" AutoPostBack="true" CssClass ="chzn-select" Width="100%" OnSelectedIndexChanged="ddllocation_SelectedIndexChanged"  >
                                   <asp:ListItem text="" Value="0"></asp:ListItem>
                                   </asp:DropDownList>
                   </div>
                  </div>
               ...
               <div class="FormGroupContent4">
                  <div class="PhoneTxt1"><asp:TextBox ID="txt_Mrcode" runat="server" CssClass="form-control"  ToolTip="Branch Code" placeHolder="Branch Code"
              ...
              <div class="FormGroupContent4">
                  <div class="Export1">
                       <asp:TextBox ID="txt_exdoc_mailid" runat="server"  ToolTip="Export Ducumention Mail Id" placeHolder="Export Ducumention Mail Id"
               CssClass="form-control" Width="100%" TabIndex="34" AutoPostBack="True" ontextchanged="txt_exdoc_mailid_TextChanged"></asp:TextBox>

                  </div>
                  </div>
                          <div class="FormGroupContent4">
 <div class="Export1">
                      <asp:TextBox ID="txt_excoord_mailid" runat="server"  ToolTip="Export Coordination Mail Id" placeHolder="Export Coordination Mail Id"
               CssClass="form-control"  TabIndex="35" AutoPostBack="True" ontextchanged="txt_excoord_mailid_TextChanged"></asp:TextBox>

                  </div>
                          </div>
                          <div class="FormGroupContent4">
 <div class="Export2">
                      <asp:TextBox ID="txt_exope_mailid" runat="server"  ToolTip="Export Operation Mail Id" placeHolder="Export Operation Mail Id"
               CssClass="form-control" TabIndex="36" AutoPostBack="True" ontextchanged="txt_exope_mailid_TextChanged"></asp:TextBox>
                ...
                <div class="FormGroupContent4">
                    <div class="Export1">
                        <asp:TextBox ID="txt_impdoc_mailid" runat="server"  ToolTip="Import Ducumention Mail Id" placeHolder="Import Ducumention Mail Id"
               CssClass="form-control" Width="100%" TabIndex="37" AutoPostBack="True" ontextchanged="txt_impdoc_mailid_TextChanged"></asp:TextBox>

                    </div>
                     </div>
                          <div class="FormGroupContent4">
                     <div class="Export1"> 
                         <asp:TextBox ID="txt_impcoord_mailid" runat="server"  ToolTip="Import Coordination Mail Id" placeHolder="Import Coordination Mail Id"
               CssClass="form-control" TabIndex="38" AutoPostBack="True" CausesValidation="True" ontextchanged="txt_impcoord_mailid_TextChanged"></asp:TextBox>

                     </div>
                              </div>
                          <div class="FormGroupContent4">
                     <div class="Export2">
                         <asp:TextBox ID="txt_impoper_mailid" runat="server"  ToolTip="Import Operation Mail Id" placeHolder="Import Operation Mail Id"
               CssClass="form-control" TabIndex="39" AutoPostBack="True" ontextchanged="txt_impoper_mailid_TextChanged"></asp:TextBox>
                      ...
                      <div class="FormGroupContent4 boxmodal">
                         <div class="Export1" style="width:16.5%;margin-right: 0.5%;" > <asp:TextBox ID="Txt_closingdays" runat="server"  ToolTip="Closingdays" placeHolder="Close Days"
               CssClass="form-control" Width="100%" TabIndex="37" AutoPostBack="True" ></asp:TextBox></div>

                     <div class="Export1" style="width:16%" > <asp:TextBox ID="Txt_backdatedays" runat="server"  ToolTip="Backdatedays" placeHolder="Date Back Days"
               CssClass="form-control" Width="100%" TabIndex="37" AutoPostBack="True" ></asp:TextBox></div>

                          </div>
              <div class="FormGroupContent4">
                  <div class="left_btn custom-mb-2">
                          
                       <div class="btn ico-save" style="display:none;">
                           <asp:Button ID="BTN_CUNTRY" runat="server" Text="COUNTRYIMAGES" ToolTip="COUNTRYIMAGES" onclick="BTN_CUNTRY_Click" TabIndex="40" />
         
                      </div>
                          <div class="btn ico-save">
                           <asp:Button ID="Btn_upload" runat="server" Text="Upload Image" ToolTip="UploadImage" onclick="Btn_upload_Click" TabIndex="40" />
         
                      </div>
                      <div class="btn ico-save"  runat="server" id="btn_save1">
                           <asp:Button ID="btnSave" runat="server" Text="Save" ToolTip="Save" onclick="btnSave_Click" TabIndex="40" />
         
                      </div>
                      <div class="btn ico-back"  runat="server" id="btn_back1">
                            <asp:Button ID="btnCancel" runat="server" Text="Back" ToolTip="Cancel/Back"  onclick="btnCancel_Click" TabIndex="41"  />
                      </div>
                  </div>
              </div>

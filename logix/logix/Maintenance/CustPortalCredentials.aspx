<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="CustPortalCredentials.aspx.cs" Inherits="logix.Maintenance.CustPortalCredentials" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
    <div class="FormGroupContent4">
        <div class="CardLbl">
            <asp:Label ID="Label59" runat="server">Customer Portal Credentials </asp:Label>
        ...
        <div class="FormGroupContent4">
            <div  style="width:39%;float:left;margin:0px 0.5% 0px 0px">
                <asp:Label ID="lbl_user" runat="server" CssClass="hide" Text="eMail"> </asp:Label>
                <div class="Bank_name_input">
                    <asp:TextBox ID="txtuser" runat="server" CssClass="form-control" AutoPostBack="True" placeholder="User name" ToolTip="User Name" TabIndex="1" ></asp:TextBox>

                </div>
            </div>

            <div style="width:40%;float:left;margin:0px 0.5% 0px 0px">
                <asp:Label ID="lblifsc" runat="server" CssClass="hide" Text="Password"> </asp:Label>
                <div class="IFSC_code_input">
                    <asp:TextBox ID="txtpwd" runat="server" CssClass="form-control" AutoPostBack="True" placeholder="Password" ToolTip="Password" TabIndex="2" ></asp:TextBox>
             ...
             <div style="width:16.2%;float:left;margin:0px 0.5% 0px 0px" >
                <asp:Label ID="Label1" runat="server" CssClass="hide" Text="Type"> </asp:Label>

                <div class="Account_type_input">
                    <asp:DropDownList ID="ddl_active" runat="server" Height="23" CssClass="chzn-select"
                        ToolTip="Active" data-placeholder="Active" Width="100%" AutoPostBack="true" TabIndex="3" AppendDataBoundItems="False">
            ...
            <div class="left_btn custom-mt-2">
                <div class="btn-add">
                    <asp:Button ID="btn_Save" runat="server" Text="Save" ToolTip="Save" OnClick="btn_Save_Click" TabIndex="46" />
                </div>

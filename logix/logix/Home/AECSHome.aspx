<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="AECSHome.aspx.cs" Inherits="logix.Home.AECSHome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
    ...
    <div class="Clear"></div>
        <div class="BandMiddle">
            <div class="BreadLabel" id="OptionDoc" runat="server">Customer Support - Air Exports</div>

        </div>
        <div class="Clear"></div>
        <div class="BandTop">
            <div style="float:left; width:182px; margin:0px 0.5% 0px 0px;">
                <h3>
            ...
            <div class="">
                ...
                <div class="widget box borderremove">
                    ...
                    <div class="widget-content">
                        <div style="float: left; width: 85%;padding: 0 10px;">
                            <div class="widget-header">
                                <span>Pending Status</span></div>
                            <div class="div_Break"></div>

                            <asp:Panel ID="Panel1" runat="server" CssClass=" panel_18" Visible="true">
                                <asp:GridView ID="Grd_Status" CssClass="Grid FixedHeader" runat="server" AutoGenerateColumns="False" Width="100%" ForeColor="Black"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Date">
                                            ...
                                            <ItemStyle Wrap="false" Width="75px" HorizontalAlign="Left"></ItemStyle>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Job #">
                                            ...
                                            <ItemStyle Wrap="false" Width="35px" HorizontalAlign="Left"></ItemStyle>
                                        </asp:TemplateField>
                        ...
                        <div class="Unclosed2" style="margin: 29px 0px 0px 0px;">

                            <div class="divbtn1">
                                <asp:LinkButton ID="lnk_Inv" runat="server" OnClick="lnk_Inv_Click">Inv_Cn OPS Customerwise</asp:LinkButton>
                            </div>

                            <div class="divbtn2">
                                <asp:LinkButton ID="lnk_Query" runat="server" OnClick="lnk_Query_Click">Shipment Query </asp:LinkButton>
                            </div>

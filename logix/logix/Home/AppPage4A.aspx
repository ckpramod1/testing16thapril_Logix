<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="AppPage4A.aspx.cs"  Inherits="logix.Home.AppPage4A" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    margin: 0px 0.5% 0px 0px;
        ...
        .InstructionApp {
            float:left; margin:10px 0.5% 0px 0px;
        }
            ...
            <div class="widget box brdernone" runat="server">
                <div class="widget-content">
                    ...
                    <div style="height: 370px;">
                        ...
                        <div style="float: left; width: 100%; margin: 10px 5px 10px;">
                            ...
                            <asp:Panel ID="Panel5" runat="server" Width="100%" CssClass="TableGrid1">
                                <asp:GridView ID="grdall" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="Grid FixedHeader" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Gaps">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtcompetency" runat="server" ForeColor="Black" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                            </ItemTemplate>
                             ...
                             <div class="InstructionApp">
                            <asp:CheckBox ID="chkagree" Text=" " TextAlign="Left" Checked="false" AutoPostBack="true" OnCheckedChanged="chkagree_CheckedChanged" runat="server" ToolTip="Access" />
                            <asp:Label ID="Label13" runat="server"> No Gaps
                                </asp:Label>
                        </div>
                        </div>
                                    ...
                                    <asp:GridView ID="grdfunc" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="Grid FixedHeader" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtFunctional" runat="server" ForeColor="Black" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                                </ItemTemplate>
                                                <ItemStyle Width="300px" Font-Size="small" Wrap="false" />
                                            </asp:TemplateField>
                                ...
                                <asp:Panel ID="Panel3" runat="server" Width="100%" CssClass="TableGrid2">
                                    <asp:GridView ID="grdpers" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="Grid FixedHeader" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtpersonal" runat="server" ForeColor="Black" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                                </ItemTemplate>
                                                <ItemStyle Width="300px" Font-Size="small" Wrap="false" />
                                            </asp:TemplateField>
                                        </Columns>
                                ...
                                <asp:Panel ID="Panel4" runat="server" Width="100%" CssClass="TableGrid3">
                                    <asp:GridView ID="grdMan" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="Grid FixedHeader" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtmangerial" runat="server" ForeColor="Black" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                                </ItemTemplate>
                                                <ItemStyle Width="300px" Font-Size="small" Wrap="false" />
                                            </asp:TemplateField>
                                        </Columns>
                                ...
                                <div class="AppLeft" style="display: none;">
                                    ...
                                    <div class="FormGroupContent4">
                                        ...
                                        <div style="float: left; width: 20%; margin: 4px 0px 0px 0px;">
                                            <asp:DropDownList ID="ddlyesNo" runat="server" Width="100%" OnSelectedIndexChanged="ddlyesNo_SelectedIndexChanged" AppendDataBoundItems="True" CssClass="chzn-select" AutoPostBack="true">

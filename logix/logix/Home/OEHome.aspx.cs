...
{
    public partial class OEHome : System.Web.UI.Page
    {
      ...
      /*  public void PendingApproval1()
        ...
        */
        ...
        protected void grdpendingbook1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            grdpendingbook1.PageIndex = e.NewPageIndex;
           // pop_hblgrd.Hide();
            Panelbooking.Visible = true;
            grdpendingbook1.Visible = true;
            grdpendingbook1.DataSource = (DataTable)ViewState["Booking"];
            grdpendingbook1.DataBind();
           // popup_Grd.Show();
        }

        protected void grdpendinghbl_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            grdpendinghbl.PageIndex = e.NewPageIndex;
           // popup_Grd.Hide();
            Panelhbl.Visible = true;
            grdpendinghbl.Visible = true;
            grdpendinghbl.DataSource = (DataTable)ViewState["hbl"];
            grdpendinghbl.DataBind();
          //  pop_hblgrd.Show();
        ...
        protected void grdpendingmbl_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            grdpendingmbl.PageIndex = e.NewPageIndex;
          //  pop_mblGrd.Show();
            Panelmbl.Visible = true;
            grdpendingmbl.Visible = true;
            grdpendingmbl.DataSource = (DataTable) ViewState["mbl"];
            grdpendingmbl.DataBind();
  

        }

        protected void grdunclosejobs_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            grdunclosejobs.PageIndex = e.NewPageIndex;
            //pop_Grdunclosed.Show();
            grdunclosejobs.Visible = true;
            PanelUnclosedjob.Visible = true;
            grdpendingmbl.DataSource = (DataTable)ViewState["unclosed"];
            grdpendingmbl.DataBind();
        }

        protected void GrdPending1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            GrdPending1.PageIndex = e.NewPageIndex;
            //Pop_GrdApproval.Show();
            PanelApproval.Visible = true;
            GrdPending1.Visible = true;
            GrdPending1.DataSource = ViewState["approval"];
            GrdPending1.DataBind();

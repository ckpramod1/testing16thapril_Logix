<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="RevPage2.aspx.cs" Inherits="logix.Home.RevPage2" %>
                                    ...
                                    <asp:GridView ID="gvcomp" runat="server" AutoGenerateColumns="False" Height="100%" Width="100%" CssClass="Grid FixedHeader" 
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="S#">
                                                ...
                                                <ItemStyle Width="7%" Font-Size="small" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Personal Competencies">
                                                ...
                                                <ItemStyle Wrap="true" Font-Size="Small" Width="50%" />
                                            ...
                                            <asp:TemplateField HeaderText="Appraiser ratings">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblselfratings" runat="server" Text='<%# Eval("appraiser1")  %>' ToolTip='<%# Eval("app1remarks")  %>'></asp:Label>
                                                  <%--  <asp:DropDownList ID="ddlself" runat="server" Width="100%" Enabled="false" ToolTip='<%# Eval("app1remarks")  %>' data-placeholder="Section" CssClass="chzn-select" AutoPostBack="true">
...
<%--                                            <asp:TemplateField HeaderText="Appraiser Remarks">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtcomremarks" Text='<%# Eval("app1remarks")  %>' runat="server" CssClass="form-control" MaxLength="500"></asp:TextBox>
                                                </ItemTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OEHome.aspx.cs" EnableEventValidation="false" Inherits="logix.Home.OEHome" %>
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                data: [{
                    ...
                    dataPoints: [
                          ...
                          { x: 20, y: l2 - 0, indexLabel: "HBL" },
                          { x: 30, y: l3 - 0, indexLabel: "MBL" },
                          { x: 40, y: l4 - 0, indexLabel: "UnClosed Jobs" }
                ...
                <div class="widget box borderremove">
                                    ...
                                    <ul>
                                        ...
                                        <div id="dialog" style="display: none;">
                                            <asp:Panel ID="Panelbooking" runat="server"  CssClass="GridN1" Visible="false">
                                                <asp:GridView ID="grdpendingbook1" CssClass="Grid FixedHeader"  runat="server" AutoGenerateColumns="true" Width="100%" OnPageIndexChanging="grdpendingbook1_PageIndexChanging"
                                    ...
                                    <ajax:ModalPopupExtender ID="popup_Grd" runat="server" PopupControlID="pln_popup"
                                        ...
                                        <div id="dialog1" style="display: none;">
                                            <asp:Panel ID="Panelhbl" runat="server"  CssClass="GridN2" Visible="false">
                                                <asp:GridView ID="grdpendinghbl" CssClass="tblGrid" runat="server" AutoGenerateColumns="false" Width="100%" OnPageIndexChanging="grdpendinghbl_PageIndexChanging"
                                        ...
                                        <div id="dialog3" style="display: none;">
                                            <div class="PendingTbl1">
                                                <asp:Panel ID="PanelUnclosedjob" runat="server" Visible="false">
                                                    <asp:GridView ID="grdunclosejobs" CssClass="PendingTblGrid" runat="server" AutoGenerateColumns="true" Width="100%" ForeColor="Black" EmptyDataText="No Record Found" BackColor="White" ShowHeaderWhenEmpty="true" PageSize="10" AllowPaging="false" OnPageIndexChanging="grdunclosejobs_PageIndexChanging" OnRowDataBound="grdunclosejobs_RowDataBound" OnSelectedIndexChanged="grdunclosejobs_SelectedIndexChanged" Visible="false">
                                                        <EmptyDataRowStyle CssClass="EmptyRowStyle" />
                                                        <HeaderStyle CssClass="GridHeader" />
                                                        <AlternatingRowStyle CssClass="GrdAltRow" />
                                                    </asp:GridView>
                    ...
                    <div class="FormGroupContent4">
                        <asp:Panel ID="pln_KPI" runat="server" CssClass="modalPopupQ" Style="display: none;">
                            ...
                            <asp:Panel ID="panel" runat="server" CssClass="panel" Style="overflow: auto; height: 274px;">
                    ...
                    <div class="FormGroupContent4">
                        <asp:Panel ID="Panel1" runat="server"  CssClass="modalPopupQnew" BorderStyle="Solid" BorderWidth="2px" Style="display: none;">
                            <div class="DivSecPanelkpi">
                    ...
                    <div class="FormGroupContent4">
                        <asp:Panel ID="Panel3" runat="server"  CssClass="modalPopupQnew" BorderStyle="Solid" BorderWidth="2px" Style="display: none;">
                            <div class="DivSecPanelkpi">
                    ...
                    <div class="FormGroupContent4">
                        <asp:Panel ID="Panel5" runat="server"  CssClass="modalPopupQnew" BorderStyle="Solid" BorderWidth="2px" Style="display: none;">
                            <div class="DivSecPanelkpi">
                            ...
                            <asp:Panel ID="panel6" runat="server" CssClass="panel" Style="overflow: auto; height: 107px;">
                                ...
                                <div class="div_total">
                                    <div class="lbl_Header1">
                                        <asp:Label ID="lblVolumeConversion" runat="server" Text="Volume Conversion" BorderColor="#999997"></asp:Label>
                                    </div>
                                    <div class="div_Break"></div>
                                    <div class="div_Ouncetxt">

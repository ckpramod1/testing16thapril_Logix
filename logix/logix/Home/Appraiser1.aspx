<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="Appraiser1.aspx.cs" Inherits="logix.Home.Appraiser1" %>
                        ...
                        <asp:GridView ID="grd_user" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="Grid FixedHeader" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtapprating" runat="server" Text='<%# Eval("appraiserrating")  %>' CssClass="form-control" MaxLength="2" onkeypress="return isNumberKey(event)" ></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>

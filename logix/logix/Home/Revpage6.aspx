<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="Revpage6.aspx.cs" Inherits="logix.Home.Revpage6" %>
    ...
    width: 100%;
        ...
        .FooterCont {
            top: 592px !important;
                ...
                .Grid select {color:#000000!important;
        }
        .txtar textarea {height:59px!important;
        }
        #logix_CPH_grdsub_ddlrating_5_chzn {width:100%!important;
        }
        #logix_CPH_grdsub_ddlrating_6_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlrating_7_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlrating_8_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlrating_9_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_0_chzn {width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_1_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_2_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_3_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_4_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_5_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_6_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_7_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_8_chzn{width:100%!important;
        }
        #logix_CPH_grdsub_ddlIMPrating_9_chzn{width:100%!important;
        }
    </style>
</asp:Content>
                ...
                <div class="widget-content">
                    ...
                    <div class="FormGroupContent4 bgclrNew">
                        <div class="PageHeaderNew">
                            ...
                            <asp:Label ID="lbl_Header" runat="server" Text="Appraisal Page -6"></asp:Label>
                        </div>
                        ...
                        <div class="FormGroupContent4 MB10">
                            ...
                            <div style="float: left; width: 56.5%; margin: 0px 0.5% 0px 0px;">
                               <%-- <div class="FormGroupContent4">
                                ...
                                <asp:Panel ID="pnlgrid" runat="server" Width="100%" CssClass="div_GridAPP" style="display:none;">
                            ...
                            <div style="float: left; width: 40.5%; margin: 0px 0% 0px 20px;">
                                ...
                                <div class="FormGroupContent4">
                                    ...
                                    <asp:TextBox ID="txtstrength" runat="server" Enabled="false" CssClass="form-control" ToolTip="Mention your notable achievements [Non KPI related]" TextMode="MultiLine" Width="94%" Height="70px" MaxLength="1000"></asp:TextBox>
                                </div>
                                ...
                                <div class="FormGroupContent4">
                                    ...
                                    <asp:TextBox ID="txtimprovement" runat="server" Enabled="false" CssClass="form-control" ToolTip="Mention areas of improvement identified for the employee." TextMode="MultiLine" Width="94%" Height="70px" MaxLength="1000"></asp:TextBox>
                                </div>
                                ...
                                <div class="FormGroupContent4" style="margin:10px 0px 0px 0px;">
                                    ...
                                    <div class="FormGroupContent4">
                                        ...
                                        <asp:TextBox ID="txttrainneed" runat="server" Enabled="false"  CssClass="form-control" ToolTip="Mention Effectiveness of Training Attended " TextMode="MultiLine" Width="94%" Height="70px" MaxLength="1000"></asp:TextBox>
                                    </div>
                                ...
                                <div class="FormGroupContent4 txtar" style="margin:10px 0px 5px 0px;">
                                    ...
                                    <asp:TextBox ID="txteffective" runat="server" Enabled="false" CssClass="form-control" ToolTip="Mention Effectiveness of Training Attended " TextMode="MultiLine" Width="94%"  Height="59px" MaxLength="1000"></asp:TextBox>
                                </div>
...
<div class="FormGroupContent4">
                          <div style="float: left">
                             <div class="btn ico-view">
                                <asp:Button ID="btncompare" runat="server" Text="Comparision" OnClick="btncompare_Click" Visible="false"/>
                            </div>
                        </div>
                        <div class="right_btn MT0 MB10">
                            ...
                            <div class="btn ico-save">
                                <asp:Button ID="btnsavepage2" Visible="false" runat="server" Text="Save" />
                            </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AEHome.aspx.cs" Inherits="logix.Home.AEHome" %>
...
<head runat="server">
    ...
    overflow-y: auto !important;
        ...
        #Panel3 {
            top:340px!important; left:358px!important;
        }
        #Panel5 {
            top:340px!important; left:358px!important;
        }
            ...
            {
                top:200px!important; left:358px!important;
            }
        #Panel1 {top:340px!important; left:323px!important;
        }
         .modalPopupssQ {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                data: [{
                    ...
                    dataPoints: [
                          ...
                          { x: 20, y: l4 - 0, indexLabel: "UnClosed Jobs" }
              ...
              <EmptyDataRowStyle CssClass="EmptyRowStyle" />
                    ...
                    <div class="FormGroupContent4">
                        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopupQnew" Style="display: none;">
                          ...
                          <asp:Panel ID="panel2" runat="server" CssClass="panel" style="overflow:auto;height:117px;" >
                     <div class="div_total">
                          <div class="widget-LBL" style="margin-bottom:10px;">
                                 <div class="LeaveLbl"><span>Length Conversion</span></div>
                                    </div>
        ...
        <div class="div_Break"></div>
                    ...
                    <div class="FormGroupContent4">
                        <asp:Panel ID="Panel3" runat="server" CssClass="modalPopupQnew"  Style="display: none;">
                          ...
                          <asp:Panel ID="panel4" runat="server" CssClass="panel" style="overflow:auto;height:117px;" >
               <div class="div_total">
        <div class="widget-LBL" style="margin-bottom:10px;">
        ...
        <div class="div_Break"></div>
                    ...
                    <div class="FormGroupContent4">
                        <asp:Panel ID="Panel5" runat="server" CssClass="modalPopupQnew" Style="display: none;">
                          ...
                          <asp:Panel ID="panel6" runat="server" CssClass="panel" style="overflow:auto;height:117px;" >

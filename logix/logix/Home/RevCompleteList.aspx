<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="RevCompleteList.aspx.cs" Inherits="logix.Home.RevCompleteList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
    <div class="FormGroupContent4">
        ...
        <asp:Label ID="lblapp2" runat="server" Text="Completed Reviews" CssClass="LabelValue"></asp:Label>
            </div>
    </div>
    <div class="FormGroupContent4">

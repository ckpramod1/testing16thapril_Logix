<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BTHome.aspx.cs" Inherits="logix.Home.BTHome" %>
                                    ...
                                    <div class="PendingTbl">
                                        <asp:Panel ID="panel_tool" runat="server"  Visible="true">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="PendingTblGrid">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="lnk_length" runat="server" ForeColor="Navy" Style="text-decoration: none" Text="Length Conversion" OnClick="lnk_length_Click"></asp:LinkButton></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="lnk_weight" runat="server" ForeColor="Navy" Style="text-decoration: none" Text="Weigth Conversion" OnClick="lnk_weight_Click"></asp:LinkButton></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="lnk_volume" runat="server" ForeColor="Navy" Style="text-decoration: none" Text="Volume Conversion" OnClick="lnk_volume_Click"></asp:LinkButton></td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                    </div>

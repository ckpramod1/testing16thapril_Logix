<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterForm.Master" AutoEventWireup="true" CodeBehind="Revpage3.aspx.cs" Inherits="logix.Home.Revpage3" %>
                    ...
                    <div style="height: 370px;">
                        ...
                        <asp:Panel ID="pnlpage3" runat="server" Width="100%">
                            <div class="AppLeft">
                                ...
                                <div class="FormGroupContent4">
                                    <div class="DISNone">
                                        <asp:Label ID="Label27" runat="server" ForeColor="Black" Text=""></asp:Label>
                                ...
                                <div class="FormGroupContent4 BGAltclr1">
                                    <div class="DISNone">
                                        <asp:Label ID="Label39" ForeColor="Black" runat="server" Text="a."></asp:Label>
                                    </div>
                                    <div class="Manpower4">
                                        <asp:Label ID="Label40" ForeColor="Black" runat="server" Text="ManPower"></asp:Label>
                                ...
                                <div class="FormGroupContent4 BGAltclr2">
                                    ...
                                    <div class="MANDrop">
                                        <asp:DropDownList ID="ddl2bques" runat="server" Enabled="false" ForeColor="Black" Width="100%" AppendDataBoundItems="True" ToolTip="Section" data-placeholder="Section" CssClass="chzn-select" AutoPostBack="true">
                                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Poor" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Average" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Good" Value="3"></asp:ListItem>
                                ...
                                <div class="FormGroupContent4 BGAltclr1">
                                    ...
                                    <div class="MANDrop">
                                        <asp:DropDownList ID="ddl2cques" runat="server" Enabled="false" ForeColor="Black" Width="100%" AppendDataBoundItems="True" ToolTip="Section" data-placeholder="Section" CssClass="chzn-select" AutoPostBack="true">
                                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Poor" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Average" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Good" Value="3"></asp:ListItem>
                                ...
                                <div class="FormGroupContent4 BGAltclr1">
                                    ...
                                    <div class="MANDrop">
                                        <asp:DropDownList ID="ddl2eques" runat="server" Enabled="false" ForeColor="Black" Width="100%" AppendDataBoundItems="True" ToolTip="Section" data-placeholder="Select" CssClass="chzn-select" AutoPostBack="true">
                                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Poor" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Average" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Good" Value="3"></asp:ListItem>
                                ...
                                <div class="FormGroupContent4 BGAltclr2">
                                    ...
                                    <div class="MANDrop"> 
                                        <asp:DropDownList ID="ddl2fques" runat="server" Enabled="false" ForeColor="Black" Width="100%" AppendDataBoundItems="True" ToolTip="Section" data-placeholder="Section" CssClass="chzn-select" AutoPostBack="true">
                                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Poor" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Average" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Good" Value="3"></asp:ListItem>
                                ...
                                <div class="FormGroupContent4 BGAltclr1">
                                    ...
                                    <div class="MANDrop">
                                        <asp:DropDownList ID="ddl2gans" runat="server" Enabled="false" ForeColor="Black" Width="100%" AppendDataBoundItems="True" ToolTip="Section" data-placeholder="Section" CssClass="chzn-select" AutoPostBack="true">
                                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Poor" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Average" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Good" Value="3"></asp:ListItem>
                                ...
                                <div class="FormGroupContent4">
                                    ...
                                    <asp:TextBox ID="txt2gques" runat="server" ReadOnly="true" ForeColor="Black" CssClass="form-control" TextMode="MultiLine" Width="93.5%" Height="30px" MaxLength="250"></asp:TextBox>
                            ...
                            <div class="AppRight">
                                ...
                                <div class="FormGroupContent4">
                                    ...
                                    <div class="MANDrop1">
                                        <asp:DropDownList ID="ddl3aques" runat="server" Enabled="false" Width="70px" ForeColor="Black" AppendDataBoundItems="True" ToolTip="Section" data-placeholder="Section" CssClass="chzn-select" AutoPostBack="true">
                                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                               ...
                               <div class="FormGroupContent4">
                                ...
                                <div class="FormGroupContent4">
                                    <div class="Manpower2">
                                        <asp:Label ID="Label69" runat="server"  ForeColor="Black" Text="Softskill "></asp:Label>
                                    </div>
                                    <div class="MANDrop2">
                                ...
                                <div class="FormGroupContent4">
                                    <div class="Manpower3">
                                        ...
                                        <asp:TextBox ID="txt4aQues" runat="server"  ForeColor="Black" ReadOnly="true"  ToolTip=" What are the areas for improvement identified and was it successfully accomplished" CssClass="form-control" TextMode="MultiLine" Width="100%" Height="30px" MaxLength="500"></asp:TextBox>
                                    </div>
                                ...
                                <div class="FormGroupContent4">
                                    <div class="Manpower3">
                                        ...
                                        <asp:TextBox ID="txt4bQues" runat="server"  ForeColor="Black" ReadOnly="true" CssClass="form-control" TextMode="MultiLine"  Width="100%" Height="30px" MaxLength="500"></asp:TextBox>
                                    </div>
                                </div>

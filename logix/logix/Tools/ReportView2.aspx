<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportView2.aspx.cs" Inherits="logix.Tools.ReportView2" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="div_viewcry">
                    ...
                    <CR:CrystalReportViewer ID="Crv1" runat="server" HasPrintButton="True"

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportView3.aspx.cs" Inherits="logix.Tools.ReportView3" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel runat="Server" ID="pnldebit" CssClass="Panelcss" Style="display: none;" Visible="false">
            ...
            <div class="div_closes">
               ...
               <asp:Image ID="img_detail" runat="server" ImageAlign="Baseline" ImageUrl="../images/close2.png" Width="100%" Height="100%" />
            </div>

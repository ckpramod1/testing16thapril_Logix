<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportView.aspx.cs" Inherits="logix.Tools.ReportView" ClientTarget="uplevel"%>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="div_viewcry">
                    ...
                    <CR:CrystalReportViewer ID="Crv" ClientTarget="Uplevel" runat="server" HasPrintButton="True"
        ...
        <asp:Panel runat="Server" ID="pnldebit" CssClass="Pnl" Style="display: none;" Visible="false">
            <br />
            <div class="div_close">

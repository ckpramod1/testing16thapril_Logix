...
{
    public partial class ProformaOverseaDebiCredi : System.Web.UI.Page
    {
        int len_ = 0;
        string blno = "";
            ...
            try
            {
                ...
                if (Request.QueryString.ToString().Contains("refno"))
                {
                    ...
                    if (bltype == "ProOSSI")
                    {
                        ...
                        //if (str_trantype == "FE" || str_trantype == "AE" || str_trantype == "FE" || str_trantype == "AE")
                        //{
                     ...
                     else if (bltype == "ProOSSI" || bltype == "ProOSPI")
                     {
                        ...
                        if (datenow>Convert.ToDateTime("11/30/2017"))
                        {
                            if (bltype == "OSSI")
                            {
                             ...
                             //D.   lbl_invoice.Text = portcode + "OSSI" + fyear.Substring(0, 2) + fyear.Substring(3, 2) + invno + dt.Rows[0]["dnno"].ToString().ToUpper();
                                lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) +"ID" +invno + dt.Rows[0]["dnno"].ToString().ToUpper();
                            ...
                            else if (bltype == "OSPI")
                            {
                              ...
                              //D.  lbl_invoice.Text = portcode + "OSPI" + fyear.Substring(0, 2) + fyear.Substring(3, 2) + invno + dt.Rows[0]["cnno"].ToString().ToUpper();
                                lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) +"IC"+ invno + dt.Rows[0]["cnno"].ToString().ToUpper();
                            ...
                            else if (bltype == "ProOSSI" || bltype == "ProOSPI")
                            {
                                if (bltype == "ProOSSI")
                                {
                                   ...
                                   //D. lbl_invoice.Text = portcode + "OSSI" + fyear.Substring(0, 2) + fyear.Substring(3, 2) + invno + dt.Rows[0]["refno"].ToString().ToUpper();
                                    lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "ID" + invno + dt.Rows[0]["refno"].ToString().ToUpper();
                                ...
                                else if (bltype == "ProOSPI")
                                {
                                  ...
                                  //D.  lbl_invoice.Text = portcode + "OSPI" + fyear.Substring(0, 2) + fyear.Substring(3, 2) + invno + dt.Rows[0]["refno"].ToString().ToUpper();
                                    lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) +"IC" + invno + dt.Rows[0]["refno"].ToString().ToUpper();

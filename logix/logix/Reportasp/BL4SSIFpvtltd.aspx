<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BL4SSIFpvtltd.aspx.cs" Inherits="logix.Reportasp.BL4SSIFpvtltd" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>BL Draft</title>
...
<body style="font-family: Tahoma, Geneva, sans-serif; font-size: 14px; color: #000;">
      ...
      <h1 class="text-bold text-center border-bottom">BILL OF LADING</h1>
      <div class="row">
        ...
        <div class="col">
          <div class="h-300 border-bottom">
            ...
            <div class="mt-3">
              <img src="../images/Shenzhen_Sealink_Logo.png" width="100%" alt="" />
      ...
      <div class="table">
        <table class="w-100">
          ...
          <tr>
            <td colspan="2" style="font-weight: bold; padding: 5px; text-align: left; font-size: 11px"><asp:Label ID="lblshiploadcount" runat="server" Visible="false"></asp:Label></td>
      ...
      <div class="w-100">
        ...
        <p style="font-size: 13px; font-weight: bold; padding: 0px 2px 2px; margin: 0px; text-align: center">
          <span id="lblFpayableAtDest"></span><br />
      ...
      <div class="row border-top">
        <div class="col border-right">
          ...
          <div class="row h-250 border-bottom">
            <div class="col-5 text-bold text-center border-right"></div>
            <div class="col text-bold text-center border-right">
          ...
          <p style="text-align: justify; font-size: 12px; padding: 8px">*APPLICABLE ONLY WHEN THIS DOCUMENT IS USED AS A COMBINED TRANSPORT BILL OF LADING</p>
        </div>
        <div class="col p-2">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BL4FCLrpt.aspx.cs" Inherits="logix.Reportasp.BL4FCLrpt" %>
...
<div style="width:1024px; margin:0px auto 0px auto;  border:1px solid #000;">
  <div style="float:left; width:512px; border-right:1px solid #000;">
    ...
    <div style="float:left; width:512px; border-bottom:1px solid #000; min-height:135px;">
    ...
    <div style="float:left; width:512px;min-height:137px;">
...
<div style="clear:both;"></div>
   ...
   <%--PK--%>
        ...
        <div id="comlogo"  runat="server" visible="false" style="float:left; width:511px; min-height:276px; ">
<div style="margin:35px 0 0 0;text-align: center;">
  <%--<asp:Image id="Image1" runat="server"  width="75"/>--%>
      <%--<asp:Image id="img_Logo" runat="server"  width="75"  Visible="false" ImageUrl="../Theme/assets/img/buttonIcon/report_logo.png"/>--%>

     <asp:Image id="img_Logo" runat="server"  width="75"  Visible="false"   />
...
<p style="font-size:14px; font-weight:normal; text-align: center; padding:5px 5px 0px 5px; margin:0px;"><b> Regd Office</b>: No 45, 1st Floor, 1st Main Road, West Shenoy Nagar,  </p>
 ...
 <p style="font-size:14px; font-weight:bold; text-align: center; padding:5px 5px 0px 5px; margin:0px;">  Registration No. MTO / DGS / 2569 / JAN / 2025</p>
  ...
  <div style="float:left; width:1024px; min-height:45px;">
    <div style="float:left;height: 50px; width:256px; border-right:1px solid #000; border-bottom:1px solid #000;border-top:1px solid #000">
    ...
    <div style="float:left;height: 50px; width:255px; border-right:1px solid #000; border-bottom:1px solid #000; min-height:45px;border-top:1px solid #000"">
    ...
    <div style="float:left; height: 50px;width:297px; border-right:1px solid #000; border-bottom:1px solid #000;border-top:1px solid #000;">
    ...
    <div style="float:left;height: 50px; width:213px; border-bottom:1px solid #000;border-top:1px solid #000;">
  ...
  <div style="width:1024px;">
    <table width="1024" border="0" cellspacing="0" cellpadding="0" style="padding:0px; font-size:14px; border-top:0px solid #000; border-bottom:0px solid #000;">
      <tr>
        ...
        <th  style="font-weight:normal; padding:5px 0px 5px 0px; font-size:14px; text-align:right; border-right:0px solid #000; border-top:1px solid #000; border-bottom:0px solid #000;padding-right:33px;">Gross Weight</th>
        ...
        <th  nowrap="nowrap" style="font-weight:normal; padding:5px 0px 5px 0px; font-size:14px; border-top:1px solid #000; border-bottom:0px solid #000;"></th>
       
      </tr>
      <tr>
        <td style="font-weight:bold; padding:5px; text-align:left; border-right:0px solid #000;"></td>
      
        <td  colspan="1" nowrap="nowrap" style=" padding:5px; text-align:center; padding-right:163px; border-right:0px solid #000;"  >
      ...
      <tr>
        <td  style="vertical-align:top; width:200px; border-right:0px solid #000; " >
            ...
            <p style="font-weight:normal; padding:5px 5px 5px 10px; text-align:left; white-space:pre-wrap; margin:0px; line-height:18px;">
...
<p style="font-weight:normal; padding:5px; text-align:right;  line-height:18px;"> 
    ...
    <div style="float:left; width:510px; border-left:1px solid #000; min-height:265px;">
        <div style="width:510px; float:left; border-bottom:1px solid #000; min-height:42px;">          
            ...
            FREIGHT PARTICULARS</p>
              <p style="font-size:14px; font-weight:bold;  padding:5px 5px 5px 10px; margin:0px;  ">SHIPPED ON BOARD</p>
            <p style="font-size:14px; font-weight:normal;height:27px;  padding:5px 5px 5px 11px; margin:0px;  "><asp:Label ID="lbl_sonboard" runat="server"></asp:Label></p>
        </div>
       ...
       <div style="font-size:12px; font-weight:normal;  padding:4px 15px 5px 10px; text-align:right;margin:0px; float:left;   ">
       For <B><asp:Label ID="lbl_div" runat="server"></asp:Label></B></div>   <%-- DEMO COMPANY--%>
       <div style="clear:both;"></div>

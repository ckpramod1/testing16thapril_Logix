                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    if (Profoma == "Profoma")
                                    {
                                        if (Session["countryid"].ToString() == "1102" || Session["countryid"].ToString() == "102")
                                        {
                                            if (Request.QueryString["header"].ToString() == "Invoice")
                                            {
                                                lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "SI" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                            }
                                            else if (Request.QueryString["header"].ToString() == "Invoice FC")
                                            {
                                                lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "SO" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                            }
                                            else if (Request.QueryString["header"].ToString() == "PA")
                                            {
                                                lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "PI" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                            }
                                            else if (Request.QueryString["header"].ToString() == "PA FC")
                                            {
                                                lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "PO" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                            }
                                        }
                                        else
                                        {
                                            ...
                                            {
                                                lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "SO" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                            }
                                            else if (Request.QueryString["header"].ToString() == "PA")
                                            {
                    ...
                    else if (Request.QueryString["header"].ToString() == "Invoice" || Request.QueryString["header"].ToString() == "Bill of Supply" || Request.QueryString["header"].ToString() == "Invoice FC" || Request.QueryString["header"].ToString() == "Bill of Supply FC")
                    {
                        ...
                        if (Request.QueryString.ToString().Contains("bltype"))
                        {
                            ...
                            else
                            {
                                if (Request.QueryString["header"].ToString() == "Invoice FC")
                                {
                                    lbl_head.Text = "PROFORMA INVOICE OC";
                                }
                                else
                                {
                                    lbl_head.Text = "PROFORMA INVOICE";
                                }
                            ...
                            if (bltype == "M")
                            {
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    if (Profoma == "Profoma")
                                    {
                                        ...
                                        if (Request.QueryString["header"].ToString() == "Invoice")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "SI" + invno + invoice.ToString();
                                        ...
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "SO" + invno + invoice.ToString();

                                            // lbl_invoice.Text = branch_invoice + "IN" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + invoice.ToString();
                                        }
                                        else if (Request.QueryString["header"].ToString() == "PA FC")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "PO" + invno + invoice.ToString();

                                        }
                                        else if (Request.QueryString["header"].ToString() == "PA")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "PI" + invno + invoice.ToString();
                                    ...
                                    else
                                    {
                                        ...
                                        if (Request.QueryString["header"].ToString() == "Bill of Supply")
                                        {
                                            ...
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "BS" + invno + invoice.ToString();
                                        ...
                                        else if (Request.QueryString["header"].ToString() == "Bill of Supply FC")
                                        {
                                            //D.  lbl_invoice.Text = portcode + "BS" + vouyear + invno + invoice.ToString();
                                            // lbl_invoice.Text = branch_invoice + "BS" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + invoice.ToString();
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "BO" + invno + invoice.ToString();
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            if (Header == "DN")
                            {
                                ...
                                if (Profoma == "Profoma")
                                {
                                    ...
                                    lbl_invoice.Text = portcode + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "DN" + invno + dt.Rows[0]["dnno"].ToString().ToUpper();
                                }
                                else
                                {
                            ...
                            else
                            {
                                ...
                                if (Profoma == "Profoma")
                                {
                                    ...
                                    {
                                        lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "CN" + invno + dt.Rows[0]["cnno"].ToString().ToUpper();
                                    }
                                    else if (Request.QueryString["header"].ToString() == "DEBIT NOTE")
                                    {
                                        lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + fyear.Substring(0, 2) + fyear.Substring(3, 2) + "DN" + invno + dt.Rows[0]["cnno"].ToString().ToUpper();
                                    }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OverseasVouchersrpt.aspx.cs" Inherits="logix.Reportasp.OverseasVouchersrpt" %>
        ...
        <div id="Wrapper" style="width: 100%; margin: 0px auto;">
            ...
            <div style="width: 1024px; margin: 0px auto; border:1px solid #000;">
                ...
                <div style="float: left;">
                     <div style="float:left; width:auto;height:54px; margin: 27px 10px 5px 15px; ">
...
<%--                         <p style="margin:2px 0px 2px 0px; padding:0px 0px 0px 0px; font-size:14px; font-family: Segoe UI; text-align:center; ">(Formerly Known as Axelerom International Logistics Private Limited)</p>--%>
                    ...
                    <div style="float:left; width:1024px; margin:0px 0px 0px 0px; border-top:1px solid #000;">
                        ...
                        <h3 style="font-family:'Segoe UI'; font-size:14px; color:#000; font-weight:bold; padding:0px; margin:0px;">
                ...
                <div style="float: left;font-size: 14px;margin: 5px 0px 0px 0px;color: #2c2b2b;padding: 3px 0px 5px 14px;width:95%">
                    ...
                    <div style="width:40%;float:left;border-right:1px solid #000;min-height:205px;">
                        ...
                        <div style="float: left; width: 100%; min-height: 115px;">
                            ...
                            <div style="font-size: 14px; color: #000; width: 99%; float: left;">
    ...
    <div style="width:40%;float:left;padding: 7px 0px 5px 3px;font-size: 14px; color: #000">
        <asp:Label ID="lbl_vendordate" runat="server"></asp:Label>
                         ...
                         <div id="div_shipperd" runat="server" visible="true" style="float:left;width:100%;border-bottom:1px solid #000">
                            ...
                            <div style="width:79%;float:left;padding: 7px 0px 5px 3px;font-size: 14px; color: #000">
                                <asp:Label ID="Lbl_shipperd" runat="server"></asp:Label>

                            </div>

                        </div>
                         <div id="div_shippername" runat="server" visible="true" style="float:left;width:100%;border-bottom:1px solid #000">
                            <div style="width:19%;float:left;font-weight: bold;font-size: 14px; color: #000;padding: 7px 0px 5px 3px;border-right:1px solid #000">
                                <label id="label_shippername" runat="server">Shipper </label>
                     ...
                     <%--   prepared--%>
                              <div style="float:left;width:100%;border-bottom:0px solid #000;display:none;" id="div1" runat="server" visible="true">
                            <div style="width:19%;float:left;font-weight: bold;font-size: 14px; color: #000;padding: 7px 0px 5px 3px;border-right:1px solid #000">
                    ...
                    <div style="width:49.9%;float:left;">
                         ...
                         <div style="float:left;width:100%;border-bottom:1px solid #000" id="div_grwt" runat="server" visible="true">
                             <div style="float:left;width:50%;">
                            <div style="width:38%;float:left;font-weight: bold;font-size: 14px; color: #000;padding: 7px 0px 5px 3px;border-right:1px solid #000">
                           
                                  <label id="Label_grwt" runat="server" >Gr Wt</label>
                            </div>
                            <div style="width:58%;float:left;padding: 7px 0px 5px 3px;font-size: 14px; color: #000;border-right:1px solid #000;">
                          
                                 <asp:Label ID="Lbl_grwt" runat="server"></asp:Label> Kgs
                            </div>
                            </div>
                              <div style="float:left;width:50%;">
<div style="width:38%;float:left;font-weight: bold;font-size: 14px; color: #000;padding: 7px 0px 5px 3px;border-right:1px solid #000">
                           
      <label id="Label_chargewt" runat="server" ></label> 
</div>
<div style="width:59%;float:left;padding: 7px 0px 5px 3px;font-size: 14px; color: #000">
                          
     <asp:Label ID="Lbl_chargewt" runat="server"></asp:Label> Kgs
</div>
</div>
                         ...
                         <div style="float:left;width:100%;border-bottom:1px solid #000" id="consignee" runat="server" visible="true">
                            <div style="width:19%;float:left;font-weight: bold;font-size: 14px; color: #000;padding: 7px 0px 5px 3px;border-right:1px solid #000">
                           
                                  <label id="Label_consignee" runat="server" >Consignee </label>
                            </div>
                            <div style="width:79%;float:left;padding: 7px 0px 5px 3px;font-size: 14px; color: #000">
                ...
                <%--        approved--%>
                         <div id="div3" runat="server"  style="float:left;width:100%;border-bottom:0px solid #000;display:none;">
                            <div style="width:19%;float:left;font-weight: bold;font-size: 14px; color: #000;padding: 7px 0px 5px 3px;border-right:1px solid #000">
    ...
    <div style="width:100%;float:left;min-height:15px;border-bottom: 1px solid #000;">
        ...
        <div style="width:100%;float:left;min-height:15px;border-bottom: 1px solid #000;">
            ...
            <div style="width:100%;float:left;min-height:15px;border-bottom: 1px solid #000;">
                <div style="width:17%;float:left;min-height:15px;border-right:1px solid #000">
                <div style="font-size: 14px; color: #000;width: 70%; float: left;padding: 7px 0px 5px 3px;font-weight: bold;">Swift Code</div>
                </div>
    ...
    <div style="width:37.7%;float:left;min-height:75px">
        ...
        <%--<asp:Image ID="img_sign" runat="server" ImageUrl="" />--%>
        <div style="    float: left;
    padding-left: 75px;min-height:124px">
        <asp:Image  ID="img_sign" runat="server" Width="314"  />
        </div>
        <div style="float: left;width: 80%;margin-top: 0px;margin-left: 79px;">
    ...
    margin: 0px 0px 0px 6px;">
            ...
            <asp:HiddenField ID="hdnlbl_bl" runat="server" />
        </div>
    </form>
</body>
</html>

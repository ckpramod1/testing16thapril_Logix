...
{
    public partial class ProformaOverseaDebiCrediEDI : System.Web.UI.Page
    {
        int len_ = 0;
        string blno = "";
        ...
        string type, Profoma, fyear_invoice, branch_invoice, customertype, jobtype;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Session["LoginBranchid"] = Request.QueryString["LoginBranchid"];
                }
                if (Request.QueryString.ToString().Contains("Basecurr"))
                {
                    Session["Basecurr"] = Request.QueryString["Basecurr"];
                }
                ...
                {
                    Session["StrTranType"] = Request.QueryString["StrTranType"];
                }
                ...
                if (Request.QueryString.ToString().Contains("refno"))
                {
                    ...
                    dt = objosdncn.GetOsdncnforreportnew(jobno, str_trantype, bltype, vouyear, invoice, bid);
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (datenow>Convert.ToDateTime("11/30/2017"))
                        {
                            ...
                            {
                                lbl_invoice.Text = "DN" + fyear_invoice + branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + dt.Rows[0]["dnno"].ToString().ToUpper();// dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + " / " + dt.Rows[0]["shortname"].ToString().ToUpper() + " / " + fyear + " / " + dt.Rows[0]["pano"].ToString().ToUpper();
                            }
                            else
                            {
                                lbl_invoice.Text = "CN" + fyear_invoice + branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + dt.Rows[0]["cnno"].ToString().ToUpper();// dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + " / " + dt.Rows[0]["shortname"].ToString().ToUpper() + " / " + fyear + " / " + dt.Rows[0]["pano"].ToString().ToUpper();
                            }
                        }
                        else
                        {
                        ...
                        //lbl_port.InnerText = "P o L";
                           ...
                           if (bltype == "CN")
                           {
                               if (str_trantype == "FE" || str_trantype == "FI")
                               {
                                   ...
                                   lbl_port_pod.Text = dt.Rows[0]["pod"].ToString().ToUpper();
                                   // lbl_vessel.Text = dt.Rows[0]["vesselname"].ToString().ToUpper() + "V" + dt.Rows[0]["voyage"].ToString().ToUpper();
                                   lbl_date.Text = Convert.ToDateTime(dt.Rows[0]["cndate"].ToString()).ToString("dd/MM/yyyy");
                                   lbl_package.Text = dt.Rows[0]["noofpkgs"].ToString() + " " + dt.Rows[0]["descn"].ToString(); // grweight
                                   lbl_grwt.Text = Convert.ToDouble(dt.Rows[0]["grweight"].ToString()).ToString("#,0.00") + " Kgs";
                                   jobtype = dt.Rows[0]["jobtype"].ToString();
                                   if (jobtype == "3")
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            if (bltype == "ProOSPI" || bltype == "OSPI" || bltype=="CN")
                            {
                                tr_row.Text += " <tr style='background-color:#d0d0d0'>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px; border-right: 1px solid Black; width:55px;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px; '>" + dt.Rows[i]["blno"].ToString().ToUpper() + "</label></td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px; width:290px;'>" + dt.Rows[i]["chargename"].ToString().ToUpper() + "</label></td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px; border-right: 1px solid Black; width:55px;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px; '>" + dt.Rows[i]["SACCode"].ToString().ToUpper() + "</label></td>";
                                if(bltype=="CN")
                                {
                                    tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;width:105px; white-space:nowrap;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px;'>" + dt.Rows[i]["unit"].ToString() + "</label><label style='display:inline-block; float:right; text-align:right;'>" + dt.Rows[i]["base"].ToString().ToUpper() + "</label></td>";
                                }
                                else
                                {
                                ...
                                if (!string.IsNullOrEmpty(dt.Rows[i]["Actamount"].ToString().ToUpper()))
                                {
                                    ...
                                    tr_row.Text += "<td style='color:#2c2b2b; width: 100px; text-align:right; padding:0px 2px 0px 0px; border-right: 1px solid Black;'><label style='display:inline-block; padding:0px 0px 0px 0px;text-align:right;' align='right' >" + (Convert.ToDouble(dt.Rows[i]["Actamount"].ToString().ToUpper()) / Convert.ToDouble(dt.Rows[i]["exrate"].ToString())).ToString("#,0.00") + "</label></td>";
                                }
                                else
                                {
                                    tr_row.Text += "<td style='color:#2c2b2b; width: 100px; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                }
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;' align='right'>&nbsp;</td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black; text-align:right;'>&nbsp;</td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;' align='right'>&nbsp;</td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;width:100px;'  align='right'>" + (Convert.ToDouble(dt.Rows[i]["Actamount"].ToString().ToUpper()) / Convert.ToDouble(dt.Rows[i]["exrate"].ToString())).ToString("#,0.00") + "</td></tr>";
                            ...
                            {
                                tr_row.Text += " <tr style='background-color:#d0d0d0'>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px; border-right: 1px solid Black; white-space:nowrap; width:155px;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px; '>" + dt.Rows[i]["blno"].ToString().ToUpper() + "</label></td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px; width:290px;'>" + dt.Rows[i]["chargename"].ToString().ToUpper() + "</label></td>";
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px; border-right: 1px solid Black; width:55px;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px; '>" + dt.Rows[i]["SACCode"].ToString().ToUpper() + "</label></td>";
                                if (bltype == "DN")
                                {
                                ...
                                {
                                    tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black; text-align:right;'>" + (Convert.ToDouble(dt.Rows[i]["cgsta"].ToString()) / Convert.ToDouble(dt.Rows[i]["exrate"].ToString())).ToString("#,0.00") + "</td>";
                                ...
                                {
                                    tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black; text-align:right;'>" + (Convert.ToDouble(dt.Rows[i]["sgsta"].ToString()) / Convert.ToDouble(dt.Rows[i]["exrate"].ToString())).ToString("#,0.00") + "</td>";
                                ...
                                {
                                    tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;' align='right'>" + (Convert.ToDouble(dt.Rows[i]["igsta"].ToString()) / Convert.ToDouble(dt.Rows[i]["exrate"].ToString())).ToString("#,0.00") + "</td>";
                                ...
                                tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;width:100px;'  align='right'>" + Convert.ToDouble(dt.Rows[i]["fcamt"].ToString()).ToString("#0,0.00") + "</td></tr>";
                        ...
                        if (row_count < 20)
                        {
                            ...
                            if (bltype == "ProOSSI" || bltype == "OSSI")
                            {
                                ...
                                {
                                    tr_row.Text += " <tr style='background-color:#d0d0d0'>";
                                    tr_row.Text += "<td style='color:#2c2b2b; white-space:nowrap; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                    tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                    tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                    tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                    tr_row.Text += "<td style='color:#2c2b2b; padding:0px 2px 0px 0px;  border-right: 1px solid Black;'>&nbsp;</td>";

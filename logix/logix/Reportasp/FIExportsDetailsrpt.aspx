<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FIExportsDetailsrpt.aspx.cs" Inherits="logix.Reportasp.FIExportsDetailsrpt" %>
...
FAX :
          ...
          <div style="float:right; width:70px; margin:10px 0px 0px 0px; color:#ffffff; font-size:10px;font-family:sans-serif;" class="Printbtn">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style=" width:100%; border-collapse:collapse; border-right:1px solid #cdbcb1; border-left:1px solid #cdbcc1; border-top:1px solid #cdbcc1; border-bottom:1px solid #cdbcc1; margin:10px 0px 0px 0px;">
    <tr style="background-color:#d0d0d0;">
      <td width="27%" valign="top" style="color:#2c2b2b; font-size:14px; padding:5px 2px 5px 10px;  border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1;">
        ...
        <div style="float:left; width:110px; margin:5px 5px 5px 0px; color:#000000; min-height:21px;"><span><asp:Label ID="linervalue" runat="server"></asp:Label></span></div>
          <div style="float:left; width:110px; margin:5px 5px 5px 0px; color:#000000;"><label>CFS</label></div>
        <div style="float:left; width:110px; margin:5px 5px 5px 0px; color:#000000; min-height:21px;"><span><asp:Label ID="cfsvalue" runat="server"></asp:Label></span></div>
        <div style="float:left; width:110px; margin:5px 5px 5px 0px; color:#000000;"><label>DeStuff On</label></div>
      ...
      <td width="25%" valign="top" style="color:#2c2b2b; font-size:14px; padding:5px 2px 5px 10px;  border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1;">
       <div style="float:left; width:110px; margin:5px 5px 5px 0px; color:#000000;"><label>Job Date</label></div>
        ...
        <div style="float:left; width:110px; margin:19px 5px 5px 0px; color:#000000;"><label>MBL DATLE</label></div>
        <div style="float:left; width:110px; margin:19px 5px 5px 0px; min-height:21px; color:#000000;"><span><asp:Label ID="draftsendonvalue" runat="server"></asp:Label></span></div>   
          <div style="float:left; width:110px; margin:65px 5px 5px 0px; color:#000000;"><label>CAN DATE</label></div>
        <div style="float:left; width:110px; margin:65px 5px 5px 0px; min-height:21px; color:#000000;"><span><asp:Label ID="candatevalue" runat="server"></asp:Label></span></div>   
       
      </td>
      <td width="28%" valign="top"  style="color:#2c2b2b; font-size:14px; padding:5px 2px 5px 10px;  border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1;">
      ...
      <div style="float:left; width:110px; margin:5px 5px 5px 0px; color:#000000;"><label>POD</label></div>
        ...
        <div style="float:left; width:110px; margin:5px 5px 5px 0px; color:#000000; min-height:21px;"><%--<span><asp:Label ID="releaseonvalue" runat="server"></asp:Label></span>--%></div>
         <div style="float:left; width:110px; margin:19px 5px 5px 0px; color:#000000;"><label>Agent</label></div>
        <div style="float:left; width:110px; margin:19px 5px 5px 0px; color:#000000; min-height:21px;"><span><asp:Label ID="agentvalue" runat="server"></asp:Label></span></div>
       <div style="float:left; width:110px; margin:7px 5px 5px 0px; color:#000000;"><label>CFS Code</label></div>
        <div style="float:left; width:110px; margin:7px 5px 5px 0px; color:#000000; min-height:21px;"><span><asp:Label ID="cfscodevalue" runat="server"></asp:Label></span></div>
          <div style="float:left; width:110px; margin:2px 5px 5px 0px; color:#000000;"><label>IM# & Date</label></div>
        <div style="float:left; width:110px; margin:2px 5px 5px 0px; color:#000000; min-height:21px;"><span><asp:Label ID="imnumvalues" runat="server"></asp:Label>&<asp:Label ID="imdate" runat="server"></asp:Label></span></div>
      </td>
      <td width="25%" valign="top" style="color:#2c2b2b; font-size:14px; padding:5px 2px 5px 10px;  border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1;">
      ...
      <div style="float:left; width:90px; margin:-5px 5px 5px 0px; color:#000000;"><label>ETA</label></div>
        <div style="float:left; width:70px; margin:-5px 5px 5px 0px; color:#000000; min-height:21px;"><span><asp:Label ID="ETAVALUENEW" runat="server"></asp:Label></span></div>
      ...
      <tr style="background-color:#878788;"><td colspan="4" style="border-bottom:1px solid #b1b1b1;">
          <div style="float:left; width:110px; margin:5px 5px 5px 0px; color:#ffffff;"><label>Container Details</label></div>
        <div style="float:left; width:85%; margin:5px 5px 5px 0px; min-height:21px; text-align:justify; color:#ffffff;"><span><asp:Label ID="containerdetails" runat="server"></asp:Label></span></div>

          </td></tr>
    <tr style="background-color:#d0d0d0;">
      <td colspan="4" style="color:#2c2b2b; font-size:14px; padding:5px 2px 5px 2px;  border-right:1px solid #cdbcb1;"><div style="float:left; width:150px; font-weight:bold; margin:5px 5px 5px 0px; color:#000000;">House BL Details</div>
       
        <div style="float:left; width:100%; margin:5px 5px 5px 0px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #b1b1b1; padding:0px 0px 0px 0px;">
            <tr>
              <td style="border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1; color:#ffffff; background-color:#184684; padding:5px;">HBL #</td>
              <td style="border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1; color:#ffffff;  background-color:#184684;  padding:5px;">Consignee</td>
              <td style="border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1; color:#ffffff;  background-color:#184684;  padding:5px;">FBL # </td>
              <td style="border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1; color:#ffffff;  background-color:#184684;  padding:5px;">CBM</td>
              <td style="border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1; color:#ffffff;  background-color:#184684;  padding:5px;">POL</td>
              <td style="border-right:1px solid #b1b1b1; border-bottom:1px solid #b1b1b1; color:#ffffff;  background-color:#184684;  padding:5px;">FD</td>
              </tr>
           <%-- <tr>

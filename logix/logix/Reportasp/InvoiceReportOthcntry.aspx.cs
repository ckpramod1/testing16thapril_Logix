...
{
    public partial class InvoiceReportOthcntry : System.Web.UI.Page
    {
       ...
       //     divqr.Visible = false;
            ...
            try
            {
                ...
                if (Request.QueryString.ToString().Contains("Invoiceno"))
                {
                    ...
                    lblcompanyname.Text = Session["LoginDivisionName"].ToString();
                    lbl4comname.InnerText = lblcompanyname.Text.ToUpper();
                 //   lbl_img.ImageUrl = "../images/s2cpaint2.png"; //--test
                    ...
                    dtadd = da_obj_Log.GetCompanyNameAdd(Convert.ToInt32(Session["LoginBranchid"].ToString()));
                    {
                        ...
                        lbl_st.Text = dtadd.Rows[0]["cinno"].ToString().ToUpper();
                    ...
                    if (Request.QueryString["header"].ToString() == "Invoice")
                    {
                        ...
                        if (duedate1 == "0")
                        {
                            // bihe lbl_date1.Text = "Immediate".ToUpper();

                        }
                        else
                        {
                            // bihe lbl_date1.Text = duedate1;
                        }
                    ...
                    if (Profoma == "")
                    {
                        ...
                        else if (Request.QueryString["header"].ToString() == "Invoice FC")
                        {

                            {
                                dtnew1 = objnewdoc.getdetails4gstdetails(bid, invoice, vouyear, "F");
                                if (dtnew1.Rows.Count > 0)
                                {
                                    //  div_image1.Visible = true;
                                    //    div_irn.Visible = true;
                ...
                if (Request.QueryString.ToString().Contains("header"))
                {
                    ...
                    if (Header == "CN" || Header == "PA" || Header == "PA FC")
                    {
                        label_bill.InnerText = "Bill From";
                        label_supply.InnerText = "Supply From";
                    }
                    if (Request.QueryString["header"].ToString() == "PA" || Request.QueryString["header"].ToString() == "PA FC")
                    {
                        dimbl.Visible = false;
                        divp.Visible = false;
                        div_exrate.Visible = false;
                        divinvtype.InnerText = "Purchase Invoice No. ";// "Cn-Ops";
                        //  divsc.Visible = false;
                        //   divIRND.Visible = false;
                        ...
                        if (Request.QueryString["header"].ToString() == "PA")
                        {
                            if (Profoma == "")
                            {
                                lbl_head.Text = "Purchase Invoice";
                                div_cnops.Visible = true;//"CREDIT NOTE - OPERATIONS";
                                terms.Visible = true;
                            }
                            else
                            {
                                lbl_head.Text = "Proforma Purchase Invoice";
                                divinvtype.InnerText = "Ref #";
                                //lbl_head.Text = "PROFORMA CREDIT NOTE - OPERATIONS";
                            }
                        }
                        if (Request.QueryString["header"].ToString() == "PA FC" )
                        {
                            if (Profoma == "")
                            {
                                lbl_head.Text = "Purchase Invoice FC";
                                div_cnops.Visible = true;//"CREDIT NOTE - OPERATIONS";
                                terms.Visible = true;
                            }
                            else
                            {
                                lbl_head.Text = "Proforma Purchase Invoice FC";
                                divinvtype.InnerText = "Ref #";
                                //lbl_head.Text = "PROFORMA CREDIT NOTE - OPERATIONS";
                            }
                        }
                            ...
                            if (bltype == "M")
                            {
                               ...
                               // dt = obj_inv.Getinvoicedetailsforreport(bid, str_trantype, invoice, vouyear, bltype, "PA", "", Profoma);
                                if (Request.QueryString["header"].ToString() == "PA")
                                {
                                 ...
                                 else if (Request.QueryString["header"].ToString() == "PA FC")
                                {
                                    dt = obj_inv.Getinvoicedetailsforreport(bid, str_trantype, invoice, vouyear, bltype, "PA FC", "", Profoma);
                                }
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    if (str_trantype == "FE")
                                    {
                                        lbl_pos.Text = dt.Rows[0]["mpolname"].ToString() + " / " + Convert.ToDateTime(dt.Rows[0]["etd"]).ToString("dd/MMM/yyyy");
                                    ...
                                    //if (exrate > 0)
                                    //{
                                    //    lbl_exrate.Text = exrate.ToString("#,0.0000");
                                    //}
                                    ...
                                    for (int j = 0; j < Dt_sort.Rows.Count; j++)
                                    {
                                        ...
                                        if (exrate > 0)
                                        {
                                            ...
                                            if (lbl_exrate.Text == "")
                                            {
                                                lbl_exrate.Text = Dt_sort.Rows[j]["curr"].ToString() + " " + exrate.ToString("#,0.0000");
                                            }
                                            else
                                            {
                                                lbl_exrate.Text += " / " + Dt_sort.Rows[j]["curr"].ToString() + " " + exrate.ToString("#,0.0000");
                                    ...
                                    if (Profoma == "Profoma")
                                    {
                                        ...
                                        //D.   lbl_invoice.Text = portcode + "IN" + vouyear + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                        if (Request.QueryString["header"].ToString() == "Invoice")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "SI" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                        }
                                        else if (Request.QueryString["header"].ToString() == "PA")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "PI"+ invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                        }
                                        else if (Request.QueryString["header"].ToString() == "PA FC")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "PO" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                        }

                                    }
                                    else
                                    {
                                        divinvtype.InnerText = "PI #";
                                        ...
                                        //D.    lbl_invoice.Text = portcode + "PA" + vouyear + invno + dt.Rows[0]["pano"].ToString().ToUpper();

                                   //     lbl_invoice.Text = branch_invoice + "PA" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                        lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "PI" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                    ...
                                    {
                                        // b hide     lbl_pod.Text = dt.Rows[0]["mpolname"].ToString().ToUpper();

                                      //  lbl_pod.Text = dt.Rows[0]["mpolname"].ToString().ToUpper() + '/' + dt.Rows[0]["mpodname"].ToString().ToUpper();
                                        lbl_pod.Text = dt.Rows[0]["pod"].ToString().ToUpper() + " / " + Convert.ToDateTime(dt.Rows[0]["eta"]).ToString("dd/MMM/yyyy");
                                    ...
                                    for (int i = 0; i < dtLi.Rows.Count; i++)
                                    {
                                        if (string.IsNullOrEmpty(dtLi.Rows[i]["percentage"].ToString()))
                                        {
                                            ...
                                            if (str_trantype == "AE" || str_trantype == "AI")
                                            {
                                                ...
                                                tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:105px;'><label style='display:block; text-align:center; white-space:nowrap;'>" + dtLi.Rows[i]["base"].ToString().ToUpper().Replace("HAWBL", "FLAT RATE").Replace("HAWB", "FLAT RATE").Replace("KGS", "PER KG") + "</label></td>";
                                            }
                                            else
                                            {
                                                ...
                                                tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:105px;'><label style='display:block;text-align:center; white-space:nowrap;'>" + dtLi.Rows[i]["base"].ToString().ToUpper() + "</label></td>";
                                            }
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    if (Profoma == "Profoma")
                                    {
                                        ...
                                        if (Request.QueryString["header"].ToString() == "Invoice")
                                        {
                                          ...
                                          //  lbl_invoice.Text = branch_invoice + "IN" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                        }
                                        else if (Request.QueryString["header"].ToString() == "PA")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "PI" + invno + dt.Rows[0]["pano"].ToString().ToUpper();
                                    ...
                                    if (str_trantype == "BT")
                                    {
                                        ...
                                        div_grw.Visible = false;
                                        div_volume.Visible = false;
                                        lbl4comname.InnerText = "for " + dt.Rows[0]["branchname"].ToString().ToUpper();
                                            ...
                                            if (str_trantype == "FE" || str_trantype == "FI")
                                            {
                                                ...
                                                if (jobtype != "")
                                                {
                                                    if (jobtype == "3")
                                                    {
                                                        ...
                                                        if (Request.QueryString.ToString().Contains("blno"))
                                                        {
                                                            blno = blno = Request.QueryString["blno"].ToString().ToUpper();
                                                            dtnew1 = obj_inv.getsizetype(blno, jobno, bid, str_trantype);
                                                        }

                                                        if (dtnew1.Rows.Count > 0)
                                                        {
                                                            lbl_volume.Text = dtnew1.Rows[0]["size"].ToString().ToUpper().ToUpper();
                                                        }
                                                        else
                                                        {
                                                            //lbl_volume.Text = dt.Rows[0]["cont20"].ToString() + " x 20' ;" + dt.Rows[0]["cont40"].ToString() + " x 40'";
                                        ...
                                        for (int i = 0; i < dtLi.Rows.Count; i++)
                                        {
                                            if (string.IsNullOrEmpty(dtLi.Rows[i]["percentage"].ToString()))
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:105px; white-space:nowrap;'><label style='display:inline-block; float:left; white-space:nowrap;margin: 0px 0px 0px 34px;text-align: center;'>" + Convert.ToDouble(dtLi.Rows[i]["unit"].ToString()).ToString("#0.000") + "</label></td>";
                                    ...
                                    {
                                        for (int i = 0; i < dtLi.Rows.Count; i++)    //set2
                                        {
                                            if (string.IsNullOrEmpty(dtLi.Rows[i]["percentage"].ToString()))
                                            {
                                                tr_row.Text += " <tr style=''>";
                                                tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:998px;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px;'>" + dtLi.Rows[i]["chargename"].ToString().ToUpper() + "</label></td>";
                                                //tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px; border-right: 1px solid Black; width:55px;'><label style='display:inline-block; float:left; padding:0px 0px 0px 0px; '>" + dtLi.Rows[i]["SACCode"].ToString().ToUpper() + "</label></td>";
                                                if (str_trantype == "AE" || str_trantype == "AI")
                                                {
                                                ...
                                                tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:200px;text-align:center'><label >" + dtLi.Rows[i]["curr"].ToString().ToUpper() + "</label></td>";
                                        ...
                                        for (int i = 0; i < dtLi.Rows.Count; i++)
                                        {
                                            if (!string.IsNullOrEmpty(dtLi.Rows[i]["percentage"].ToString()) || dtLi.Rows[i]["percentage"].ToString() == "0")
                                            {
                                                ...
                                                // hide nambi //tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;' align='right'>" + dtLi.Rows[i]["CGSTP"].ToString() + "</td>";
                                                if (!string.IsNullOrEmpty(dtLi.Rows[i]["cgsta"].ToString()))
                                                {
                                                    // hide nambi //tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black; text-align:right;'>" + Convert.ToDouble(dtLi.Rows[i]["cgsta"].ToString()).ToString("#,0.00") + "</td>";
                                                    // hide nambi //cgsta += Convert.ToDouble(dtLi.Rows[i]["cgsta"].ToString());
                                                }
                                                else
                                                {
                                                    tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;'>&nbsp;</td>";
                                                }
                                                // hide nambi //tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black; text-align:right;'>" + dtLi.Rows[i]["sgstp"].ToString() + "</td>";
                                                if (!string.IsNullOrEmpty(dtLi.Rows[i]["sgsta"].ToString()))
                                                {
                                                    // hide nambi // tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black; text-align:right;'>" + Convert.ToDouble(dtLi.Rows[i]["sgsta"].ToString()).ToString("#,0.00") + "</td>";
                                                    // hide nambi //sgsta += Convert.ToDouble(dtLi.Rows[i]["sgsta"].ToString());
                                                }
                                                else
                                                {
                                                    tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;'>&nbsp;</td>";
                    ...
                    else if (Request.QueryString["header"].ToString() == "Invoice" || Request.QueryString["header"].ToString() == "Bill of Supply" || Request.QueryString["header"].ToString() == "Invoice FC" || Request.QueryString["header"].ToString() == "Bill of Supply FC")
                    {
                        //lbl_total.Text = Convert.ToDouble(Request.QueryString["total"]).ToString("#,0.00");
                        ...
                        if (Request.QueryString.ToString().Contains("bltype"))
                        {
                            ...
                            if (Profoma == "")
                            {
                                ...
                                terms.Visible = true;
                                if (Request.QueryString["header"].ToString() == "Bill of Supply" || Request.QueryString["header"].ToString() == "Bill of Supply FC")
                                {
                                    lbl_head.Text = "Bill of Supply";
                                    divinvtype.InnerText = "BOS #";
                                    //label_invoice.InnerText = "BOS";
                                }
                                else
                                {
                                    if (Request.QueryString["header"].ToString() == "Invoice FC")
                                    {
                                        lbl_head.Text = "TAX INVOICE OC";
                                        divinvtype.InnerText = "Invoice No.";
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                  if (Request.QueryString["header"].ToString() == "Invoice FC")
                                {
                                    lbl_head.Text = "Proforma Sales Invoice OC";
                                }
                                else
                                {

                                    lbl_head.Text = "Proforma Sales Invoice";
                            ...
                            if (bltype == "M")
                            {
                                ...
                                if (Request.QueryString["header"].ToString() == "Bill of Supply" || Request.QueryString["header"].ToString() == "Bill of Supply FC")
                                {
                                    ...
                                    else if (Request.QueryString["header"].ToString() == "Bill of Supply FC")
                                    {
                                        dt = obj_inv.Getinvoicedetailsforreport(bid, str_trantype, invoice, vouyear, bltype, "BOS FC", "", Profoma);
                                    }
                                    //dt = obj_inv.Getinvoicedetailsforreport(bid, str_trantype, invoice, vouyear, bltype, "Bill of Supply", "", Profoma);
                                    if (Request.QueryString["header"].ToString() == "Bill of Supply")
                                    {
                                        //div_vendorref.Visible = true;
                                        //llbl_vendor.Text = dt.Rows[0]["vendorrefno"].ToString().ToUpper();

                                        if (str_trantype == "FE")
                                        {
                                            lbl_pos.Text = dt.Rows[0]["pol"].ToString() + " / " + Convert.ToDateTime(dt.Rows[0]["etd"]).ToString("dd/MMM/yyyy");
                                ...
                                else
                                {
                                    if (Request.QueryString["header"].ToString() == "Invoice FC")
                                    {
                                        dt = obj_inv.Getinvoicedetailsforreport(bid, str_trantype, invoice, vouyear, bltype, "Invoice FC", "", Profoma);
                                    }
                                    else
                                    {
                                 ...
                                 //   dt = obj_inv.Getinvoicedetailsforreport(bid, str_trantype, invoice, vouyear, bltype, "Invoice", "", Profoma);
                                    if (Request.QueryString["header"].ToString() == "Invoice" || Request.QueryString["header"].ToString() == "Invoice FC")
                                    {
                                        div_vendorref.Visible = true;
                                        lbl_vendor.Text = dt.Rows[0]["vendorrefno"].ToString().ToUpper();
                                        if (str_trantype == "FE")
                                        ...
                                        //DataTable dtref = obj_inv.Getcusrefnofromquot4rpt(bid, str_trantype, invoice, Profoma);
                                        //if (dtref.Rows.Count > 0)
                                        //{
                                        //    lbl_vendor.Text = dtref.Rows[0]["cuspono"].ToString().ToUpper();
                                        //}
                                        //div_vendorrefdate.Visible = true;
                                        if (!string.IsNullOrEmpty(dt.Rows[0]["vendorrefdate"].ToString()))
                                        {
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    if (Profoma == "Profoma")
                                    {
                                        ...
                                        if (Request.QueryString["header"].ToString() == "Invoice")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "SI" + invno + invoice.ToString();

                                           // lbl_invoice.Text = branch_invoice + "IN" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + invoice.ToString();
                                        }
                                        else if (Request.QueryString["header"].ToString() == "Invoice FC")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "SO" + invno + invoice.ToString();

                                            // lbl_invoice.Text = branch_invoice + "IN" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + invoice.ToString();
                                        }
                                        else if (Request.QueryString["header"].ToString() == "PA FC")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "PO" + invno + invoice.ToString();

                                        }
                                        else if (Request.QueryString["header"].ToString() == "PA")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "PI" + invno + invoice.ToString();

                                        }

                                        //d. lbl_invoice.Text = portcode + "IN" + vouyear + invno + invoice.ToString();
                                    ...
                                    else
                                    {
                                        ...
                                        if (Request.QueryString["header"].ToString() == "Bill of Supply")
                                        {
                                            //D.  lbl_invoice.Text = portcode + "BS" + vouyear + invno + invoice.ToString();
                                           // lbl_invoice.Text = branch_invoice + "BS" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + invoice.ToString();
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "BS" + invno + invoice.ToString();
                                       ...
                                       else if (Request.QueryString["header"].ToString() == "Bill of Supply FC")
                                        {
                                            //D.  lbl_invoice.Text = portcode + "BS" + vouyear + invno + invoice.ToString();
                                            // lbl_invoice.Text = branch_invoice + "BS" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + invoice.ToString();
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "BO" + invno + invoice.ToString();
                                        ...
                                        else
                                        {
                                            ...
                                            //  lbl_invoice.Text = portcode + "IN" + vouyear + invno + invoice.ToString();
                                          //  lbl_invoice.Text = branch_invoice + "IN" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + invoice.ToString();
                                          //  lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "SI" + invno + invoice.ToString();
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    if (Profoma == "Profoma")
                                    {
                                        ...
                                        else if (Request.QueryString["header"].ToString() == "PA")
                                        {
                                          ...
                                          //  lbl_invoice.Text = branch_invoice + "PA" + vouyear + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + invoice.ToString();
                                        }
                                        else if (Request.QueryString["header"].ToString() == "PA FC")
                                        {
                                            lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "PO" + invno + invoice.ToString();
                                    ...
                                    else if (str_trantype == "FI")
                                    {
                                        ...
                                        // B HIDE   lbl_port.InnerText = "P O R / P O L";/// B HIDE
                                        ...
                                        if (dt.Columns.Contains("mpolname"))
                                        {
                                            // B HIDE  lbl_pod.Text = dt.Rows[0]["mpolname"].ToString().ToUpper(); // BHIDE
                                            lbl_pod.Text = dt.Rows[0]["pol"].ToString().ToUpper() + " / " + dt.Rows[0]["fd"].ToString().ToUpper();
                                        }
                                        else
                                        {
                        ...
                        {
                            dt = obj_inv.GetinvoicedetailsgridBOSFC(invoice, bid, vouyear, str_trantype, Profoma);
                        }
                        else if (Request.QueryString["header"].ToString() == "Invoice FC")
                        {
                            dt = obj_inv.GetinvoicedetailsgridFC(invoice, bid, vouyear, str_trantype, Profoma);
                        }
                        else
                        {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            for (int i = count; i < dt.Rows.Count; i++)
                            {
                                //i = count;
                                tr_row.Text += " <tr style=''>";
                                tr_row.Text += "<td style='color:#000000; padding:0px 8px 0px 0px;  border-right: 1px solid Black;'><label style='display:inline-block; float:left; padding:0px 0px 0px 2px; width:502px;'>" + dt.Rows[i]["chargename"].ToString().ToUpper() + "</label></td>";
                               // tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px; border-right: 1px solid Black; width:55px;'><label style='display:inline-block; float:left; padding:0px 0px 0px 0px; '>" + dt.Rows[i]["SACCode"].ToString().ToUpper() + "</label></td>";
                                ...
                                if (str_trantype == "AE" || str_trantype == "AI")
                                {
                                    ...
                                    tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:97px;'><label style='display:block;white-space:nowrap;text-align:right'>" + Convert.ToDouble(dt.Rows[i]["unit"].ToString()).ToString("#0.000") + "</label></td>";
                                ...
                                {
                                    //bb hide
                                    //tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:105px;'><label style='display:inline-block; float:left;'>" + dt.Rows[i]["base"].ToString() + "</label><label style='display:inline-block; float:right; text-align:right;'></label></td>";
                                    //tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:105px;'><label style='display:inline-block; float:left;'>" + dt.Rows[i]["unit"].ToString() + "</label><label style='display:inline-block; float:right; text-align:right;'></label></td>";
                                    //tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:105px;'><label style='display:inline-block; float:left;'>" + dt.Rows[i]["Rate"].ToString() + "</label><label style='display:inline-block; float:right; text-align:right;'></label></td>";



                                    tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:305px;'><label style='display:block; white-space:nowrap;text-align:right'>" + Convert.ToDouble(dt.Rows[i]["unit"].ToString()).ToString("#0.000") + "</label></td>";
                                ...
                                //   b hide
                                tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;width:150px;'><label style='display:block;text-align:center'>" + dt.Rows[i]["curr"].ToString().ToUpper() + "</label></td>";
                           ...
                           // bihe     tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black;' align='right'>" + dt.Rows[i]["CGSTP"].ToString() + "</td>";
                                if (!string.IsNullOrEmpty(dt.Rows[i]["cgsta"].ToString()))
                                {
                                    // b  hie tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black; text-align:right;'>" + Convert.ToDouble(dt.Rows[i]["cgsta"].ToString()).ToString("#,0.00") + "</td>";
                             ...
                             // bihe   tr_row.Text += "<td style='color:#000000; padding:0px 2px 0px 2px;  border-right: 1px solid Black; text-align:right;'>" + dt.Rows[i]["sgstp"].ToString() + "</td>";
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            if (Header == "DN")
                            {
                                ...
                                if (Profoma == "Profoma")
                                {
                                    ...
                                    lbl_invoice.Text = portcode + vouyear + "DN" + invno + dt.Rows[0]["dnno"].ToString().ToUpper();
                                }
                                else
                                {
                            ...
                            else
                            {
                                ...
                                if (Profoma == "Profoma")
                                {
                                    ...
                                    {
                                        lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear +"CN" + invno + dt.Rows[0]["cnno"].ToString().ToUpper();
                                    }
                                    else if (Request.QueryString["header"].ToString() == "DEBIT NOTE")
                                    {
                                        lbl_invoice.Text = branch_invoice + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + vouyear + "DN" + invno + dt.Rows[0]["cnno"].ToString().ToUpper();
                                    }

                                    //d.14 feb 23  lbl_invoice.Text = portcode + "CN" + vouyear + invno + dt.Rows[0]["cnno"].ToString().ToUpper();
                                }
                                else
                                {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        lbl_toaddress.Text += dt.Rows[0]["address"].ToString().ToUpper() + "<br />";  //.Replace(",", "")
                    }
                    ...
                    if (!string.IsNullOrEmpty(dt.Rows[0]["gstin"].ToString()))
                    {
                        lbl_toaddress.Text += "<strong>GST # :</strong>" + dt.Rows[0]["gstin"].ToString() + ",";//+ "Fax :" + dt.Rows[0]["fax"].ToString()
                    }
                    if (!string.IsNullOrEmpty(dt.Rows[0]["statename"].ToString()))
                    {
                        lbl_toaddress.Text += "<strong>State  :</strong>" + dt.Rows[0]["statename"].ToString() + ",";//+ "Fax :" + dt.Rows[0]["fax"].ToString()
                    }
                    if (!string.IsNullOrEmpty(dt.Rows[0]["gstcode"].ToString()))
                    {
                        lbl_toaddress.Text += "<strong>Code # :</strong>" + dt.Rows[0]["gstcode"].ToString() + ".";//+ "Fax :" + dt.Rows[0]["fax"].ToString()
                    }


                    //  div_gst.Text = dt.Rows[0]["gstin"].ToString().ToUpper().ToUpper();
                    //  gst_state.Text = dt.Rows[0]["statename"].ToString().ToUpper();

                    //   gst_code.Text = dt.Rows[0]["gstcode"].ToString().ToUpper();
                }
                if (supplyto != 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (!string.IsNullOrEmpty(dt.Rows[0]["address"].ToString()))
                        {
                            lbl_tosupply.Text += dt.Rows[0]["address"].ToString().ToUpper() + "<br />"; //.Replace(",", "")
                        }
                        if (!string.IsNullOrEmpty(dt.Rows[0]["Location"].ToString()))
                        {
                        ...
                        if (!string.IsNullOrEmpty(dt.Rows[0]["gstin"].ToString()))
                        {
                            lbl_tosupply.Text += "<strong>GST # :</strong>" + dt.Rows[0]["gstin"].ToString() + ",";//+ "Fax :" + dt.Rows[0]["fax"].ToString()
                        }
                        if (!string.IsNullOrEmpty(dt.Rows[0]["statename"].ToString()))
                        {
                            lbl_tosupply.Text += "<strong>State  :</strong>" + dt.Rows[0]["statename"].ToString() + ",";//+ "Fax :" + dt.Rows[0]["fax"].ToString()
                        }
                        if (!string.IsNullOrEmpty(dt.Rows[0]["gstcode"].ToString()))
                        {
                            lbl_tosupply.Text += "<strong>Code # :</strong>" + dt.Rows[0]["gstcode"].ToString() + ".";//+ "Fax :" + dt.Rows[0]["fax"].ToString()
                        }
                        //b hide
                ...
                th_basecurr.InnerText ="Total Amount " + Session["Basecurr"].ToString().ToUpper();
        ...
        public string conversion(string amount, string curr)
        {
            ...
            else if (curr == "USD")
            {
                ...
                Content = beforefloating + ' ' + " AND " + afterfloating + ' ' + " CENTS ";
            }
            else if (curr == "AED")
            {
                var beforefloating = ConvertNumbertoWordsUSD(Convert.ToInt64(m));
            ...
            else if (curr == "XOF")
            {
                var beforefloating = ConvertNumbertoWordsUSD(Convert.ToInt64(m));
                var afterfloating = ConvertNumbertoWordsUSD(Convert.ToInt64(j));
                Content = beforefloating + ' ' + " WEST AFRICAN CFA FRANC " + ' ' + afterfloating + ' ' + " CENTIME  ";
            }
            return Content;
        }

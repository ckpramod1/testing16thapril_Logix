<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoicerptFAnew.aspx.cs" Inherits="logix.Reportasp.InvoicerptFAnew" %>
...
<%--                         <p style="margin:2px 0px 2px 0px; padding:0px 0px 0px 0px; font-size:14px; font-family: Segoe UI; text-align:center; ">(Formerly Known as Axelerom International Logistics Private Limited)</p>--%>
                ...
                <div style="float: left; width: 570px; min-height:379px; border-right:1px solid #000;">

                    <div style="width: 566px; float: left; min-height: 140px; color: #000000;">
                        <div style="float: left; width: 566px; min-height: 120px;">
                        ...
                        <div style="width: 570px; float: left; border-top: 1px solid #000;">
                    ...
                    <div style="width: 570px; float: left; min-height: 117px; border-top: 1px solid #000; color: #000000;">
                        <div style="float: left; width: 566px; min-height: 125px;">
                        ...
                        <div style="width: 570px; float: left; border-top: 1px solid #000; min-height:38px;">
                            <div style="float: left; width: 45px; margin: 5px 0px 0px 20px; padding: 0px 0px 0px 0px; font-weight: bold;">GST #</div>
                ...
                <div style="width: 452px; float: left;">
                    ...
                    <div style="width: 457px; float: left; min-height:274px; padding:5px 0px 0px 0px; ">
                        ...
                        <div id="div_OBL" runat="server" visible="true">
                            <label id="lbl_oblname" runat="server" style="width: 165px; float: left; display: inline-block; margin: 0px 0px 5px 0px; font-weight: bold;color: #000000; padding: 0px 0px 0px 20px;">OBL</label>


                            <asp:Label ID="lbl_obl" runat="server" Style="width: 260px; float: left; display: inline-block; margin: 0px 0px 5px 0px;"></asp:Label>
                        </div>
                        ...
                        <div id="div_port1" runat="server" visible="true">
                            <label id="lbl_port1" runat="server" style="width: 165px; float: left; display: inline-block; margin: 0px 0px 5px 0px;color: #000000; font-weight: bold; padding: 0px 0px 0px 20px;">P O L</label>


                            <asp:Label ID="lbl_pod1" runat="server" Style="width: 260px; float: left; display: inline-block; margin: 0px 0px 5px 0px;"></asp:Label>
                        </div>
...
<div style="clear: both;"></div>
                       <div  id="div2" runat="server" visible="true" style="border-top:1px solid #000; width:453px; margin:0px 0px 5px 0px;">
 ...
 <div style="clear: both;"></div>
                        ...
                        <div style="float:left; width:99.2%; border-bottom:1px solid #000; height:1px; margin:0px 0px 5px 0px;"></div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProformaOverseaDebiCrediFA.aspx.cs" Inherits="logix.Reportasp.ProformaOverseaDebiCrediFA" %>
            ...
            <div style="width: 1024px; margin: 0px auto; border:1px solid #000;">
                ...
                <div style="float: left;">
                    <div style="float:left; width:150px; margin: 9px 10px 5px 15px; ">
                        <asp:Image  ID="lbl_img" runat="server" Width="149" Height="83" />
                        <%--Width="116" Height="32"--%>
                    </div>
                    <div style="float:left; width:735px; margin: 7px 0px 4px 9px;">
                        <h3 style="font-family: Segoe UI; font-size: 30px; font-weight: normal; color: #000; text-align: center; padding: 0px 0px 0px 0px; margin: 0px 0px 0px -75px;">
...
<%--                         <p style="margin:2px 0px 2px 0px; padding:0px 0px 0px 0px; font-size:14px; font-family: Segoe UI; text-align:center; ">(Formerly Known as Axelerom International Logistics Private Limited)</p>--%>
                    ...
                    <div style="float:left; width:1024px;  margin:0px 0px 0px 0px; border-bottom:1px solid #000; border-top:1px solid #000;">
                        <h3 style="font-family:'Segoe UI'; font-size:24px; text-align:center; color:#000; font-weight:normal; padding:0px; margin:0px;">
                            <asp:Label ID="lbl_head" runat="server"></asp:Label></h3>
                    </div>
                </div>
                <div style="float:left; width:1024px;">
                <div style="float: left; width: 578px; border-right: 1px solid #000; min-height:283px;">

                    <div style="width: 578px; float: left; min-height: 140px;  color: #000000;">
                    ...
                    <div style="width: 578px; float: left; min-height: 141px; border-top: 1px solid #000; color: #000000;">
                        <div style="float: left; width: 566px; min-height: 141px;">
                ...
                <div style="width: 445px; float: left;">
                    ...
                    <div style="width: 445px; float: left; min-height: 272px; padding: 10px 0px 0px 0px;">
                        ...
                        <div style="width: 245px; float: left; color: #000000; display: inline-block; margin: 0px 0px 2px 0px;">
                            <span>
                        ...
                        <div style="width: 245px; float: left; display: inline-block; margin: 0px 0px 2px 0px;">
                            <span>
                        ...
                        <div style="clear: both;"></div>
                          <div id="div_vessel" runat="server">
                        <div style="width: 165px; float: left; display: inline-block; margin: 0px 0px 2px 20px; color: #000000; font-weight: bold;">
                        ...
                        <div id="div_mbl" runat="server" visible="true">
                            ...
                            <asp:Label ID="lbl_mbl" runat="server" Style="width: 245px; float: left; display: inline-block; margin: 0px 0px 5px 0px;"></asp:Label>
                        </div>
                        <div style="clear: both;"></div>
                        <div id="div_port" runat="server" visible="true">
                            <label id="lbl_port" runat="server" style="width: 165px; float: left; display: inline-block; margin: 0px 0px 5px 0px;color: #000000; font-weight: bold; padding: 0px 0px 0px 20px;">Orgin</label>


                            <asp:Label ID="lbl_pod" runat="server" Style="width: 245px; float: left; display: inline-block; margin: 0px 0px 5px 0px;"></asp:Label>
                        </div>
                          <div style="clear: both;"></div>
                        <div id="div_pod" runat="server" visible="true">
                            <label id="lbl_Portpod" runat="server" style="width: 165px; float: left; display: inline-block; margin: 0px 0px 5px 0px;color: #000000; font-weight: bold; padding: 0px 0px 0px 20px;">Destination </label>


                            <asp:Label ID="lbl_port_pod" runat="server" Style="width: 245px; float: left; display: inline-block; margin: 0px 0px 5px 0px;"></asp:Label>
                        </div>
                       <%-- <div style="clear: both;"></div>
                        ...
                        <div style="clear: both;"></div>
                         <div id="div_vendorref" runat="server" visible="false">
                            ...
                            <div style="width: 245px; float: left; display: inline-block; margin: 0px 0px 5px 0px;">
                       ...
                       <div  id="div2" runat="server" visible="true" style="border-top:1px solid #000; margin:0px 0px 5px 0px;">
                        ...
                        <div style="float:left; width:100%; border-bottom:1px solid #000; height:1px; margin:40px 0px 10px 0px;"></div>
                        ...
                        <div style="clear:both;"></div>
                        <div style="width:432px; float:left; display:inline-block; margin:0px 0px 5px 0px; font-family:sans-serif; font-weight:normal; font-size:13px; color:#000; padding:0px 0px 0px 20px;"><asp:Label ID="lblLedgername1" runat="server"></asp:Label></div>
                            </div>
                ...
                <div>
                    <div id="table_invoice" runat="server" visible="true">
                        <table width="1024" border="0" cellspacing="0" cellpadding="0"  style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <th style="width: 150px; color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #000; border-top:1px solid #000;" rowspan="2">BL #</th>
                                <th style="width: 450px; color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #000; border-top:1px solid #000;" rowspan="2">Charges</th>
                                ...
                                <th style="color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #000; border-top:1px solid #000; width:145px; white-space:nowrap;" rowspan="2">Qty - Units</th>
                                <th style="color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #000; border-top:1px solid #000; width:392px; white-space:nowrap;" rowspan="2">Rate</th>
                                <th style="color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px 1px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #000; border-top:1px solid #000; width: 60px;" rowspan="2">Taxable Amt<label id="td_tax_basecurr" runat="server">(USD)</label></th>
                                ...
                                <th style="color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px 1px 3px 1px; margin: 0px; border-bottom: 1px solid #000; border-top:1px solid #000;" colspan="2">Amount</th>
                            </tr>
                            <tr>
                                ...
                                <th style="color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #000;width: 16px;">%</th>
                                <th style="color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #000;width: 65px;">Amt</th>
                                <th style="color: #000; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px 1px 3px 1px; margin: 0px; border-bottom: 1px solid #000;width:60px;" id="th_basecurr" runat="server">(USD)</th>
                            </tr>
                ...
                <div style="float: left; width: 98.1%; padding: 5px 0px 5px 20px; margin: 0px 0px 0px 0px; font-size: 12px; border-bottom: 1px solid black; border-top:1px solid #000;">
                    <asp:Label ID="lbl_currword" runat="server"></asp:Label>
                </div>



                <div id="div_cont" visible="false" runat="server" style="float: left; width: 99.9%; height: 100%; margin: 0px 0px 0px 0px; padding: 10px 0px 10px 0px;" >
                ...
                <div style="clear: both;"></div>
                <div style="float: left; width: 1024px; margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px; text-align: left; border-top:1px solid #000;">
                ...
                <div id="div_invoice" runat="server" visible="true">
                    <div style="width: 1024px; float: left; border-top: 1px solid #000; border-bottom: 1px solid #000;" id="div_banktot" runat="server" visible="true">
                        <div id="div_bank" runat="server" visible="true" style="width: 554px; float: left; margin: 0px 10px 0px 0px;">
                            <h3 style="color: #000; float: left; width: 150px; font-family: sans-serif, Geneva, sans-serif; font-size: 18px; padding: 10px 0px 10px 23px; margin: 0px;">E & O E</h3>
                            <div style="clear: both;"></div>
                                ...
                                <div style="clear: both;"></div>
                                <label style="float: left; width: 95px; margin: 0px 5px -5px 22px; color: #000;">Swift Code</label>
                                <div style="width: 4px; color: #000; float: left; margin: 0px 5px 0px 0px;">:</div>
                                <span style="float: left;">

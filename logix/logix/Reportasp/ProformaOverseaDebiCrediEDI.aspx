<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProformaOverseaDebiCrediEDI.aspx.cs" Inherits="logix.Reportasp.ProformaOverseaDebiCrediEDI" %>
...
<body>
    <form id="form1" runat="server">
        <div id="Wrapper" style="width: 100%; margin: 0px auto;">
             <div style="width: 1024px; margin: 1px auto 1px auto;">
                 <div style="float:right;">
                        <asp:Image  ID="lbl_img" runat="server" Width="269" Height="54" />
                     </div>
                        <%--Width="116" Height="32"--%>
                    </div>
            <div style="width: 1024px; margin: 0px auto;">
                ...
                <div style="float: left; background-color: #878788">
                    ...
                    <div style="float:left; width:735px; margin:5px 0px 0px 160px;">
                        <h3 style="font-family: Segoe UI; font-size: 24px; font-weight: normal; color: #ffffff; text-align: center; padding: 0px 0px 5px 0px; margin: 0px 0px 0px 22px;">
                    ...
                    <div style="float:left; width:1024px; background-color:#184684; margin:0px 0px 0px 0px; border-bottom:1px solid #c2bebe;">
                        <h3 style="font-family:'Segoe UI'; font-size:24px; text-align:left; color:#ffffff; font-weight:normal; padding:0px 0px 0px 10px; margin:0px; width:35%; float:left;">
                            <asp:Label ID="lbl_head" runat="server"></asp:Label></h3>
                        <div style="float:right; width:22%; text-transform:uppercase; color:#fff; font-size:15px; font-family:sans-serif; padding:7px 10px 5px 0px; text-align:right;"><span id="LBL_Original">Original for the Recipient</span></div>
                    </div>
                </div>
                ...
                <div style="float: left; width: 566px; border-right: 1px solid #ffffff; min-height:283px;">
                    ...
                    <div style="background-color: #d0d0d0; width: 566px; float: left; min-height: 141px; border-top: 1px solid #ffffff; color: #000000;">
                ...
                <div style="width: 456px; float: left;">
                    ...
                    <div style="background-color: #d0d0d0; width: 457px; float: left; min-height: 272px; padding: 10px 0px 0px 0px; border-top: 1px solid #ffffff;">
                        ...
                        <div id="div_pack" runat="server" visible="true">
                        ...
                        <div id="div_pod" runat="server" visible="true">
                            ...
                            <asp:Label ID="lbl_port_pod" runat="server" Style="width: 260px; float: left; display: inline-block; margin: 0px 0px 5px 0px;"></asp:Label>
                        </div>
                       <%-- <div style="clear: both;"></div>
  ...
  <div style="clear: both;"></div>
                        ...
                        <div style="float:left; width:100%; border-bottom:1px solid #fff; height:1px; margin:40px 0px 10px 0px;"></div>
                ...
                <div  id="div_ship" runat="server" visible="true" style="background-color: #878788; width: 1024px; float: left; padding: 1px 0px 1px 0px; line-height: 24px;">
                  <%--  <div style="float: left; width: 567px;">
                    ...
                    <div style="float: left; width: 450px;" id="div_igm" runat="server" visible="false">
                        <label style="float: left; display: inline-block; width: 150px; font-weight: bold; color: #ffffff;" id="label_igm" runat="server" >IGM #</label>
                ...
                <div style="border: 1px solid #b1b1b1; background-color: #d0d0d0;">
                    <div id="table_invoice" runat="server" visible="true">
                        <table width="1024" border="0" cellspacing="0" cellpadding="0"  style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <th style="background-color: #184684; width: 150px; white-space:nowrap; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;" rowspan="2">BL #</th>
                                <th style="background-color: #184684; width: 450px; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;" rowspan="2">Charges</th>
                                ...
                                <th style="background-color: #184684; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;width:392px; white-space:nowrap;" rowspan="2">Rate</th>
                                <th style="background-color: #184684; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px 1px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;width: 60px;" rowspan="2">Taxable Amt<label id="td_tax_basecurr" runat="server">(USD)</label></th>
                            ...
                            <tr>
                                ...
                                <th style="background-color: #184684; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;width: 16px;">%</th>
                                <th style="background-color: #184684; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;width: 65px;">Amt</th>
                                <th style="background-color: #184684; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px 1px 3px 1px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;width:60px;" id="th_basecurr" runat="server">(USD)</th>
                            </tr>
                            ...
                            <tr style="background-color:#d0d0d0;">
                                <td colspan="2" style="border-top:1px solid black;">
                                    <h3 style="color: #2c2b2b; float: left; width: 150px; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 1px 0px 1px 17px; margin: 0px;">E & O E</h3>
                                ...
                                <td id="td_cgsta" runat="server" style="border-top:1px solid Black; border-right: 1px solid Black;text-align:right;">&nbsp;</td>
                                <td style="border-top:1px solid Black; border-right: 1px solid Black;">&nbsp;</td>
                                <td id="td_sgsta" runat="server" style="border-top:1px solid Black; border-right: 1px solid Black; text-align:right;">&nbsp;</td>
                                <td style="border-top:1px solid Black; border-right: 1px solid Black;">&nbsp;</td>
                                <td id="td_igsta" runat="server" style="border-top:1px solid Black; border-right: 1px solid Black;text-align:right;">&nbsp;</td>
                    ...
                    <%--<div id="table_agent" runat="server" visible="false">
                        <table width="1024" border="0" cellspacing="0" cellpadding="0"  style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                <th style="background-color: #184684; width: 150px; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;" rowspan="2">BL #</th>
                                <th style="background-color: #184684; width: 450px; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;" rowspan="2">Charges</th>
                                <th style="background-color: #184684; width: 55px; color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;" rowspan="2">SAC</th>
                                <th style="background-color: #184684;  color: #ffffff; font-family: sans-serif, Geneva, sans-serif; font-size: 14px; padding: 3px; margin: 0px; border-right: 1px solid Black;border-bottom: 1px solid #ffffff;width:145px; white-space:nowrap;" rowspan="2">Qty - Units</th>
                ...
                <div style="clear: both;"></div>
                <div style="float: left; width: 1024px; margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px; text-align: left; background-color: #d0d0d0;">
                ...
                <div id="div_invoice" runat="server" visible="true">
                    <div style="width: 1022px; float: left; background-color: #878788; border-left: 1px solid #cdbcb1; border-right: 1px solid Black;border-top: 1px solid #cdbcb1; border-bottom: 1px solid #cdbcb1;" id="div_banktot" runat="server" visible="true">
                        ...
                        <div id="div_between" visible="false" runat="server" style="float: left; width: 1px; border-left: 1px solid #b1b1b1; height: 188px; margin: 0px 5px 0px 5px;">&nbsp;</div>

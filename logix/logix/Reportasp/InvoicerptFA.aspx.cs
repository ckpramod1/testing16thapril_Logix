...
{
    public partial class InvoicerptFA : System.Web.UI.Page
    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            else
                            {
                                ...
                                if (Profoma == "Profoma")
                                {
                                    ...
                                    if (Request.QueryString["header"].ToString() == "CN")
                                    {
                              ...
                              //   14 feb 23   lbl_invoice.Text = portcode + "CN" + fyear.Substring(0, 2) + fyear.Substring(3, 2) + invno + dt.Rows[0]["cnno"].ToString();
                                }
                                else
                                {
                                    ...
                                    //d. 14 feb 23          lbl_invoice.Text = portcode + "CN" + fyear.Substring(0, 2) + fyear.Substring(3, 2) + invno + dt.Rows[0]["cnno"].ToString();
                                    lbl_invoice.Text = branch_invoice + "CN" + fyear.Substring(0, 2) + fyear.Substring(3, 2) + dt.Rows[0]["trantype"].ToString().Replace("FE", "OE").Replace("FI", "OI") + invno + dt.Rows[0]["cnno"].ToString().ToUpper();

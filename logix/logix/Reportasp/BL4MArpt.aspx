<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BL4MArpt.aspx.cs" Inherits="logix.Reportasp.BL4MArpt" %>
...
<div style="width:1024px; margin:0px auto 0px auto;  border:3px solid #000;"class="borderhide">
  <div style="float:left; width:512px; border-right:1px solid #000;"class="borderhide">
    ...
    <div style="float:left; width:512px; border-bottom:1px solid #000; min-height:122px;" class="borderhide">
      <p style="font-size:14px; font-weight:bold;  padding:5px 5px 0px 10px; margin:0px;" class="blhide">Consignee (IF 'To Order' so indicate)</p>
...
<div style="float:left;width:511px;margin-top:10px;"class="blhide">
    ...
    <div style="float:left;width:351px;">
     <p style="font-size:19px; font-weight:bold;padding:5px 5px 0px 5px; margin:0px;text-align:center;">Marin<span style="color:red !important">air</span> Cargo India Pvt Ltd.,</p>
     <p style="font-size:14px; font-weight:bold; padding:5px 5px 0px 5px; margin:0px;text-align:center;">#4, 2nd Street, Ponni Nagar, Pammal,</p>
     <p style="font-size:14px; font-weight:bold;padding:5px 5px 0px 5px; margin:0px;text-align:center;">Chennai - 600 075. India</p>
...
<p style="font-size:14px; font-weight:bold; text-align: center; padding:5px 5px 0px 5px; margin:0px;"><b> Regd Office</b>: No 45, 1st Floor, 1st Main Road, West Shenoy Nagar,  </p>
 <p style="font-size:14px; font-weight:bold; text-align: center; padding:5px 5px 0px 5px; margin:0px;"> <b>Chennai- 600 030. India. Email: info@swenlog.com Website: www.swenlog.com</b> </p>
 <%--<p style="font-size:14px; font-weight:bold; text-align: center; padding:5px 5px 0px 5px; margin:0px;"> <b> Chennai India. </p>--%>
 <p style="font-size:14px; font-weight:bold; text-align: center; padding:5px 5px 0px 5px; margin:0px;">  Registration No. MTO / DGS / 2569 / JAN / 2025</p>
  <p style="font-size:14px; font-weight:bold; text-align: center; padding:5px 5px 0px 5px; margin:0px;">  FMC Reg. No.: 031710</p>
   ...
   <div style="float:left; width:511px;"class="blhide">
     ...
     <p style="font-size:14px; font-weight:bold;  padding:5px 5px 5px 10px; margin:0px; line-height:18px; display:none;">   
         <br />
         </p>
   </div>
  ...
  <div style="float:left; width:1024px; min-height:45px;">
    ...
    <div style="float:left; height: 63px;width:290px; border-right:1px solid #000;border-top:1px solid #000;"class="borderhide">
        ...
        <p style="font-size:14px; font-weight:normal;  padding:0px 5px 5px 10px; margin:0px;"><asp:Label ID="lbl_vessel" runat="server"></asp:Label>/<asp:Label ID="lbl_voy" runat="server"></asp:Label></p>
      </div>
 ...
 <div style="clear:both;"></div>
  ...
  <div style="width:1024px;">
    <table width="1024" border="0" cellspacing="0" cellpadding="0" style="padding:0px; font-size:14px; border-top:0px solid #000; border-bottom:0px solid #000;"class="borderhide">
      <tr class="bltableheadhide">
        <th  style="font-weight:bold; padding:5px 0px 5px 0px; font-size:14px; text-align:center; width:297px; border-right:0px solid #000; border-top:1px solid #000; border-bottom:0px solid #000;font-weight:bold;display:flex;"class="borderhide"><span style="position:relative;top:8px;left:11px;"> Marks & Nos.<br /> Container & Seals</span><span style="position:relative;left:62px;top:8px;">No.Of.Packages</span></th>
       
        <th  style="font-weight:bold; padding:5px 0px 5px 0px; font-size:14px; border-right:0px solid #000; width:498px; border-top:1px solid #000; border-bottom:0px solid #000;font-weight:bold;"class="borderhide">Kind of Packages Description of Goods, Marks & Nos</th>
        <th  style="font-weight:bold; padding:5px 0px 5px 0px; font-size:14px; text-align:center; border-right:0px solid #000; border-top:1px solid #000; border-bottom:0px solid #000;font-weight:bold;"class="borderhide">Gross Weight</th>
        <th  nowrap="nowrap" style="font-weight:bold; padding:5px 0px 5px 0px; text-align:left; width:130px;font-size:14px; border-top:1px solid #000; border-bottom:0px solid #000;font-weight:bold;"class="borderhide">Measurement</th>
        <th  nowrap="nowrap" style="font-weight:bold; padding:5px 0px 5px 0px; font-size:14px; border-top:1px solid #000; border-bottom:0px solid #000;"class="borderhide"></th>
      ...
      <tr>
        ...
        <span style="font-weight:bold;  width:140px; float:right; padding:0px 0px 0px 0px; display:inline-block; text-align:right;">SAID TO CONTAIN</span>
             ...
             <span style="font-weight:bold; display:inline-block; float:left; padding:0px 5px 0px 5px; width:60px; text-align:left;"> </span>
        </td>
        <td nowrap="nowrap"  style="font-weight:bold; padding:5px 2px 5px 5px; text-align:right; border-right:0px solid #000;"class="borderhide">SAID TO WEIGHT </td>
         <td nowrap="nowrap"  style="font-weight:bold; padding:5px 0px 5px 2px; text-align:left; border-right:0px solid #000;"class="borderhide">/ MEASURE</td>
      </tr>
      <tr>
        <td  style="vertical-align:top; width:200px; border-right:0px solid #000; "class="borderhide" >
            
            <p style="font-weight:normal; padding:5px 5px 5px 10px;  white-space:pre-wrap; margin:0px;display:flex;">
 <asp:Label ID="lbl_marks" runat="server"></asp:Label>
        ...
        <td  style="vertical-align:top; border-right:0px solid #000;"class="borderhide">
            <p style="font-weight:normal; margin:0px; padding:5px 5px 5px 5px; text-align:left; white-space:pre-line; vertical-align:top; line-height:15px; height:350px;"><asp:Label ID="lbl_pkg" runat="server" Text=""></asp:Label><br /> <asp:Label ID="lblDescription" runat="server"></asp:Label>
    ...
    <asp:Label ID="Label10" runat="server"></asp:Label></p>
        ...
        <td  valign="top" style="font-weight:bold; padding:5px; text-align:left; border-right:0px solid #000;"class="borderhide">
      
      <p style="font-weight:normal; padding:15px 5px 5px; text-align:left; white-space:pre; "><asp:Label ID="lbl_shiptype" runat="server"></asp:Label> <br />
</p>
<p style="font-weight:normal; padding:5px; text-align:center;  line-height:18px;position:relative;top:-70px !important;"> 
    ...
    text-align: center;
    line-height: 18px;
    margin-left: -16px;position:relative;top:-81px !important;left:1px;"> 
        ...
        <br />
                        <p style="font-weight: bold; padding: 5px; text-align: left; white-space: pre; margin-top: 10px;">
       ...
       <%-- <td style="font-weight:bold; padding:15px 5px 5px; text-align:left;"><p style="font-weight:bold; padding:5px 0px 5px 0px; text-align:left; font-weight:bold; margin:-35px 0px 0px 0px; line-height:18px; ">
  ...
  <div style="width:1024px; float:left; border-top:1px solid #000;display:none;">
    ...
    <div style="float:left; width:512px;">
      <div style="font-size:14px; font-weight:bold;  padding:1px 5px 1px 10px; margin:0px; float:left; min-height:40px;  width:497px; border-bottom:1px solid #000;display:none;"> For Delivery Please Apply To
<br/>
          <p style="font-size:14px; font-weight:bold;  padding:2px 5px 2px 10px; margin:0px;  "><asp:Label ID="lbl_totcont" runat="server"></asp:Label></p>
      </div>
       
        <div style="clear:both;"></div>
      <div style="font-size:14px; font-weight:bold;  padding:5px 5px 5px 10px; border-bottom:1px solid #000; margin:0px; float:left; min-height:40px; width:512px; display:none;">Cargo Shall not delivered unless freight and charges not paid</div>    
      <div style="width:512px; border-bottom:1px solid #000; min-height:50px;">
       <div style="font-size:14px; font-weight:bold;  padding:5px 5px 5px 10px; margin:0px; ">Freight Details, Charges etc</div>
      <div style="font-size:14px; font-weight:bold;  padding:5px 5px 5px 10px; margin:0px;  "> <asp:Label ID="lbl_freight" runat="server"></asp:Label></div>
        </div>     
        <div style="float:left; width:512px; border-bottom:0px solid #000; min-height:210px;">
        <div style="font-size:12px; font-weight:bold;  padding:5px 5px 5px 10px; margin:0px; float:left;  width:499px; text-align:center; ">
        For Delivery Please Apply To
</div>
        <div style="font-size:14px; font-weight:bold;  padding:5px 5px 5px 10px; margin:0px; float:left; min-height:60px; width:490px;white-space: pre-line"> <asp:Label ID="lbl_delicontact1" runat="server"></asp:Label></div>
        </div>       
      ...
      <div style="font-size:14px; font-weight:bold;  padding:15px 5px 15px 10px; margin:0px; float:left;  width:331px; display:none;"> </div>
    ...
    <div style="float:left; width:510px; border-left:1px solid #000; min-height:265px;">
        ...
        <div style="width:510px; float:left; border-bottom:1px solid #000; min-height:35px;">
            ...
            <p style="font-size:14px; font-weight:bold;  padding:5px 5px 0px 10px; margin:0px; float:left;  width:264px;"><asp:Label ID="lbl_placedtofisue" runat="server"></asp:Label></p>
             <p style="font-size:14px; font-weight:bold;  padding:5px 5px 0px 10px; margin:0px; float:left; text-align:right; width:180px;"></p>
            </div>
         <div style="clear:both;"></div>
       ...
       <p style=" float:left;font-weight:bold;width:12px;margin:10px 0px 0px 10px;" >by</p>
        <p style=" float:left;font-weight:bold;width:236px;margin:23px 0px 0px 6px;border-bottom:1px solid #000;"></p>
       </div>      
    </div>   
  </div>
    <div style="width:1024px;display:none;">
     ...
     <div style="float:left;width:1024px;">
         <div style="float:left;width:35%;">
             <p style="font-size:14px; font-weight:normal;  padding:5px 5px 5px 11px; margin:0px;float:left;width:70%;"class="blhide">TOTAL NUMBER OF CONTAINERS OR PACKAGES OR UNITS</p>
    ...
    <p style="font-size:14px; font-weight:bold;  padding:5px; margin:0px;float:left;width:100%;">SHIPPER LOAD / STOW / COUNT<br />DESTINATION ANCILLARY CHARGES ON CONSIGNEE'S A/C</p>
</div>
    ...
    <div style="float:left;width:1024px;border-top:1px solid #000;"class="borderhide">
        <div style="float:left;width:200px;border-right:1px solid #000;min-height:131px;"class="borderhide">
           <p style="font-size:14px; font-weight:bold;  padding:5px; margin:0px;text-align:center;width:95%;float:left;"class="blhide">OTHER CHARGES</p>
            <p style="font-size:14px; font-weight:bold;  padding:0px 0px 5px 10px; margin:0px;width:8%;float:left;" class="blhide"></p>  <p style="float:left;width:82%; padding:0px 0px 5px 10px; margin:0px;"><asp:Label ID="lbl1" runat="server"></asp:Label></p>
            <p style="font-size:14px; font-weight:bold; padding:0px 0px 5px 10px; margin:0px;width:8%;float:left;"class="blhide"></p> <p style="float:left;width:82%; padding:0px 0px 5px 10px; margin:0px;"><asp:Label ID="Label3" runat="server"></asp:Label></p>
            <p style="font-size:14px; font-weight:bold;  padding:0px 0px 5px 10px; margin:0px;width:8%;float:left;"class="blhide"></p> <p style="float:left;width:82%; padding:0px 0px 5px 10px; margin:0px;"><asp:Label ID="Label4" runat="server"></asp:Label></p>
            <p style="font-size:14px; font-weight:bold;  padding:0px 0px 5px 10px; margin:0px;width:8%;float:left;"class="blhide"></p> <p style="float:left;width:82%; padding:0px 0px 5px 10px; margin:0px;"><asp:Label ID="Label5" runat="server"></asp:Label></p>
            <p style="font-size:14px; font-weight:bold; padding:0px 0px 5px 10px;margin:0px;width:8%;float:left;"class="blhide"></p> <p style="float:left;width:82%; padding:0px 0px 5px 10px; margin:0px;"><asp:Label ID="Label6" runat="server"></asp:Label></p>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:14px;">
                ...
                <tbody>
                    <tr style="height:66px;">
                        <td style="padding:0px 0px 0px 10px;border-right:1px solid #000;font-weight:normal;"class="borderhide";white-space="pre-wrap" ;> <asp:Label ID="lbl_delicontact" runat="server"></asp:Label> </td>
                        <td style="padding:0px 0px 0px 10px;border-right:1px solid #000;font-weight:normal;"class="borderhide"><asp:Label ID="lbl_preorcol" runat="server"></asp:Label></td>
                        <td style="padding:0px 0px 0px 10px;font-weight:normal;"><asp:Label ID="lbl_colorper" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
  ...
  <div style="float:left;height: 51px; width:260px; border-top:1px solid #000;"class="borderhide">
      <p style="font-size:14px; font-weight:bold;  padding:5px 5px 5px 10px; margin:0px;float:left;width:123px;"class="blhide">Place B/L Issued :</p>
      <p style="font-size:14px; font-weight:normal;  padding:5px 5px 5px 3px; margin:0px;float:left;width:114px;"><asp:Label ID="Label2" runat="server"></asp:Label></p>
    </div>
  ...
  <p style="float:left;font-size:14px; font-weight:normal;  padding:5px 5px 5px 10px; margin:0px;width:123px;"><asp:Label ID="lbl_etd" runat="server"></asp:Label></p>
    ...
    <div style="float:left;width:1024px;">
                <div style="float:left;width:250px;min-height:150px;display:none;"class="borderhide">
...
<p style="font-size:14px; font-weight:bold;height:27px;  padding:39px 5px 5px 11px; margin:0px;text-align:center;"><asp:Label ID="Label1" runat="server"></asp:Label></p>
            <p style="text-align:center">
                </div>
        <div style="float:left;width:571px;border-right:1px solid #000;min-height:150px;"class="borderhide">
              <p style="font-size:21px; font-weight:bold;  padding:5px 5px 5px 10px; margin:0px;text-align:center;margin-left: -125px;"class="lblsob">SHIPPED ON BOARD</p>
<p style="font-size:36px; font-weight:bold;height:22px;  padding:5px 5px 5px 11px; margin:0px;text-align:center;color:#8D7BD4;width:385px"><asp:Label ID="lbl_sonboard" runat="server"></asp:Label></p>
            <p style="text-align:center">
        ...
        <div style="float:left;width:427px;">
            <div style="font-size:14px; font-weight:bold;  padding:4px 15px 5px 10px; text-align:right;margin:0px; float:left; width:434px;  " class="blhide">
...
">
<p style=" float:left;font-weight:normal;margin:10px 0px 0px 10px;width:451px;">by_____________________Signed on behalf of the Carrier / Agent</p>
            </div>
         <div style="float:left;width:427px;text-align:right;" class="blhide">
         <p style=" float:left;font-weight:bold;margin:10px 0px 0px 0px;width:444px;">Authorised Signatory</p>
         </div>

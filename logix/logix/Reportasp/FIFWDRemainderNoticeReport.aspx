<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FIFWDRemainderNoticeReport.aspx.cs" Inherits="logix.Reportasp.FIFWDRemainderNoticeReport" %>
...
<div class="report">
    <div class="header">
        ...
        font-size: 21px;
        font-weight: bold;
        color: #000;"><asp:label runat="server" ID="lblcompanyname">DEMO COMPANY</asp:label></h2>
    ...
    <div class="div1content">
        ...
        <div class="right1">
            ...
            <div style="width:100%;float:left">
            <p style="font-size:14px;font-weight:bold;font-family: sans-serif;color:#000;width:50px">Job #</p>
            <p style="font-size:14px;font-family:sans-serif; color: #2c2b2b;">:</p>
        ...
        <div class="div2content">
            ...
            <div class="leftc">
                ...
                <p style="font-size:14px;font-weight:bold;font-family: sans-serif;color:#000;width:50px !important">SUB</p>
        <p style="font-size:14px;font-family:sans-serif; color: #2c2b2b;">: </p><asp:label runat="server" id="lblvessel" style="margin-left: 20px;">M.V </asp:label>
            <asp:Label ID="lblvoyage" runat="server" ></asp:Label>
                ...
                <div style="width: 100%;float: left;">
        <p style="font-size:14px;font-weight:bold;font-family: sans-serif;color:#000;width:50px !important">B \ L</p>
        <p style="font-size:14px;font-family:sans-serif; color: #2c2b2b;">:</p>
            ...
            <div class="centerc">
                <div style="width: 100%;float: left;">
                <p style="font-size:14px;font-weight:bold;font-family: sans-serif;color:#000;width:50px !important">ETA</p>
        <p style="font-size:14px;font-family:sans-serif; color: #2c2b2b;">:</p>
...
<div style="width: 100%;float: left;">
        <p style="font-size:14px;font-weight:bold;font-family: sans-serif;color:#000;width:50px !important">Line #</p>
        <p style="font-size:14px;font-family:sans-serif; color: #2c2b2b;">:</p>
            ...
            <div class="rightc">
                <div style="width: 100%;float: left;">
                <p style="font-size:14px;font-weight:bold;font-family: sans-serif;color:#000;width:50px !important">IM # </p>
        <p style="font-size:14px;font-family:sans-serif; color: #2c2b2b;">:</p>
        ...
        <div class="div3content">
            <p style="font-size:14px;font-weight:bold;font-family: sans-serif;color:#000;">Container #(s)</p>
            <div class="table" style="width:100%;">
                <table class="details" style="margin-left: 50px !important; width:25%;">
                    <thead>
                        <tr>
                            <th></th>
                            <th></th>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AEBLOriginalforjobinfo.aspx.cs" Inherits="logix.Reportasp.AEBLOriginalforjobinfo" %>
...
<span class="span4">ROAD, NANSHAN DISTRICT, SHENZHEN,CHINA,SHENZHEN</span>--%>
    ...
    <div style="border:2px solid black;float: left;width:100%;margin-bottom: 10px;">
        ...
        <div class="div_left1">
            <div style="width: 100%;border-bottom: 2px solid black;float: left;"> 
            ...
            <div style="width: 100%;margin-bottom: 28px;float: left;min-height: 157px;;">
        ...
        <div class="div_right1">
            <div style="width: 100%;float: left;min-height: 156px;border-bottom: 2px solid black;">
            ...
            <div style="width:100%;float: left;">
                ...
                font-size: 13px;">It is agreed that the goods descriped herein are accepted in apparent good order and conditions.(EXCEPT as noted) for
...
FOR DELIVERY
       ...
       <div style="width:100%;float: left;border-top: 2px solid black;">
        ...
        <div class="divleft3">
            ...
            <p class="Heading" style="margin: 5px 0px 0px 10px;"><asp:Label ID="airportcode1" runat="server"> </asp:Label></p>
        </div>
    ...
    <p class="center" ><asp:Label ID="lbl_DVCar" runat="server">  </asp:Label></p>
        </div>
        <div style="width:24%;float: left;min-height: 54px">
        <p class="Heading center">Declared Value for Customs</p>
        <p class="center"><asp:Label ID="lbl_DVcus" runat="server">  </asp:Label></p>
        </div>
        ...
        <div style="width:100%;float: left;border-top: 2px solid black;min-height: 60px;">
        <div class="divleft4">
            <div style="width:35%;float: left;border-right: 2px solid black;min-height: 93px;">
            ...
            <div style="width:65%;float: left;">
                <div style="width:30%;float:left;border-right:2px solid black;min-height:41px !important;">
                    <div style="width:100%;float: left;min-height:40px !important;">
    <p class="Heading" style="padding: 4px 0px 0px 5px;">Flight/Date</p>
                        </div>
                    
                </div>
                <div style="float:left;width:30%;border-right:2px solid black;min-height:40px !important;border-bottom:2px solid black;">
...
<p class="Heading" style="padding: 4px 0px 0px 5px;" >Flight/Date</p>
                ...
                <div style="width:50%;float:left;border-right:2px solid black;">
                        <div style="width:100%;float: left;min-height:50px !important;">
    ...
    <div style="width:50%;float:left;">
            <div style="width:100%;float: left;" >
<p style="padding: 8px 0px 0px 5px;"><asp:Label ID="Lbl_flno2" runat="server"> </asp:Label> / <asp:Label ID="lbl_fldate2" runat="server"> </asp:Label></p></div>
</div>
        ...
        <div class="divright4">
            ...
            <div style="width:27.5%;float: left;border-right: 2px solid black;min-height: 93px;">
            ...
            <p style="margin: 11px 0px 0px 5px;">INSURANCE : it careers offers insurance and such insurance ie requested in accordance with conditions on reverse hereof.
            Indicate amount to be insured in figures in box marked "Amount of Insurance"</p></div>
        </div>
        </div>
    </div>

    <div style="width:100%;float: left;border-top: 2px solid black;padding: 5px 0px 5px 13px;border-bottom: 2px solid black;">
    
        <p style="float: left;"  class="Heading">Handling Information</p>
        <p style="float: left;" ><asp:Label ID="Label27" runat="server"> </asp:Label></p>
...
<table class="w3-table w3-border w3-bordered">
        ...
        <tr style="border-bottom: none;">
            <th style="width:90px;padding-top: 34px;">No. of Pieces RCP</th>
            <th style="width:90px;padding-top: 34px;">Gross Weight</th>
            <th style="width:50px;padding-top: 35px;">Kg LB</th>
            <th style="padding: 2px;background: #c0c0c0;width: 10px;"></th>
            <th style="border-right: none;"></th>
            <th style="border-bottom: 2px solid black;">Rate Class</th>
            <th style="padding: 0px;background: #c0c0c0;width: 10px;"></th>
            <th style="width: 30px;">Chargeable
            Weight</th>
            <th style="padding: 0px;background: #c0c0c0;width: 10px;"></th>
            <th style="width: 30px;padding: 30px;">Rate /
            Charge</th>
            <th style="padding: 0px;background: #c0c0c0;width: 10px;"></th>
            <th style="padding: 30px;">Total</th>
            <th style="padding: 0px;background: #c0c0c0;width: 10px;"></th>
            <th style="width: 390px; border-right: 0px">Nature and Quantity of goods <br>
            (Incl.Dimensind or volume)</th>
      
           
        </tr>
        <tr>
            <th style="border-right:2px solid black;padding-bottom: 39px;"></th>
            ...
            <th></th>
            <th style="border-right:none;padding: 5px 16px 3px 21px;;" colspan="1">
        ...
        <tbody>
        <tr>
          <td style="border-right: 2px solid black;">            <asp:Label ID="pkgs" runat="server"></asp:Label></td>

          <td style="border-right: 2px solid black;">            <asp:Label ID="grosswt" runat="server" ></asp:Label></td>

          <td style="border-right: 2px solid black;">            <asp:Label ID="wttype" runat="server" ></asp:Label></td>

          <td style="padding: 2px;background: #c0c0c0;width: 10px;border-right: 2px solid black;"></td>
          <td style="border-right: 2px solid black;"></td>
          <td style="border-right: 2px solid black;">            <asp:Label ID="citemno" runat="server" ></asp:Label></td>

          <td style="padding: 2px;background: #c0c0c0;width: 10px;border-right: 2px solid black;"></td>
          <td style="border-right: 2px solid black;">            <asp:Label ID="chargewt" runat="server"></asp:Label></td>

          <td style="padding: 2px;background: #c0c0c0;width: 10px;border-right: 2px solid black;"></td>
          <td style="border-right: 2px solid black;">            <asp:Label ID="rateclass" runat="server"></asp:Label></td>

          <td style="padding: 2px;background: #c0c0c0;width: 10px;border-right: 2px solid black;"></td>
          <td style="border-right: 2px solid black;">            <asp:Label ID="total" runat="server"></asp:Label></td>

          <td style="padding: 2px;background: #c0c0c0;width: 10px;border-right: 2px solid black;">            </td>
                      <td>            <asp:Label ID="descn" runat="server"></asp:Label></td>
          <td></td>
        </tr>
    ...
    <div style="width:100%;float: left;">
    <div style="width:66.9%;float:left;border-right: 2px solid black;min-height: 30px;">
    <div style="width:75%;float: left;border-right: 2px solid black;min-height: 30px;">
    ...
    <div style="float: left;width:114px;border-bottom: 2px solid black;border-right: 2px solid black;text-align: center;padding: 5px; border-left: 2px solid black;margin-left: 70px;"><p>Weight Charge</p></div>
 
    <div style="float: left;width:129px;border-bottom: 2px solid black; border-left: 2px solid black;text-align: center;padding: 5px;margin-left: 81px"><p>Collect</p></div>
    </div>
    <div style="width:100%;float: left;">
...
<div style="width: 25%;float: left;text-align: center;min-height: 156px;" >
...
<div style="width:25%;float: left;">
    <p style="display: inline-block;margin: 0px 0px 0px 17px;">
                    <asp:Label ID="lbllength" runat="server" ></asp:Label> X <asp:Label ID="lblbreadth" runat="server" ></asp:Label> X <asp:Label ID="lblwidth" runat="server" ></asp:Label> X <asp:Label ID="lblpieces" runat="server"></asp:Label> 
        </p>
</div>
    ...
    <div style="width:100%;float: left;min-height: 50px;background-color: #c0c0c0;border-top: 2px solid black;"></div>
    ...
    <div style="width: 50%;float: left;border-top: 2px solid black;min-height: 169px;">

        <div style="min-height: 156px;border-bottom: 2px solid black">
    <p style="margin: 16px 40px 0px 11px;">Shipper certifies that the particulars on the face hereof are correct and that insofar as any part of the consignment
...
<div style="width: 100%;text-align: center;float: left;margin-top: 25px;">
    ...
    <div style="width:21%;float:left;min-height: 60px;">
    <p>
        <asp:Label ID="portname" runat="server"></asp:Label>
    </p>
    
    <p class="label">at(Place)</p></div>
    <div style="width:49%;float:left;min-height: 60px;">
    <p>
...
<div style="width:36%;float: left;min-height: 57px;border-right: 2px solid black;text-align: center;">

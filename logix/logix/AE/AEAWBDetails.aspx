...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  img#logix_CPH_finaldesflag {
    ...
    left:0px !important;
        ...
        div#logix_CPH_pnl_shp .divRoated{
            width:47% !important;
         ...
         div#logix_CPH_pnl_shp .DivSecPanel{
             width:10% !important;
         }
            div#logix_CPH_pnl_shp .DivSecPanel {
        ...
        function pageLoad(sender, args) {
            ...
            $(document).ready(function () {
             ...
             focus: function (event, ui) {
                 $('#<%=txt_fromport.ClientID%>').val(ui.item.portname);
                 return false;
             },
      ...
      <%--      $(document).ready(function () {
            ...
            $(document).ready(function () {
                $('#<%=txt_toport.ClientID%>').autocomplete({
                    ...
                    focus: function (event, ui) {
                        $('#<%=txt_toport.ClientID%>').val(ui.item.portname);
                        return false;
                    },
                    select: function (event, ui) {
                        $('#<%=txt_toport.ClientID%>').val(ui.item.portname);
...
change: function (event, ui) {
    $('#<%=txt_toport.ClientID%>').val(ui.item.portname);
            ...
            $(document).ready(function () {
             ...
             focus: function (event, ui) {
                 $('#<%=txt_to1.ClientID%>').val(ui.item.portname);
                 return false;
             },
             select: function (event, ui) {
                 $('#<%=txt_to1.ClientID%>').val(ui.item.portname);
    $("#<%=hf_inttoid1.ClientID %>").val(ui.item.portid);
       ...
       <%--     $(document).ready(function () {
            ...
            $(document).ready(function () {
                ...
                $("#<%=txt_by1.ClientID %>").autocomplete({
                    ...
                    focus: function (e, i) {
                        $("#<%=txt_by1.ClientID %>").val(i.item.label);
                        $("#<%=hf_intbyid1.ClientID %>").val(i.item.val);
                    },
                    close: function (e, i) {
            ...
            $(document).ready(function () {
             ...
             focus: function (event, ui) {
                 $('#<%=txt_to2.ClientID%>').val(ui.item.portname);
                 return false;
             },
             select: function (event, ui) {
                 $('#<%=txt_to2.ClientID%>').val(ui.item.portname);
    $("#<%=hf_inttoid2.ClientID %>").val(ui.item.portid);
         ...
         <%--   $(document).ready(function () {
            ...
            $(document).ready(function () {
                ...
                $("#<%=txt_by2.ClientID %>").autocomplete({
                    ...
                    focus: function (e, i) {
                        $("#<%=txt_by2.ClientID %>").val(i.item.label);
                        $("#<%=hf_intbyid2.ClientID %>").val(i.item.val);
                    },
                    close: function (e, i) {
            ...
            $(document).ready(function () {
             ...
             focus: function (event, ui) {
                 $('#<%=txt_to3.ClientID%>').val(ui.item.portname);
                 return false;
             },
             select: function (event, ui) {
                 $('#<%=txt_to3.ClientID%>').val(ui.item.portname);
    $("#<%=hf_inttoid3.ClientID %>").val(ui.item.portid);
       ...
       <%--     $(document).ready(function () {
            ...
            $(document).ready(function () {
                ...
                $("#<%=txt_by3.ClientID %>").autocomplete({
                    ...
                    focus: function (e, i) {
                        $("#<%=txt_by3.ClientID %>").val(i.item.label);
                        $("#<%=hf_intbyid3.ClientID %>").val(i.item.val);
                    },
                    close: function (e, i) {
            ...
            $(document).ready(function () {
                ...
                $("#<%=txt_inscurr.ClientID %>").autocomplete({
                    ...
                    close: function (e, i) {
                        var result = $("#<%=txt_inscurr.ClientID %>").val().toString().split(' ,')[0];
                        $("#<%=txt_inscurr.ClientID %>").val($.trim(result));
            ...
            $(document).ready(function () {
             ...
             focus: function (event, ui) {
                 $('#<%=txt_issueat.ClientID%>').val(ui.item.portname);
                 return false;
             },
             select: function (event, ui) {
                 $('#<%=txt_issueat.ClientID%>').val(ui.item.portname);
    $("#<%=hf_intissuedid.ClientID %>").val(ui.item.portid);
...
<asp:Content ID="Content2" ContentPlaceHolderID="logix_CPH" runat="server">
    ...
    <div class="left_btn">
        ...
        <div class="btn ico-ship-invoice" id="Div2" runat="server">
            <asp:Button ID="Btnshipper" runat="server" ToolTip="Shippers Ref Details" TabIndex="42" OnClick="Btnshipper_Click" Visible="false" />
        </div>
                ...
                <div class="widget-content">
                    ...
                    <div class="FormGroupContent4 boxmodal">
                        ...
                        <div class="FormGroupContent4">
                         ...
                         <div class="img">
  <asp:Image ID="fromportflag" runat="server" Width="100%" />
  <asp:Image ID="toportflag" runat="server" Width="100%" />
  <asp:Image ID="toflag1" runat="server" Width="100%" />
  <asp:Image ID="toflag2" runat="server" Width="100%" />
  <asp:Image ID="finaldesflag" runat="server" Width="100%" />
  <asp:Image ID="issuedatflag" runat="server" Width="100%" />
     ...
     <asp:Button ID="Btnamendbl" runat="server" ToolTip="Amend AWB #" TabIndex="41" OnClick="Btnamendbl_Click" />
 </div>
                            ...
                            <div class="FormGroupContent4 boxmodal">
                                ...
                                <div class="PkgsInput1 blueheighlight">
                                    ...
                                    <asp:TextBox ID="txt_packages" runat="server" CssClass="form-control" placeholder="" ToolTip="Number of Packages" TabIndex="22"></asp:TextBox>
                                </div>
                                ...
                                <div class="Pallet">
                                    ...
                                    <asp:TextBox ID="txt_pallet" runat="server" CssClass="form-control" placeholder="" ToolTip="Number of Pallet" TabIndex="23" ></asp:TextBox>
                                </div>
                        ...
                        <div class="box2">
                            ...
                            <div class="FormGroupContent4">
                                ...
                                <div class="ToInput4 blueheighlight">
                                    <asp:Label ID="Label22" runat="server" Text="FD "></asp:Label>
    ...
    <asp:Panel ID="pnl_shp" runat="server" CssClass="modalPopup" BorderStyle="Solid" BorderWidth="2px" Style="display: none;">
        <div class="divRoated">
            <div class="DivSecPanel">
                <asp:Image ID="Image3" runat="server" ImageUrl="~/Theme/assets/img/buttonIcon/active/close-sm.png" Width="100%" Height="100%" />
            </div>
                            <div class="FormGroupContent4">
                    <div class="txct" style="width:40%;float:left;">
                        <span>Shipper Invoice Detail</span>
                <asp:TextBox ID="txt_shipperinvoice" runat="server" CssClass="form-control" MaxLength="100"></asp:TextBox>
                        </div>
                    <div class="left_btn">
        <div class="btn ico-add" id="Div3" runat="server">
    <asp:Button ID="btnadd" runat="server" ToolTip="Add Shipper Details" OnClick="btnadd_Click" />
    <%--OnClick="btnyes_Click" --%>
            ...
            <asp:Panel ID="Panel3" runat="server" CssClass="Grid FixedHeader" ScrollBars="Vertical">
                ...
                <div class="gridpnl" style="width:100%;height:408px !important;">
                <asp:GridView ID="Grid_shipperinvoice" runat="server" CssClass="FixedHeader" ShowHeaderWhenEmpty="true" Width="100%" AutoGenerateColumns="False">
                    <%-- OnRowCommand="Grid_shipperinvoice_RowCommand" OnRowDataBound="Grid_shipperinvoice_RowDataBound1" OnRowDeleted="Grid_shipperinvoice_RowDeleted"--%>
                    <Columns>

                        <asp:BoundField DataField="Shipperinvoice" HeaderText="Shipper Invoice Details">
                        ...
                        <%--                        <asp:TemplateField HeaderText="Shipper">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_shipperinvoice" runat="server" Text='<%#Bind("Shipperinvoice") %>' Visible="true" CssClass="form-control" MaxLength="100"></asp:TextBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="Img_Delete" runat="server" OnClick="Img_Delete_Click" ImageUrl="~/images/delete.jpg" />
                            </ItemTemplate>
                            <HeaderStyle Wrap="true" Width="5%" />
                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                        </asp:TemplateField>
    ...
    <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnl_shp"
        TargetControlID="hidlabel3" CancelControlID="Image3" DropShadow="false" BehaviorID="Test3">
    </asp:ModalPopupExtender>

    <asp:ModalPopupExtender ID="pop_up" runat="server" PopupControlID="pnl_emp" DropShadow="false"
        TargetControlID="Label61" CancelControlID="Image2" BehaviorID="Test2">
    </asp:ModalPopupExtender>
    ...
    <asp:Label ID="hidlabel3" runat="server" />

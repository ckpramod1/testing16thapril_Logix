<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainModuleNew.aspx.cs" Inherits="logix.samp" EnableEventValidation="false" %>
              ...
              <li class="current"><i class="icon-home"></i><a href="#"></a>Home </li>
                    ...
                    <div class="HomeGroup">
                        ...
                        <a id="CRM" runat="server" href="#">
                            <div class="MenuCRM">
                                <img src="Theme/assets/img/crm.png" width="52" height="52">
                                <h3>CRM</h3>
                            </div>
                        </a>
                        <a id="CHA" runat="server" href="#">
                            <div class="MenuCHA">
                                <img src="Theme/assets/img/cha_ic.png" width="59" height="51">
                                <h3>CHA</h3>
                            </div>
                        </a>
                        <a id="BondedTrucking" runat="server" href="#">
                            <div class="MenuBT">
                                <img src="Theme/assets/img/bt.png" width="52" height="52">
                                <h3>Bounded Trucking</h3>
                            </div>
                        </a>
                        ...
                        <a id="OperatingAccounts" runat="server" href="#">
                            <div class="MenuOA">
                                <img src="Theme/assets/img/oa_ic.png" width="82" height="54">
                                <h3>Operating Accounts</h3>
                            </div>
                        </a>
